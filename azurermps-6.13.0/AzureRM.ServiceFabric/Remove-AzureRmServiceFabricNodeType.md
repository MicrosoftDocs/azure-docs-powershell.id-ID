...
## DESCRIPTION
Gunakan **Remove-AzureRmServiceFabricNodeType** untuk menghapus semua node dari tipe simpul tertentu dan tipe node dari kluster. Perintah ini tidak dapat digunakan untuk menghapus tipe simpul utama.
