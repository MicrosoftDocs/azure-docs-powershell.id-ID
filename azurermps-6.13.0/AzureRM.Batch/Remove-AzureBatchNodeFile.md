...
## DESCRIPTION
Cmdlet **Remove-AzureBatchNodeFile** menghapus file node Azure Batch untuk tugas atau node perhitungan.
...
Perintah ini akan mendapatkan file simpul menggunakan **Get-AzureBatchNodeFile**.
File tersebut dikaitkan dengan tugas yang memiliki ID Task26 di bawah pekerjaan Job-000001.
