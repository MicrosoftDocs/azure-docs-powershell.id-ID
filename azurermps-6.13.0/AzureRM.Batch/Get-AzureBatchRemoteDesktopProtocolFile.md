...
## DESCRIPTION
Cmdlet **Get-AzureBatchRemoteDesktopProtocolFile** mendapatkan file Remote Desktop Protocol (RDP) dari simpul komputasi dan menyimpannya sebagai file atau ke streaming yang disediakan pengguna.
