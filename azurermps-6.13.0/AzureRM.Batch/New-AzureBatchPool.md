...
## DESCRIPTION
Cmdlet **New-AzureBatchPool** membuat kumpulan dalam layanan Azure Batch di bawah akun yang ditentukan oleh parameter *BatchContext*.
...
Kumpulan dikonfigurasi untuk menggunakan mesin virtual kecil yang digambarkan dengan versi sistem operasi terbaru dari keluarga empat.
...
Kumpulan dikonfigurasi untuk menggunakan mesin virtual kecil yang digambarkan dengan versi sistem operasi terbaru dari keluarga empat, dan jumlah target node komputasi ditentukan oleh rumus Skala Otomatis.
