...
## DESCRIPTION
Cmdlet **Set-AzureBatchJob** memperbarui pekerjaan Azure Batch.
Gunakan cmdlet Get-AzureBatchJob untuk mendapatkan objek **PSCloudJob** .
...
Perintah pertama mendapatkan kumpulan menggunakan **Get-AzureBatchJob**, lalu menyimpannya dalam variabel $Job.
