...
Cmdlet **Remove-AzureRmVirtualNetworkGatewayConnection** menghapus objek koneksi Anda berdasarkan Nama dan Nama Grup Sumber Daya.

## EXAMPLES

### 1: Menghapus Koneksi Gateway Jaringan Virtual
```
