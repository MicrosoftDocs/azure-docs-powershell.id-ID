...
## DESCRIPTION
Cmdlet **Set-AzureRmNetworkSecurityRuleConfig** mengatur status tujuan untuk konfigurasi aturan keamanan jaringan Azure.
...
Perintah kedua menggunakan operator pipeline untuk melewati grup keamanan dalam $nsg ke Get-AzureRmNetworkSecurityRuleConfig, yang mendapatkan konfigurasi aturan keamanan bernama rdp-rule.
...
- SEBUAH CIDR
- Rentang IP sumber
- Karakter wildcard (*) untuk mencocokkan alamat IP apa pun Anda juga dapat menggunakan tag seperti VirtualNetwork, AzureLoadBalancer, dan Internet.
