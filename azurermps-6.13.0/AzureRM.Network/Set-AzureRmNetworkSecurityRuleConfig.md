...
Perintah kedua menggunakan operator pipeline untuk menyampaikan grup keamanan dalam $nsg ke Get-AzureRmNetworkSecurityRuleConfig, yang mendapatkan konfigurasi aturan keamanan bernama rdp-rule.
...
- A CIDR
- Rentang IP sumber
- Karakter wildcard (*) agar sesuai dengan alamat IP Anda juga bisa menggunakan tag seperti VirtualNetwork, AzureLoadBalancer dan Internet.
