...
## DESCRIPTION
Cmdlet Get-AzureRmNetworkWatcherConnectionMonitor mengembalikan monitor koneksi dengan nama / resourceId yang ditentukan atau daftar monitor koneksi yang terkait dengan pengawas jaringan / lokasi yang ditentukan.

## EXAMPLES

### Contoh 1: Dapatkan monitor koneksi berdasarkan nama di lokasi yang ditentukan
```
...
Dalam contoh ini, kami mendapatkan monitor koneksi berdasarkan nama di lokasi yang ditentukan.
