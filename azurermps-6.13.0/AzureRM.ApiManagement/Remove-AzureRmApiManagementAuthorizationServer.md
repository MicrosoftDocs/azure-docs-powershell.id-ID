...
## DESCRIPTION
Cmdlet **Remove-AzureRmApiManagementAuthorizationServer** menghapus server otorisasi Azure API Management.
...
### -ServerId
Menentukan ID server otorisasi untuk dihapus.
