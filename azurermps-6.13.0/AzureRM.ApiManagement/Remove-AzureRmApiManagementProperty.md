...
ms.locfileid: "142665594"
---
# Remove-AzureRmApiManagementProperty

## SYNOPSIS
Menghapus Properti API Management.
...
## DESCRIPTION
Cmdlet **Remove-AzureRmApiManagementProperty** menghapus **Properti** azure API Management.

## EXAMPLES

### Contoh 1: Menghapus properti
```
PS C:\>$apimContext = New-AzureRmApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzureRmApiManagementProperty -Context $apimContext -PropertyId "Property11" -PassThru
```

Perintah ini menghapus properti yang memiliki Properti ID11.
...
### -PropertyId
Menentukan ID properti yang dihapus cmdlet ini.
