...
## DESCRIPTION
Cmdlet **Remove-AzureRmTrafficManagerExpectedStatusCodeRange** menghapus rentang kode status yang diharapkan dari objek profil Azure Traffic Manager lokal.
