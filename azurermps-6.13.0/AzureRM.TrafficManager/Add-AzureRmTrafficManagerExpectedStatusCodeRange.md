...
## DESCRIPTION
Cmdlet **Add-AzureRmTrafficManagerExpectedStatusCodeRange** menambahkan rentang kode status yang diharapkan ke objek profil Azure Traffic Manager lokal.
