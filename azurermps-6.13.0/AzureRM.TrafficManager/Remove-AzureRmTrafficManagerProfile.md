...
## DESCRIPTION
Cmdlet **Remove-AzureRmTrafficManagerProfile** menghapus profil Azure Traffic Manager.
...
Perintah kemudian meneruskan profil tersebut ke cmdlet **Remove-AzureRmTrafficManagerProfile** menggunakan operator pipeline.
