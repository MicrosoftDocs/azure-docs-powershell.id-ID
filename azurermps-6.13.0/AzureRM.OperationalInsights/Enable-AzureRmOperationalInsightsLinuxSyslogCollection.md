...
## DESCRIPTION
Cmdlet **Enable-AzureRmOperationalInsightsLinuxSyslogCollection** memulai pengumpulan data syslog dari komputer Linux yang terhubung di ruang kerja.
