...
## DESCRIPTION
**Cmdlet New-AzureRmOperationalInsightsWindowsEventDataSource** menambahkan sumber data yang mengumpulkan log kejadian Windows dari komputer tersambung yang menjalankan sistem operasi Windows di Insights Operasional Azure.
