...
## DESCRIPTION
Cmdlet **Enable-AzureRmOperationalInsightsIISLogCollection** memulai pengumpulan log Layanan Informasi Internet (IIS) dari komputer yang tersambung dalam ruang kerja.
