...
## DESCRIPTION
Cmdlet **Enable-AzureRmOperationalInsightsIISLogCollection** memulai kumpulan log Layanan Informasi Internet (IIS) dari komputer yang tersambung dalam ruang kerja.
