...
## DESCRIPTION
Cmdlet **Add-AzureRmVmssSshPublicKey** menambahkan kunci publik yang dapat Digunakan untuk menyambungkan ke mesin virtual Virtual Machine Scale Set (VMSS) melalui Secure Shell (SSH).
