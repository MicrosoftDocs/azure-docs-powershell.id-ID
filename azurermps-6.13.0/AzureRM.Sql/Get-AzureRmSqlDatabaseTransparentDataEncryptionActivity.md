...
## DESCRIPTION
Cmdlet **Get-AzureRmSqlDatabaseTransparentDataEncryptionActivity** mendapatkan kemajuan pemindaian Enkripsi Data Transparan (TDE) database Azure SQL.
