...
## DESCRIPTION
Cmdlet **Get-AzureRmSqlServerDisasterRecoveryConfigurationActivity** mendapatkan aktivitas untuk konfigurasi pemulihan sistem server database SQL.
