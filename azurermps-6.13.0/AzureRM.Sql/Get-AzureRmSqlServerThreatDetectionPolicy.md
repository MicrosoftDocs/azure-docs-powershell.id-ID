...
## DESCRIPTION
Cmdlet **Get-AzureRmSqlServerThreatDetectionPolicy** mendapatkan kebijakan deteksi ancaman dari server SQL Azure.
Untuk menggunakan cmdlet ini, tentukan *parameter ResourceGroupName* dan *ServerName* untuk mengidentifikasi server di mana cmdlet ini mendapatkan kebijakan.

## EXAMPLES

### Contoh 1: Dapatkan kebijakan deteksi ancaman untuk server
```
...
Perintah ini mendapatkan kebijakan deteksi ancaman untuk server bernama Server01.
