...
## DESCRIPTION
**Cmdlet Get-AzureRmSqlDatabaseRecommendedAction** mendapatkan satu atau beberapa tindakan yang direkomendasikan untuk penasihat Azure SQL Database.
