...
## DESCRIPTION
Cmdlet Remove-AzureRmSqlServerKeyVaultKey menghapus kunci Key Vault dari server SQL yang ditentukan.
Perhatikan bahwa izin server SQL ke kubah kunci tidak diubah.
Untuk mengubah izin, gunakan Set-AzureRmKeyVaultAccessPolicy.
Perhatikan bahwa cmdlet ini tidak membuat perubahan pada Key Vault.
Untuk menghapus kunci dari Key Vault, gunakan Remove-AzureKeyVaultKey.
