...
## DESCRIPTION
Cmdlet **Remove-AzureRmSqlServerActiveDirectoryAdministrator** menghapus administrator Azure Active Directory (Azure AD) untuk AzureSQL Server dalam langganan saat ini.
