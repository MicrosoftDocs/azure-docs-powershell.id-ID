...
ms.openlocfilehash: 450779b20aa1aa8b384f20e18f54fe0473e1f60db2bff3c17404800638d8f37d
ms.sourcegitcommit: 49f8ffe5d8e08ba3d22e3b2e76db0e54dd55d4f0
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 08/11/2021
ms.locfileid: "132419321"
---
...
## DESCRIPTION
Cmdlet **Remove-AzureRmSqlDatabaseLongTermRetentionBackup** menghapus cadangan yang ditentukan.

## EXAMPLES

### Contoh 1: Menghapus cadangan tunggal
```powershell
...
### Contoh 2: Menghapus semua cadangan untuk lokasi
```powershell
