...
## DESCRIPTION
Cmdlet **Get-AzureRmSqlInstance** mengembalikan informasi tentang satu atau beberapa instans terkelola Azure SQL.
...
### Contoh 2: Dapatkan informasi tentang instans
```
