...
## DESCRIPTION
Cmdlet **New-AzureRmSqlServerCommunicationLink** membuat tautan komunikasi untuk transaksi database elastis antara dua server logika di Azure SQL Database.
