...
## DESCRIPTION
Cmdlet **Set-AzureRmRedisCacheDiagnostics** memungkinkan diagnostik untuk Cache Azure Redis.
...
### -StorageAccountId
Menentukan ID sumber daya akun penyimpanan yang digunakan untuk menyimpan data diagnostik.
