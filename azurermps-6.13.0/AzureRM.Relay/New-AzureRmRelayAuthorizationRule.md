...
## DESCRIPTION
Cmdlet **New-AzureRmEroyAuthorizationRule** membuat aturan otorisasi baru untuk entitas Relay yang ditentukan (Namespace/WcfIguy/HybridConnection).
