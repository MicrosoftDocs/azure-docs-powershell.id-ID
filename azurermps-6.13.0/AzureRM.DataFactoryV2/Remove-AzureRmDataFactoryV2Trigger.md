...
## DESCRIPTION
Cmdlet **Remove-AzureRmDataFactoryV2Trigger** menghapus pemicu dari pabrik data. Jika parameter _Paksa_ ditentukan, cmdlet tidak meminta sebelum menghapus pemicu.
