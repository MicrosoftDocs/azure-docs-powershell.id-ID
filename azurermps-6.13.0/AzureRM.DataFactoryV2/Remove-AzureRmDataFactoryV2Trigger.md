...
## DESCRIPTION
Cmdlet **Remove-AzureRmDataFactoryV2Trigger** menghapus pemicu dari pabrik data. Jika parameter _Force_ ditentukan, cmdlet tidak akan meminta anda sebelum menghapus pemicu.
