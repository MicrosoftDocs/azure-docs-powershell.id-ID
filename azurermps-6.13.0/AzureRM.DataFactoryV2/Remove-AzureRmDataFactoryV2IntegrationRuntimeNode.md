...
## DESCRIPTION
Cmdlet Remove-AzureRmDataFactoryV2IntegrationRuntimeNode menghapus simpul dalam runtime integrasi.
...
Perintah ini menghapus simpul bernama 'Node_1' dalam runtime integrasi bernama 'test-selfhost-ir' dalam langganan untuk grup sumber daya bernama 'rg-test-dfv2' dan pabrik data bernama 'test-df-eu2'.
