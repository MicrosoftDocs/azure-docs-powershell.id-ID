...
## DESCRIPTION
Cmdlet Remove-AzureRmDataFactoryV2IntegrationRuntimeNode akan menghapus simpul dalam runtime integrasi.
...
Perintah ini menghapus simpul yang bernama 'Node_1' dalam runtime integrasi yang bernama 'test-selfhost-ir' dalam langganan grup sumber daya bernama 'rg-test-dfv2' dan pabrik data bernama 'test-df-eu2'.
