...
## DESCRIPTION
Cmdlet **Stop-AzureRmDataFactoryV2Trigger** menghentikan pemicu di pabrik data. Jika pemicu berada dalam status 'Dimulai', cmdlet akan menghentikan pemicu dan tidak lagi menjalankan saluran. Jika pemicu sudah berada dalam status 'Dihentikan', cmdlet ini tidak memiliki pengaruh. Jika parameter Force ditentukan, cmdlet tidak akan meminta sebelum menghentikan pemicu.
