...
## DESCRIPTION
Cmdlet **Sync-AzureRmDataFactoryV2IntegrationRuntimeCredential** menyinkronkan kredensial lokal di antara node runtime integrasi, yang memaksa kredensial untuk identik di semua node.
...
Cmdlet menyinkronkan kredensial di antara node runtime integrasi.
