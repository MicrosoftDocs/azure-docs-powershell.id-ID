...
Buat konfigurasi ekspor berkelanjutan wawasan aplikasi baru untuk mengekspor tipe dokumen "Permintaan" dan "Lacak" ke penyimpanan berisi "testcontainer" dalam akun penyimpanan "teststorageaccount" dalam grup sumber daya "testgroup". Token SAS harus valid dan memiliki izin menulis ke kontainer, jika tidak, fitur ekspor berkelanjutan tidak akan berfungsi. Jika token SAS kedaluwarsa, fitur ekspor berkelanjutan akan berhenti berfungsi.
