...
## DESCRIPTION
Cmdlet **Remove-AzureRmServiceBusTopic** menghapus topik dari ruang nama Bus Layanan yang ditentukan.
...
### Contoh 3.2 - Nilai ResourceId Using String
```
