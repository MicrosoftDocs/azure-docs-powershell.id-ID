...
## DESCRIPTION
Cmdlet **Remove-AzureRmServiceBusSubscription** menghapus langganan ke topik dari ruang nama Bus Layanan yang ditentukan.
...
### Contoh 3.2 - ResourceId - Menggunakan nilai string:
```
