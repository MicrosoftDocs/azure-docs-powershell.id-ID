...
## DESCRIPTION
Cmdlet **Test-AzureRmStreamAnalyticsOutput** menguji kemampuan Stream Analytics untuk menyambungkan ke output.
...
Ini menguji status koneksi output dalam StreamingJob.
...
### -JobName
Menentukan nama pekerjaan Azure Stream Analytics tempat output Azure Stream Analytics diinginkan berada.
...
### -Nama
Menentukan nama output Azure Stream Analytics untuk diuji.
