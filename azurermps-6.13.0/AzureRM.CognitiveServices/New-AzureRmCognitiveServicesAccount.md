...
### -Tipe
Menentukan tipe akun yang akan dibuat. Gunakan `Get-AzureRmCognitiveServicesAccountType` cmdlet untuk mendapatkan nilai yang dapat diterima saat ini.
