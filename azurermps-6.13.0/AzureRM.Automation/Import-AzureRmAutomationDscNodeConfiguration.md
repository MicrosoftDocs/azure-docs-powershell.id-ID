...
## DESCRIPTION
Cmdlet **Import-AzureRmAutomationDscConfiguration** mengimpor dokumen konfigurasi Managed Object Format (MOF) ke dalam Azure Automation sebagai konfigurasi node Desired State Configuration (DSC).
