...
## DESCRIPTION
Cmdlet **Remove-AzureRmAutomationDscNodeConfiguration** menghapus metadata dari konfigurasi node APS Desired State Configuration (DSC) dalam Azure Automation.
...
[Cmdlet Azure Automation](./AzureRM.Automation.md)
