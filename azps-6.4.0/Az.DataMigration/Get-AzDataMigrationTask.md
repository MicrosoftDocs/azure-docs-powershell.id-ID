...
Contoh di atas menggambarkan penggunaan cmdlet Get-AzDataMigrationTask untuk mengambil properti yang terkait dengan tugas migrasi Layanan Migrasi Database Azure berdasarkan nama tugas yang disampaikan sebagai parameter input
