...
### -RolloutEnvironment
Nama lingkungan Azure Analysis Services yang menjadi tempat masuk. Diberikan nama lengkap server misalnya, asazure://westcentralus.asazure.windows.net/testserver , nilai yang benar untuk variabel ini akan westcentralus.asazure.windows.net
