...
Perintah ini Mengunci ImmutabilityPolicy wadah Storage blob dengan Storage akun dan nama kontainer.

### Contoh 2: Lock ImmutabilityPolicy of a Storage blob container, with Storage account object
```
...
Perintah ini mengunci ImmutabilityPolicy pada wadah blob Storage, dengan Storage akun. 

### Contoh 3: Kunci ImmutabilityPolicyof a Storage blob container, with container object
```
...
Perintah ini mengunci ImmutabilityPolicy wadah Storage blob dengan objek Storage wadah.

### Contoh 4: Mengunci ImmutabilityPolicy wadah Storage blob, dengan objek ImmutabilityPolicy
```
