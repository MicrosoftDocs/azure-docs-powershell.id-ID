...
Contoh ini membuat koleksi dengan satu aturan. Semua lalu lintas yang cocok dengan kondisi yang diidentifikasi $rule 1 akan ditetapkan menjadi ALAMAT dan port YANG diterjemahkan.
