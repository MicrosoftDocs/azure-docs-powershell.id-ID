...
ms.openlocfilehash: ae221ea5007493c22daf01a8778473ee9dc73e97
ms.sourcegitcommit: 53ef403038f665f1b3a9f616185b31f5de9bd7bb
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 11/03/2021
ms.locfileid: "136213355"
---
# Get-AzFirewall
...
### 3: Ambil semua Firewall dengan pemfilteran
```
...
### 4: Ambil firewall lalu tambahkan kumpulan aturan aplikasi ke Firewall
```
...
### 5: Ambil firewall lalu tambahkan kumpulan aturan jaringan ke Firewall
```
$azFw=Get-AzFirewall -Name "azFw" -ResourceGroupName "rgName"
...
### 6: Ambil firewall lalu ambil kumpulan aturan aplikasi menurut nama dari Firewall
```
$azFw=Get-AzFirewall -Name "azFw" -ResourceGroupName "rgName"
...
### 7: Ambil firewall lalu ambil kumpulan aturan jaringan menurut nama dari Firewall
```
$azFw=Get-AzFirewall -Name "azFw" -ResourceGroupName "rgName"
...
### 8: Ambil firewall lalu hapus kumpulan aturan aplikasi menurut nama dari Firewall
```
$azFw=Get-AzFirewall -Name "azFw" -ResourceGroupName "rgName"
...
### 9: Ambil firewall lalu hapus kumpulan aturan jaringan menurut nama dari Firewall
```
$azFw=Get-AzFirewall -Name "azFw" -ResourceGroupName "rgName"
...
### 10: Ambil firewall lalu alokasikan firewall
```
