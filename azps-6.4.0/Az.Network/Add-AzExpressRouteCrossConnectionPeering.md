...
### Contoh 1: Tambahkan peer ke koneksi silang ExpressRoute yang sudah ada
```
...
### -PeerASN
Nomor AS koneksi silang ExpressRoute Anda. Ini harus menjadi ASN Publik ketika PeeringType adalah AzurePublicPeering.
