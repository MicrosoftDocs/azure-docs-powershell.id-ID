...
## DESCRIPTION
Cmdlet **New-AzSqlSyncMember** membuat Azure SQL Database Anggota Sinkronisasi.
...
### -SyncAgentServerName
Nama pustaka Azure SQL Server tempat agen sinkronisasi berada.
