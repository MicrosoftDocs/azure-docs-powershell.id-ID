...
## DESCRIPTION
Cmdlet Invoke-AzSqlDatabaseFailover cmdlet failover Azure SQL baru. Jika database berada dalam pool elastis, perintah ini akan membuat database tertentu tanpa mempengaruhi database lain dalam pool elastis yang sama.
