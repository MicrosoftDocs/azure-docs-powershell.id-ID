...
## DESCRIPTION
Cmdlet Set-AzSqlInstanceDatabaseSensitivityClassification mengatur tipe informasi dan label sensitivitas kolom di database Azure SQL Managed Instance.
...
### Contoh 2: Atur tipe informasi yang direkomendasikan dan label sensitivitas kolom dalam database Azure SQL Managed Instance.
```powershell
