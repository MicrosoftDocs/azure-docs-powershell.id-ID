...
### Contoh 1: Hapus tipe informasi dan label sensitivitas kolom di Azure SQL Database.
```powershell
...
### Contoh 3: Hapus tipe informasi dan label sensitivitas kolom dalam database Azure SQL menggunakan Piping.
```powershell
