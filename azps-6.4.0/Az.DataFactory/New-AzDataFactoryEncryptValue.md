...
### -Credential
Menentukan kredensial Windows autentikasi (nama pengguna dan kata sandi) yang akan digunakan.
...
Untuk layanan terkait SQL Server di tempat dan layanan tertaut Oracle lokal, gunakan string koneksi.
