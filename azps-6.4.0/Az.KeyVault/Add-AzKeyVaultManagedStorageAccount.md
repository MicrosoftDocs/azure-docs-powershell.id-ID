...
## DESCRIPTION
Menyiapkan Akun Azure Storage yang sudah ada dengan Key Vault Storage kunci Akun yang akan dikelola oleh Key Vault. Akun Storage harus sudah ada. Tombol Storage pernah diekspos ke penelepon.
