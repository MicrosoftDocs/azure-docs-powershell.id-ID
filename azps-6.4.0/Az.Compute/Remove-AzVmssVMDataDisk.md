...
Perintah kedua menghapus lun disk data lun 0 dari VM scale set VM yang disimpan di $VmssVM Perintah terakhir memperbarui VMss VM dengan disk data yang dihapus.
