...
ms.openlocfilehash: a35acc36e2555c4c72b0b02066fd72513c96662c
ms.sourcegitcommit: 53ef403038f665f1b3a9f616185b31f5de9bd7bb
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 11/03/2021
ms.locfileid: "136188827"
---
...
Cmdlet ini mendapatkan otorisasi `azps-test-auth` di bawah awan privat `azps-test-cloud`

### Contoh 2: Otorisasi daftar
```powershell
...
Otorisasi daftar cmdlet ini di `azps-test-auth` bawah awan privat `azps-test-cloud`
