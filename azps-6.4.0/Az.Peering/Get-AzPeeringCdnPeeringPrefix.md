...
Gunakan Get-AzPeeringLocation -Jenis gunakan Nama Kota sebagai kunci untuk memeriksa apakah lokasi peering sudah ada atau Gunakan Get-AzPeeringLocation -Kind untuk mendapatkan semua lokasi \<kind\> \<kind\> peering yang akan dipilih.
