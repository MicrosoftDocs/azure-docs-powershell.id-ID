...
## DESCRIPTION
Cmdlet **Remove-AzServiceBusQueue** menghapus antrean dari ruang nama Bus Layanan tertentu.
...
Menghapus antrean Bus Layanan yang disediakan di $inputobject parameter -InputObject
...
Menghapus antrean Bus Layanan yang disediakan di id ARM dalam $resourceid/string untuk parameter -ResourceId

### Contoh 5: ResourceId - memberikan sebagai string:
```powershell
...
### -ResourceId
Bus Layanan Id Sumber Daya Antrean
