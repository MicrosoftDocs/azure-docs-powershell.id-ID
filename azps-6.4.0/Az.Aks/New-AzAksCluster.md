...
ms.openlocfilehash: 7a9e9f418e0b0f7a66579355556c30b10992a58c
ms.sourcegitcommit: 53ef403038f665f1b3a9f616185b31f5de9bd7bb
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 11/03/2021
ms.locfileid: "136179234"
---
# New-AzAksCluster
...
Kata sandi administrator untuk digunakan dalam Windows VM, panjangnya harus setidaknya 12, yang berisi setidaknya satu karakter huruf kecil, yaitu , satu dan `[a-z]` `[A-Z]` satu karakter khusus `[!@#$%^&*()]` .
