...
ms.openlocfilehash: 6e419b03e9ec5990e6934c99e01902836c24bc27
ms.sourcegitcommit: 53ef403038f665f1b3a9f616185b31f5de9bd7bb
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 11/03/2021
ms.locfileid: "136168662"
---
...
Nilai default lokasi adalah West US 2, Sku adalah Standard_D2s_v3, Sku tier adalah GeneralPurpose, dan ukuran penyimpanan adalah 128GiB.
...
Anda tidak dapat menggunakan subnet yang didelegasikan ke layanan lain

### Contoh 4: Membuat server fleksibel PostgreSql baru dengan jaringan virtual
```powershell
PS C:\> $Vnet = 'vnetname'
...
### Contoh 5: Buat server fleksibel PostgreSql baru dengan nama jaringan virtual dan subnet
```powershell
