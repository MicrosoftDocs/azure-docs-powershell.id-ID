...
## DESCRIPTION
Cmdlet **Set-AzHpcCacheStorageTarget** memperbarui item Storage Target yang dilampirkan ke cache Azure HPC.
...
### -NFS
Perbarui NFS Storage Tipe Target.
