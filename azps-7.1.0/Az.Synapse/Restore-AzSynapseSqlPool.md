...
## DESCRIPTION
Cmdlet **Restore-AzSynapseSqlPool** memulihkan pool SQL Analitik Azure Synapse dari cadangan geo berlebihan, cadangan dari pool SQL yang dihapus atau titik pemulihan dari setiap SQL lokal.
...
Perintah ini membuat azure Synapse Analytics SQL baru yang dipulihkan dari SQL pool cadangan.
...
Perintah ini membuat analitik Azure Synapse SQL lokal yang dipulihkan dari cadangan SQL otomatis yang dihapus.
...
Perintah ini membuat penyimpanan SQL Analitik Azure Synapse dengan tag tertentu dan tipe akun penyimpanan dengan memaksimalkan titik pemulihan dari setiap SQL lokal yang sudah ada untuk memulihkan atau menyalin dari status sebelumnya.
