...
INPUTOBJECT <IJob> : Menentukan objek pekerjaan dari server yang replikasi.
  ...
  - `[TargetInstanceType <String>]`: Tipe objek yang terpengaruh yang merupakan bagian dari Microsoft.Azure.SiteRecovery.V2015_11_10.AffectedObjectType kelas.
