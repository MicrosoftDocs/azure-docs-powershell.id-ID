...
Perintah ini mencantumkan semua uji Insights web aplikasi di bawah aplikasi Insights.
...
### -AppInsightsName
Nama Application Insights component resource.
...
INPUTOBJECT <IApplicationInsightsIdentity> : Parameter Identitas
  - `[ComponentName <String>]`: Nama Sumber daya Insights aplikasi.
