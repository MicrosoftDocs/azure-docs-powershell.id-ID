...
### SQL File Jalur File Kebijakan Proteksi Informasi
```
...
### -Kebijakan
Menentukan definisi kebijakan SQL informasi informasi. Anda dapat menentukan jalur file .json atau string format JSON yang menentukan kebijakan.
