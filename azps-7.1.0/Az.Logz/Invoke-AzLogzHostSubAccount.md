...
### Contoh 2: Mengembalikan payload sub akun logz yang perlu disampaikan dalam badan permintaan untuk menginstal agen Logz.io dalam VM dengan pipeline
```powershell
