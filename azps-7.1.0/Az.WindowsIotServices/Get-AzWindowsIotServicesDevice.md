...
### Contoh 1: Mendapatkan Windows IoT dalam langganan
```powershell
...
Perintah ini akan mendapatkan Windows IoT di bawah grup sumber daya.
...
Perintah ini memberikan Windows IoT menurut objek.
...
Perintah ini mendapatkan Windows IoT berdasarkan pipeline.
