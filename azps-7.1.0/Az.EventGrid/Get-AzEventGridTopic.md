...
List the first 10 Event Grid topics (if any) in resource group \` MyResourceGroupName \` that satisfies the $odataFilter query. Jika hasil lainnya tersedia, $result. NextLink tidak akan $null. Agar dapat memperoleh halaman berikutnya dalam topik, pengguna diharapkan untuk menghubungi kembali Get-AzEventGridTopic menggunakan hasilnya. NextLink diperoleh dari panggilan sebelumnya. Penelepon harus berhenti saat hasil. NextLink menjadi $null.
...
List the first 10 Event Grid topics (if any) in the subscription that satisfies the $odataFilter query. Jika hasil lainnya tersedia, $result. NextLink tidak akan $null. Agar dapat memperoleh halaman berikutnya dalam topik, pengguna diharapkan untuk menghubungi kembali Get-AzEventGridTopic menggunakan hasilnya. NextLink diperoleh dari panggilan sebelumnya. Penelepon harus berhenti saat hasil. NextLink menjadi $null.
