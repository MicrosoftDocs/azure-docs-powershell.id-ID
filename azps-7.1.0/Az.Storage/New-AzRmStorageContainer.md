...
### Contoh 1: Membuat wadah Storage blob dengan nama Storage dan nama wadah akun, dengan metadata
```
...
### Contoh 2: Membuat Storage blob dengan wadah Storage wadah dan objek akun, dengan akses publik sebagai Blob
```
PS C:\>$accountObject = Get-AzStorageAccount -ResourceGroupName "myResourceGroup" -AccountName "myStorageAccount"
PS C:\>New-AzRmStorageContainer -StorageAccount $accountObject -ContainerName "myContainer" -PublicAccess Blob
```

Perintah ini akan membuat Storage blob dengan Storage wadah dan objek akun, dengan akses publik sebagai Blob.
...
### Contoh 5: Buat wadah penyimpanan dan aktifkan penyimpanan yang dapat Storage dengan pembuatan versi
```
...
Mengaktifkan informasi tetap Storage dengan versi pada tingkat wadah.
