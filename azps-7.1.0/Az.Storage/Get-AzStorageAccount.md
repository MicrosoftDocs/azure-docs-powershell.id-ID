...
### Contoh 2: Mendapatkan semua Storage di grup sumber daya
```
PS C:\>Get-AzStorageAccount -ResourceGroupName "RG01"
```

Perintah ini mendapatkan semua Storage pengguna dalam grup sumber daya.
...
Dapatkan GeoReplicationStats akun Storage Anda.
