...
Perintah ini mengubah metadata Storage berbagi file dan berbagi kuota dengan nama akun Storage dan nama berbagi, serta memperlihatkan hasil modifikasi dengan objek berbagi file yang dikembalikan.

### Contoh 2: Mengubah metadata pada file Storage dibagikan dengan objek akun Storage dan nama berbagi
```
PS C:\>$accountObject = Get-AzStorageAccount -ResourceGroupName "myResourceGroup" -StorageAccountName "myStorageAccount"
PS C:\>$share = Update-AzRmStorageShare -StorageAccount $accountObject -Name "myshare" -Metadata @{tag0="value0";tag1="value1"}
```

Perintah ini memodifikasi metadata pada file Storage dibagikan dengan Storage objek akun dan nama berbagi.
