...
### Contoh 2: Menghapus Storage blob dengan wadah Storage nama objek dan wadah akun
```
...
### Contoh 3: Menghapus Storage wadah blob dalam akun Storage dengan pipeline
```
PS C:\>Get-AzStorageContainer -ResourceGroupName "myResourceGroup" -AccountName "myStorageAccount" | Remove-AzRmStorageContainer -Force
```

Perintah ini menghapus semua Storage blob dalam akun Storage dengan pipeline.
