...
### Contoh 1: Dapatkan berbagi Storage file dengan Storage nama akun dan nama berbagi
```
...
### Contoh 2: Daftar semua Storage berbagi file dari Storage anda
```
...
Perintah ini berisi Storage berbagi file Storage nama akun dan nama berbagi, serta menyertakan penggunaan berbagi dalam byte.
