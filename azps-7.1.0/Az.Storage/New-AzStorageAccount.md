...
## DESCRIPTION
Cmdlet **New-AzStorageAccount** membuat akun Azure Storage tersebut.
...
Perintah ini membuat Storage grup sumber daya untuk nama grup sumber daya MyResourceGroup.
...
Perintah ini akan membuat Storage yang memiliki properti NetworkRuleSet dari JSON
...
Perintah ini akan membuat Storage dengan Ruang Nama Hierarki diaktifkan.
...
Lalu dapatkan kunci Storage, dan tampilkan tipe keytype enkripsi dari Queue and Table Service, dan nilai RequireInfrastructureEncryption.
...
Perintah ini akan membuat akun Storage dengan EdgeZone sebagai "microsoftlosangeles1" dan AllowCrossTenantReplication sebagai false, lalu memperlihatkan properti terkait akun yang dibuat.
...
Gets or sets allow or disallow cross AAD tenant object replication. Interpretasi default berlaku untuk properti ini.
