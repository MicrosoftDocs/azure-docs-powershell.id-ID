...
### Contoh 3: Remove legal hold tags from all Storage blob containers in a Storage account with pipeline
```
PS C:\>Get-AzStorageContainer -ResourceGroupName "myResourceGroup" -AccountName "myStorageAccount" | Remove-AzRmStorageContainerLegalHold -Tag  tag1
```

Perintah ini menghapus tag perlindungan hukum dari Storage wadah blob dalam akun Storage dengan pipeline.
