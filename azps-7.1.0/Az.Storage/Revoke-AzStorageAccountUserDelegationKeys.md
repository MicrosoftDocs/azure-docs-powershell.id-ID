...
## DESCRIPTION
Cmdlet **Revoke-AzStorageAccountUserDelegationKeys** mencabut semua kunci Delegasi Pengguna dari akun Storage, sehingga semua token Sas Identitas dari akun Storage juga akan dicabut.

## EXAMPLES

### Contoh 1: Cabut semua kunci Delegasi Pengguna dari Storage tersebut
```powershell
...
### -InputObject
Objek akun penyimpanan, dikembalikan oleh Get_AzStorageAccount, New-AzStorageAccount.
...
### -ResourceGroupName
Nama grup sumber daya yang berisi sumber daya akun penyimpanan.
...
### -StorageAccountName
Nama sumber daya akun penyimpanan.
