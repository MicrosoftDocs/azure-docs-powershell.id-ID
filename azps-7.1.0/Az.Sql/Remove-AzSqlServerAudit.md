...
## DESCRIPTION
Cmdlet **Remove-AzSqlServerAudit** menghapus pengaturan audit server SQL Azure.
Tentukan parameter *ResourceGroupName* *dan ServerName* untuk mengidentifikasi server.

## EXAMPLES

### Contoh 1: Menghapus pengaturan pengauditan server Azure SQL sedang
```
