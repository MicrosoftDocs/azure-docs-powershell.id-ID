...
## DESCRIPTION
Cmdlet **Get-AzSqlDatabaseRestorePoint** mengambil titik pemulihan berbeda dari Azure SQL Gudang Data yang dapat dipulihkan.
Sebagai Azure SQL Database pemulihan, jendela pemulihan akan berkelanjutan.
