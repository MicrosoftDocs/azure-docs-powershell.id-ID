...
### -Edition
Menentukan edisi produk bagi Azure SQL Database elastis pool. Anda tidak dapat mengubah edisi. Nilai yang dapat diterima untuk parameter ini adalah:
- Tidak ada
- Dasar
- Standar
- Premium
