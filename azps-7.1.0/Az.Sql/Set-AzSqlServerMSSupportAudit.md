...
### Contoh 3: Mengaktifkan kebijakan audit operasi dukungan Microsoft hub kejadian dari server SQL Azure
```powershell
...
### Contoh 7: Nonaktifkan, melalui saluran, analitik log Mendukung kebijakan audit operasi dukungan Microsoft untuk server SQL Azure
```powershell
