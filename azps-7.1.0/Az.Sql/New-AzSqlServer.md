...
### -AssignIdentity
Buat dan tetapkan Azure Active Directory Identity untuk server ini untuk digunakan dengan layanan manajemen kunci seperti Azure KeyVault.
