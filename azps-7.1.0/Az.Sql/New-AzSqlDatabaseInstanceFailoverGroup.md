...
## DESCRIPTION
Membuat grup Azure SQL Database Failover Instance baru di antara kawasan tertentu dengan pasangan Instans Terkelola yang tidak bernama.

Dua Azure SQL Database titik akhir TDS dibuat di Name.SqlDatabaseDns Pertanyaaan (misalnya, Name.database.windows.net) dan Name.secondary.SqlDatabaseDns Percontohan. Titik akhir ini mungkin digunakan untuk terhubung ke wilayah utama dan sekunder dari Grup Failover. Jika kawasan utama terpengaruh oleh pemadaman, failover otomatis titik akhir dan database akan dipicu oleh pendiktean oleh kebijakan failover dan masa tenggang Instance Failover Group.
...
Perintah ini akan membuat grup Azure SQL Database baru Failover Instance. (otomatisgenerated)
