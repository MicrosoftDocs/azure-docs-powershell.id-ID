...
## DESCRIPTION
Cmdlet **New-AzSqlSyncAgent** membuat Azure SQL Sync Agent.

## EXAMPLES

### Contoh 1: Buat agen sinkronisasi untuk server Azure SQL.
```
...
Perintah ini akan membuat agen sinkronisasi untuk server Azure SQL sama.
