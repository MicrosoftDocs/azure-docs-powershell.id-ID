...
### Contoh 3: Get metrics for a Azure SQL Elastis Database Pool
```
...
Perintah ini mengembalikan metrik untuk pool database elastis Azure SQL bernama ElastisPool01.
