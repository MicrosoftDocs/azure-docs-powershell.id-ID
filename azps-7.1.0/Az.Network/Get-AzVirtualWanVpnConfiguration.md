...
Jika commandlet berhasil, konfigurasi pengunduhan akan ditulis ke blob yang ditunjukkan oleh SignedSasUrl. Di bawah ini adalah contoh untuk bagaimana URL akan terlihat seperti: https://[account].blob.core.windows.net/[container]/[path/to/blob]? [SAS]
