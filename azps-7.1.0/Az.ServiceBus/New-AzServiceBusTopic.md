...
## DESCRIPTION
Cmdlet **New-AzServiceBusTopic** membuat topik baru Bus Layanan di ruang nama Bus Layanan tertentu.
...
Membuat topik baru Bus Layanan dalam `SB-Topic_exampl1` ruang nama Bus Layanan nama yang `SB-Example1` ditentukan.
...
Menentukan durasi setelah pesan kedaluwarsa, dimulai dari ketika pesan dikirim ke Bus Layanan.
...
### -SizeInBytes
Menentukan ukuran topik dalam byte.
...
### -SupportOrdering
Menunjukkan apakah topik mendukung pemesanan.
