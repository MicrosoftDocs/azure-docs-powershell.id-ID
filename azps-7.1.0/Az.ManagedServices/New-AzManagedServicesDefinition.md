...
Kumpulan objek otorisasi yang memenuhi syarat yang menjelaskan akses langsung Azure Active Directory lokal dalam penyewa managedBy akan diterima pada sumber daya yang didelegasikan dalam penyewa terkelola.
...
AUTHORIZATION <IAuthorization[]>: Kumpulan objek otorisasi yang menjelaskan prinsipal Azure Active Directory akses dalam penyewa managedBy akan diterima pada sumber daya yang didelegasikan dalam penyewa yang dikelola.
  ...
  - `RoleDefinitionId <String>`: Pengidentifikasi peran bawaan Azure yang menentukan izin yang akan tersedia Azure Active Directory utamanya pada lingkup yang diproyeksikan.
