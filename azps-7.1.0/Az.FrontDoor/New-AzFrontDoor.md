...
## DESCRIPTION
Cmdlet **New-AzFrontDoor** membuat penyeimbang muat Azure Front Door baru dalam grup sumber daya tertentu di bawah langganan saat ini

## EXAMPLES

### Contoh 1: Buat Pintu Depan berdasarkan parameter yang diberikan.
```powershell
