...
### Contoh 1: Stop Spring Cloud Service by name.
```powershell
PS C:\> Stop-AzSpringCloudAppDeployment -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service -AppName gateway -DeploymentName default
```

Hentikan Layanan Awan Musim Semi menurut namanya.

### Contoh 2: Stop Spring Cloud Service from pipe.
```powershell
