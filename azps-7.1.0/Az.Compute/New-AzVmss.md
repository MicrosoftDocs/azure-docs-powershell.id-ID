...
* Perintah kedua belas menggunakan **New-AzLoadBalancerProbeConfig** untuk membuat kota dan menyimpan informasi fiji di variabel yang bernama $Probe.
...
* Perintah terdekat menggunakan **Get-AzLoadBalancer** untuk mendapatkan informasi tentang penyeimbang muat yang dibuat dalam perintah ke-lima belas dan menyimpan informasi dalam variabel bernama $ExpectedLb.
