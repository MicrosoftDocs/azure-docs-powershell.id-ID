...
## DESCRIPTION
Cmdlet **Remove-AzureRmApiManagementProperty** menghapus Properti Manajemen AZURE **API.**

## EXAMPLES

### Contoh 1: Hapus properti
```
PS C:\>Remove-AzureRmApiManagementProperty -Context $ApimContext -PropertyId "Property11" -PassThru
```

Perintah ini akan menghapus properti yang memiliki ID Properti11.
