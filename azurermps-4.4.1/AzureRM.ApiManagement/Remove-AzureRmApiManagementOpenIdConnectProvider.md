...
## DESCRIPTION
Cmdlet **Remove-AzureRmApiManagementOpenIdConnectProvider** menghapus penyedia Koneksi OpenID untuk Manajemen API Azure.
...
Perintah ini akan menghapus penyedia yang memiliki ID OICProvicer01.
