...
ms.openlocfilehash: 21bff94a371590c872ef4f4180796d4472d43382
ms.sourcegitcommit: 6dce6f7972b2236b87b25b31465bffaad2435711
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 09/13/2021
ms.locfileid: "132421039"
---
...
### Parameter default untuk menonaktifkan pemberitahuan log aktivitas
```
Disable-AzureRmActivityLogAlert -Name <String> -ResourceGroupName <String>
 [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Parameter untuk menonaktifkan pemberitahuan log aktivitas yang mengambil nilai dari pipa
```
Disable-AzureRmActivityLogAlert -InputObject <PSActivityLogAlertResource>
 [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Parameter untuk menonaktifkan pemberitahuan log aktivitas yang mengambil nilai ResourceId dari pipa
```
