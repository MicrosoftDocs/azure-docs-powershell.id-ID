...
### Parameter untuk New-AzureRmAutoscaleProfile cmdlet tanpa waktu terjadwal
```
...
### Parameter untuk New-AzureRmAutoscaleProfile cmdlet menggunakan penjadwalan tanggal perbaikan
```
New-AzureRmAutoscaleProfile -Name <String> -DefaultCapacity <String> -MaximumCapacity <String>
...
### Parameter untuk New-AzureRmAutoscaleProfile cmdlet menggunakan penjadwalan ulang
```
New-AzureRmAutoscaleProfile -Name <String> -DefaultCapacity <String> -MaximumCapacity <String>
...
Dua perintah pertama membuat aturan, dan menyimpannya dalam variabel $Rule 1 dan $Rule 2, secara berurutan.

Perintah ketiga membuat profil bernama ProfileName menggunakan aturan di Rule1 dan Rule2, lalu menyimpannya di $Profile 1 tertentu.
...
Tidak semua nilai ini didukung.
