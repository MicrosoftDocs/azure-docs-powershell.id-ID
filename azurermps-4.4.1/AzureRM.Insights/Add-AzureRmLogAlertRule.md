...
ms.locfileid: "132419782"
---
# Add-AzureRmLogAlertRule

## SYNOPSIS
Menambahkan atau mengganti aturan pemberitahuan log.
...
## DESCRIPTION
Cmdlet **Add-AzureRmLogAlertRule** menambahkan atau mengganti aturan pemberitahuan kejadian.
Aturan yang ditambahkan dikaitkan dengan grup sumber daya dan memiliki nama.

Seperti yang diumumkan dalam rilis sebelumnya: **Cmdlet Add-AzureRMLogAlertRule akan** ditolak dalam rilis mendatang. Setelah 1 Oktober 2017, cmdlet tidak akan berpengaruh lagi karena fungsi ini akan dialihkan ke Peringatan Log Aktivitas. Silakan lihat **_https://aka.ms/migratemealerts_** informasi selengkapnya.

## EXAMPLES

### Contoh 1: Tambahkan aturan pemberitahuan log
```
...
Perintah ini menambahkan atau memperbarui aturan pemberitahuan berbasis kejadian.
...
### -Level
Menentukan tingkat kejadian aturan adalah pemantauan.
Tentukan parameter ini hanya untuk aturan berbasis kejadian.
...
### -Lokasi
Menentukan lokasi untuk aturan tersebut.
...
### -TargetResourceGroup
Menentukan grup sumber daya dari sumber daya yang menjadi pemantauan aturan.
...
### -TargetResourceId
Menentukan ID sumber daya yang memantau aturan.
...
Menentukan penyedia sumber daya dari sumber daya tersebut, aturan adalah pemantauan.
