...
### Sebuah kunci di lingkup grup sumber daya.
```
...
### Sebuah kunci di lingkup sumber daya grup sumber daya.
```
...
### Sebuah kunci dengan lingkup tertentu.
```
...
### Kunci pada lingkup sumber daya langganan.
```
Remove-AzureRmResourceLock -LockName <String> [-Force] -ResourceName <String> -ResourceType <String>
...
### Kunci pada lingkup sumber daya penyewa.
```
Remove-AzureRmResourceLock -LockName <String> [-Force] -ResourceName <String> -ResourceType <String>
...
## DESCRIPTION
Cmdlet **Remove-AzureRmResourceLock** menghapus kunci sumber daya Azure.
