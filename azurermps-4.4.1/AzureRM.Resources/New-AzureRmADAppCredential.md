...
## DESCRIPTION
Cmdlet New-AzureRmADAppCredential ini dapat digunakan untuk menambahkan kredensial baru atau untuk meluncurkan kredensial untuk aplikasi.
...
Kredensial kata sandi baru ditambahkan ke aplikasi yang sudah ada.
Dalam contoh ini, nilai kata sandi yang diberikan ditambahkan ke aplikasi menggunakan id objek aplikasi.
...
Kredensial kunci baru ditambahkan ke aplikasi yang sudah ada.
Dalam contoh ini, sertifikat X509 publik yang dikodekan yang disediakan ("myapp.cer") ditambahkan ke aplikasi menggunakan applicationId.
...
### -ApplicationId
Id aplikasi untuk menambahkan kredensial.
