...
### Contoh 2: Membuat grup sumber daya dengan tag
```
...
Untuk menambahkan atau mengubah tag, Anda harus mengganti kumpulan tag untuk grup sumber daya tersebut.
...
Untuk mendapatkan tag yang sudah ditentukan sebelumnya, gunakan cmdlet Get-AzureRMTag baru.
