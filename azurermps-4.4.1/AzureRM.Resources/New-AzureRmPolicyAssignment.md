...
### Penetapan kebijakan tanpa parameter (Default)
```
...
### Penetapan kebijakan dengan parameter melalui objek parameter kebijakan
```
New-AzureRmPolicyAssignment -Name <String> -Scope <String> [-NotScope <String[]>] [-DisplayName <String>]
...
### Penetapan kebijakan dengan parameter melalui string parameter kebijakan
```
New-AzureRmPolicyAssignment -Name <String> -Scope <String> [-NotScope <String[]>] [-DisplayName <String>]
 [-Description <String>] -PolicyDefinition <PSObject> [-PolicySetDefinition <PSObject>]
...
### Penetapan kebijakan dengan parameter melalui objek parameter kumpulan kebijakan
```
New-AzureRmPolicyAssignment -Name <String> -Scope <String> [-NotScope <String[]>] [-DisplayName <String>]
 [-Description <String>] [-PolicyDefinition <PSObject>] -PolicySetDefinition <PSObject>
 -PolicyParameterObject <Hashtable> [-Sku <Hashtable>] [-ApiVersion <String>] [-Pre]
...
### Penetapan kebijakan dengan parameter melalui string parameter kumpulan kebijakan
```
New-AzureRmPolicyAssignment -Name <String> -Scope <String> [-NotScope <String[]>] [-DisplayName <String>]
 [-Description <String>] [-PolicyDefinition <PSObject>] -PolicySetDefinition <PSObject>
 -PolicyParameter <String> [-Sku <Hashtable>] [-ApiVersion <String>] [-Pre]
...
Perintah kedua mendapatkan definisi kebijakan bernama VirtualMachinePolicy menggunakan cmdlet Get-AzureRmPolicyDefinition baru.
Perintah menyimpan objek tersebut dalam $Policy variabel.

Perintah terakhir menetapkan kebijakan di $Policy di tingkat grup sumber daya.
...
### -PolicyDefinition
Menentukan kebijakan, sebagai objek **PSObject** yang berisi aturan kebijakan.
...
Misalnya, untuk menetapkan kebijakan ke grup sumber daya, tentukan hal berikut ini:

`/subscriptions/`nama grup `/resourcegroups/` sumber daya ID langganan
...
### -Sku
Tabel hash yang menyatakan properti sku. Default untuk Sku Gratis: Nama = A0, Tier = Gratis
