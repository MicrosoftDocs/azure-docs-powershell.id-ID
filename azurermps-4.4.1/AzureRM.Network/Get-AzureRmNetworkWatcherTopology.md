...
## DESCRIPTION
Cmdlet Get-AzureRmNetworkWatcherTopology cmdlet tingkat jaringan dan hubungannya dalam grup sumber daya. Catatan: Jika sumber daya dari beberapa kawasan berada dalam grup sumber daya, hanya sumber daya di kawasan yang sama dengan Pengawas Jaringan yang akan disertakan dalam output JSON.

## EXAMPLES

### -------------------------- Contoh 1: Dapatkan dukungan Topologi Azure --------------------------
```
