...
## DESCRIPTION
Cmdlet **Set-AzureRmApplicationGatewayIPConfiguration** mengubah konfigurasi IP.
Konfigurasi IP berisi subnet di mana gateway aplikasi digunakan.

## EXAMPLES

### Contoh 1: Mengatur status tujuan konfigurasi IP
```
...
Perintah ketiga mendapatkan gateway aplikasi bernama ApplicationGateway01 yang dimiliki oleh grup sumber daya yang bernama ResourceGroup01 dan menyimpannya di $AppGw tertentu.
