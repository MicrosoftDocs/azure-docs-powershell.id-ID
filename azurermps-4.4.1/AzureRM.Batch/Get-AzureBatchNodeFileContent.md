...
Perintah ini mendapatkan file node yang bernama StdOut.txt, dan menyimpannya ke jalur file E:\PowerShell\StdOut.txt pada komputer lokal.
...
### -Nama
Menentukan nama file node yang diambil cmdlet ini.
