...
## DESCRIPTION
Cmdlet **Reset-AzureBatchComputeNode** menginstal ulang sistem operasi pada node perhitungan yang ditentukan.
...
### Contoh 2: Mengganti semua node dalam sebuah pool
```
