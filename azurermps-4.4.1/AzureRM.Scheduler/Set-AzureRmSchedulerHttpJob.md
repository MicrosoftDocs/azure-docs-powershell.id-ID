...
## DESCRIPTION
Cmdlet **Set-AzureRmSchedulerHttpJob** mengubah pekerjaan HTTP di Azure Scheduler.
...
### -Method
Menentukan metode untuk tipe tindakan untuk pekerjaan ini.
Nilai yang dapat diterima untuk parameter ini adalah:
