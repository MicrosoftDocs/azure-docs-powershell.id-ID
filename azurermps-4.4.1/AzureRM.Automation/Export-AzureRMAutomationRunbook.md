...
## DESCRIPTION
Cmdlet **Export-AzureRmAutomationRunbook** mengekspor runbook Azure Automation ke file skrip wps_2 (.ps1 ), untuk runbooks wps_2 atau wps_2 Workflow, atau ke file runbook grafis (.graphrunbook), untuk runbooks grafis.
