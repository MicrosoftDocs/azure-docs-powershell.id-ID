...
## DESCRIPTION
Cmdlet **New-AzureRmServerManagementGateway** membuat gateway Manajemen Azure Server.
...
### -AutoUpgrade
Menunjukkan bahwa gateway akan melakukan pemutakhiran otomatis sendiri saat versi baru dirilis.
...
### -GatewayName
Menentukan nama gateway yang dibuat cmdlet ini.
...
### -Lokasi
Menentukan lokasi untuk membuat gateway.
...
### -ResourceGroupName
Menentukan nama grup sumber daya di mana cmdlet ini membuat gateway.
...
Anda bisa menggunakan tag untuk mengidentifikasi Gateway dari sumber daya Azure lainnya.
