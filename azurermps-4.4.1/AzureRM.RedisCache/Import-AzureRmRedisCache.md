...
## DESCRIPTION
Cmdlet **Import-AzureRmRedisCache** mengimpor data dari blob ke Singgahan Azure Redis.
...
### -File
Menentukan URL SAS dari blob yang kontennya diimpor cmdlet ini ke cache. Anda dapat menghasilkan URL SAS menggunakan perintah PowerShell berikut:
