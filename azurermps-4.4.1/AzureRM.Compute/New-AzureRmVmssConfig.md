...
### -HealthProbeId
Tentukan ID sisi penyeimbang muat yang digunakan untuk menentukan kesehatan instans dalam kumpulan skala mesin virtual. HealthProbeId berbentuk '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/msdns/{msdnName}'.
