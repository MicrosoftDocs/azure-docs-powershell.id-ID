...
## DESCRIPTION
Cmdlet **Set-AzureRmSiteRecoveryVM** mengatur opsi proteksi sisi pemulihan, seperti ukuran mesin virtual pemulihan dan jaringan mesin virtual pemulihan, untuk entitas perlindungan Pemulihan Situs Azure.
...
### -NicSelectionType
Menentukan properti pilihan adaptor jaringan.
...
Menentukan alamat IP statis yang ditetapkan ke pengontrol adaptor jaringan utama yang sedang dalam proses pemulihan.
...
Menentukan nama subnet jaringan virtual Azure untuk melampirkan pengontrol adaptor jaringan utama pada pemulihan.
...
### ASRVirtualMachine
Parameter 'VirtualMachine' menerima nilai tipe 'ASRVirtualMachine' dari saluran
