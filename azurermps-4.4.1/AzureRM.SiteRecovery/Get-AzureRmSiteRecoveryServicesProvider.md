...
## DESCRIPTION
Cmdlet **Get-AzureRmSiteRecoveryServicesProvider** mendapatkan informasi tentang penyedia Pemulihan Situs Azure di vault.
...
### -FriendlyName
Menentukan nama penyedia Pemulihan Situs Azure yang mudah didaurkan oleh cmdlet ini.
...
### -Nama
Tentukan nama Penyedia Pemulihan Situs Azure yang akan dapatkan cmdlet ini.
