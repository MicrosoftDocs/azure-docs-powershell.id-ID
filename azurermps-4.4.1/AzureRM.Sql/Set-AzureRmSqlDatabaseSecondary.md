...
## DESCRIPTION
Cmdlet **Set-AzureRmSqlDatabaseSecbasery** mengalihkan database sekunder menjadi database primer untuk memulai failover.
...
Menentukan nama grup sumber daya tempat mitra Azure SQL Database ditetapkan.
...
###  
Anda dapat pipa contoh objek **Database** untuk database sekunder agar gagal dan menjadikan database utama sebagai cmdlet ini.

## OUTPUTS

###  
Cmdlet ini mengembalikan **ReplicationLink.**
