...
Perintah ini membuat database bernama Database01 dalam kolam elastis bernama ElastisPool01 di server Server01.
...
### -Tag
Menentukan kamus pasangan Nilai kunci dalam bentuk tabel hash yang terkait dengan database baru oleh cmdlet ini. Misalnya:
