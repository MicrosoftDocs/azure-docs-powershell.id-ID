...
### Contoh 3: Dapatkan metrik untuk Azure SQL Pool Database Elastis
```
...
### -ResourceGroupName
Menentukan nama grup sumber daya yang berisi kelompok elastis yang dapatkan cmdlet ini.
