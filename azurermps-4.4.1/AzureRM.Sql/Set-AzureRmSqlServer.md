...
## DESCRIPTION
Cmdlet **Set-AzureRmSqlServer** mengubah properti server Azure SQL Database.
...
### -Tag
Menentukan kamus tag yang terkait dengan server cmdlet ini. Pasangan nilai kunci dalam bentuk tabel hash yang diatur sebagai tag di server. Misalnya:
