...
ms.openlocfilehash: df39b2fe99975de01cd2ff2d5a622089af6c9e4d
ms.sourcegitcommit: 6dce6f7972b2236b87b25b31465bffaad2435711
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 09/13/2021
ms.locfileid: "132423922"
---
...
## DESCRIPTION
Cmdlet **Set-AzureStorageContainerStoredAccessPolicy** mengatur kebijakan akses tersimpan untuk tempat penyimpanan Azure.

## EXAMPLES

### Contoh 1: Menetapkan kebijakan akses tersimpan di wadah penyimpanan dengan izin penuh
```
PS C:\>Set-AzureStorageContainerStoredAccessPolicy -Container "MyContainer" -Policy "Policy06" -Permission rwdl
```

Perintah ini mengatur kebijakan akses yang bernama Policy06 untuk wadah penyimpanan bernama MyContainer.
