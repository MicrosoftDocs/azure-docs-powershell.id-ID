...
### Contoh 2: Upload sertifikat dan mengikatnya ke Web App
```
...
Contoh 2 juga mengikat sertifikat E3A38EBA60CAA1C162785A2E1C44A15AD450199C3 ke Aplikasi Web bernama ContosoWebApp.
Namun, dalam hal ini, sertifikat belum diunggah ke Azure.
Karenanya, *parameter CertificateFilePath* digunakan untuk menentukan salinan lokal sertifikat. file PFX.
Sertifikat ini akan diunggah ke Azure, lalu pengikatan SSL baru akan dibuat.
...
Anda bisa menggunakan cmdlet Get-AzureRMWebAppSlot untuk mendapatkan slot.
