...
Perintah ini mengunggah file ke SrcFile.csv dan menambahkannya ke folder MyFiles di Data Lake Store sebagai File.csv.
...
### -ConcurrentFileCount
Tentukan jumlah maksimum file yang akan diunggah secara paralel untuk unggahan folder.
...
### -ForceBinary
Menunjukkan bahwa operasi ini mengunggah file sebagai file biner.
...
### -Resume
Menunjukkan bahwa operasi ini harus melanjutkan unggahan yang sebelumnya dibatalkan atau gagal.
