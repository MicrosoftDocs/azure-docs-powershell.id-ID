...
### Tidak ada pembuatan log diagnostik (Default)
```
...
### Menyertakan pembuatan log diagnostik
```
Export-AzureRmDataLakeStoreItem [-Account] <String> [-Path] <DataLakeStorePathInstance> [-Destination] <String>
 [-Recurse] [-Resume] [[-PerFileThreadCount] <Int32>] [[-ConcurrentFileCount] <Int32>] [-Force]
...
## DESCRIPTION
Cmdlet **Export-AzureRmDataLakeStoreItem** mengunduh file dari Data Lake Store.
...
Perintah ini mengunduh file TestSource.csv data Lake Store ke C:\Test.csv.
...
### -ConcurrentFileCount
Menentukan jumlah maksimum file yang diunduh secara paralel untuk unduhan folder.
Nilai default adalah lima (5).
...
### -PerFileThreadCount
Menentukan jumlah maksimum utas untuk digunakan per file.
Nilai default adalah sepuluh (10).
...
### -Resume
Menunjukkan bahwa file atau file yang disalin merupakan lanjutan dari unduhan sebelumnya.
Unduhan berusaha melanjutkan dari file terakhir yang tidak diunduh sepenuhnya.
...
### string
Jalur tujuan pengunduhan file atau folder.
