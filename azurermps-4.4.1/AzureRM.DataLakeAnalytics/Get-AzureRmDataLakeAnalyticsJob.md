...
### Semua Dalam Grup dan Akun Sumber Daya (Default)
```
...
### -Sertakan
Menentukan opsi yang menunjukkan tipe informasi tambahan untuk diambil tentang pekerjaan tersebut.
...
### Guid
Parameter 'JobId' menerima nilai tipe 'Guid' dari saluran

## OUTPUTS

### JobInformation
Detail informasi pekerjaan yang ditentukan

### Daftar<JobInformation>
Daftar pekerjaan dalam akun Data Lake Analytics yang ditentukan.
