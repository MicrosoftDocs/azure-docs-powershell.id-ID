...
### Kirim pekerjaan dengan jalur skrip untuk U-SQL
```
...
### Mengirimkan pekerjaan dengan jalur skrip untuk SQL dengan informasi per pengulangan
```
Submit-AzureRmDataLakeAnalyticsJob [-Account] <String> [-Name] <String> [-ScriptPath] <String>
 [[-Runtime] <String>] [[-CompileMode] <String>] [-CompileOnly] [[-DegreeOfParallelism] <Int32>]
...
### Kirim Tugas SQL Kerja dengan informasi pengulangan
```
Submit-AzureRmDataLakeAnalyticsJob [-Account] <String> [-Name] <String> [-Script] <String>
 [[-Runtime] <String>] [[-CompileMode] <String>] [-CompileOnly] [[-DegreeOfParallelism] <Int32>]
 [[-Priority] <Int32>] -RecurrenceId <Guid> [-RecurrenceName <String>]
...
### Kirimkan pekerjaan dengan jalur skrip untuk SQL dengan informasi pengulangan dan saluran
```
Submit-AzureRmDataLakeAnalyticsJob [-Account] <String> [-Name] <String> [-ScriptPath] <String>
 [[-Runtime] <String>] [[-CompileMode] <String>] [-CompileOnly] [[-DegreeOfParallelism] <Int32>]
...
### Kirimkan Informasi SQL Kerja dengan pengulangan dan informasi saluran
```
Submit-AzureRmDataLakeAnalyticsJob [-Account] <String> [-Name] <String> [-Script] <String>
 [[-Runtime] <String>] [[-CompileMode] <String>] [-CompileOnly] [[-DegreeOfParallelism] <Int32>]
 [[-Priority] <Int32>] -RecurrenceId <Guid> [-RecurrenceName <String>] -PipelineId <Guid>
...
### -CompileMode
Menentukan mode kompilasi pekerjaan.
...
### -CompileOnly
Menunjukkan bahwa cmdlet ini menyusun pekerjaan tanpa menjalankannya.
...
### -DegreeOfParallelism
Menentukan Pekerjaan Unit Analitik Danau (DLAU, Data Lake Analytics Units), yang menunjukkan perbolehkan paralel maksimum dari pekerjaan tersebut.
...
Jika tidak ditentukan, prioritasnya adalah 1000.
Angka rendah menunjukkan prioritas pekerjaan yang lebih tinggi.
...
### -Runtime
Menentukan versi runtime pekerjaan.
...
### -Script
Menentukan konten skrip untuk dijalankan.
...
### -ScriptPath
Menentukan jalur file lokal ke skrip untuk dijalankan.
