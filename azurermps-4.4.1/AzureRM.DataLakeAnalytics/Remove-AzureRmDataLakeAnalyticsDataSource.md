...
### Menghapus akun penyimpanan Data Lake
```
...
### Menghapus akun penyimpanan Blob
```
...
## DESCRIPTION
Cmdlet **Remove-AzureRmDataLakeAnalyticsDataSource** menghapus sumber data dari akun Azure Data Lake Analytics.
...
Perintah ini menghapus sumber data yang bernama AzureStorage01 dari akun yang bernama ContosoAdlAccount.
...
### bool
Jika PassThru ditentukan, mengembalikan true setelah penyelesaian operasi.
