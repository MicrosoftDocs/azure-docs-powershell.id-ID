...
## DESCRIPTION
Cmdlet **Get-AzureRmDataFactoryRun** dijalankan untuk potongan dataset data di Azure Data Factory.
...
Untuk mendapatkan waktu mulai potongan, gunakan cmdlet Get-AzureRmDataFactorySlice.
...
*StartDateTime* harus ditentukan dalam format ISO8601, seperti dalam contoh berikut: 
...
### System.Collections.generic.List'1[[Microsoft.WindowsAzure.commands.Utilities.PSDataS pemutakhiranRun, Microsoft.WindowsAzure.Commands.Utilities, Version=0.8.2.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35]]
