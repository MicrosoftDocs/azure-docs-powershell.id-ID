...
## DESCRIPTION
Cmdlet **Set-AzureRmSchedulerServiceBusTopicJob** mengubah pekerjaan topik bus layanan di Azure Scheduler.
...
### -ServiceBusMessage
Menentukan pesan topik bus layanan.
...
### -ServiceBusTopicPath
Menentukan jalur topik bus layanan.
