...
## DESCRIPTION
Cmdlet **Get-AzureRmSqlDatabaseImportExportStatus** mendapatkan detail tentang impor file bacpac dari akun penyimpanan ke Azure SQL Database atau ekspor Azure SQL Database sebagai file bacpac ke akun penyimpanan.
...
### -OperationStatusLink
Menentukan link status yang dikembalikan dari cmdlet New-AzureRmSqlDatabaseExport atau New-AzureRmSqlDatabaseImport.
