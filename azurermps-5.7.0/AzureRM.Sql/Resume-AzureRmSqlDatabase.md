...
## DESCRIPTION
Cmdlet **Resume-AzureRmSqlDatabase** melanjutkan database Azure SQL Gudang Data.
...
Perintah ini melanjutkan database Azure SQL Gudang Data yang ditangguhkan.
...
## CATATAN
* Cmdlet **Resume-AzureRmSqlDatabase** hanya berfungsi di Database Azure SQL Gudang Data. Operasi ini tidak didukung di Azure SQL Database Edisi Azure SQL Database Dasar, Standar Premium terbaru.
