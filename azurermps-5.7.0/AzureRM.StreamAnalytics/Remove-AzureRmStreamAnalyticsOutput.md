...
## DESCRIPTION
Cmdlet **Remove-AzureRmStreamAnalyticsOutput** secara asinkron menghapus output dari pekerjaan Analitik Stream di Azure.
...
### -Nama
Menentukan nama output Analitik Azure Stream yang akan dihapus.
