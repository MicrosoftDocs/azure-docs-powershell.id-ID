...
## DESCRIPTION
Cmdlet **Export-AzureRmAutomationRunbook** mengekspor runbook Azure Automation ke file skrip wps_2 (.ps1), untuk runbooks alur kerja wps_2 atau wps_2, atau ke file buku jalankan grafis (.graphrunbook), untuk runbooks grafis.
Nama runbook menjadi nama file yang diekspor.

## EXAMPLES

### Contoh 1: Mengekspor runbook
```
