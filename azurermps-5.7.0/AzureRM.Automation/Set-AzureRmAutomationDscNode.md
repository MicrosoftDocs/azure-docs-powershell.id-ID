...
## DESCRIPTION
Cmdlet **Set-AzureRmAutomationDscNode** memodifikasi konfigurasi node Konfigurasi Status Yang Diinginkan (DSC, Desired State Configuration).
