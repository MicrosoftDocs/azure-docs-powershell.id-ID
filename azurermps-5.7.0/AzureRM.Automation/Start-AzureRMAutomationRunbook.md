...
Cmdlet ini mengembalikan **objek** Pekerjaan, kecuali jika Anda _menentukan_ parameter Tunggu.

Jika Anda tidak menentukan _Tunggu_, Azure PowerShell segera mengembalikan **objek** Pekerjaan.
Jika Anda _menentukan_ Tunggu, Azure PowerShell akan menyelesaikan pekerjaan, lalu mengembalikan hasilnya.
