...
## DESCRIPTION
Cmdlet **Remove-AzureRmServerManagementGateway** menghapus gateway Manajemen Azure Server.
...
### -Gateway
Menentukan gateway yang dihapus cmdlet ini.

Parameter ini mungkin digunakan sebagai ganti parameter *ResourceGroupName* dan *GatewayName.*
...
### -GatewayName
Menentukan nama gateway yang dihapus cmdlet ini.
...
### -ResourceGroupName
Menentukan nama grup sumber daya di gateway tempatnya berada.
...
## CATATAN
* Semua node di Gateway harus dihapus sebelum menggunakan cmdlet ini; jika tidak cmdlet ini akan gagal.
