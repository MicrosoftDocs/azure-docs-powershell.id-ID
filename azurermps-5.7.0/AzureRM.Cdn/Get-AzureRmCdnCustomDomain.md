...
## DESCRIPTION
Cmdlet **Get-AzureRmCdnCustomDomain** mendapatkan domain kustom Azure Content Delivery Network (CDN) dan pengaturan terkait.
...
### -CdnEndpoint
Menentukan CDN titik akhir domain kustom sebagai anggota.
...
###  
Cmdlet ini mengembalikan objek domain kustom.
