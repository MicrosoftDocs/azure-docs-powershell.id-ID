...
## DESCRIPTION
Cmdlet **Unpublish-AzureRmCdnEndpointContent** membersihkan konten dari titik akhir Azure Content Delivery Network (CDN).
...
### -CdnEndpoint
Menentukan titik akhir yang pembersihan cmdlet ini.
