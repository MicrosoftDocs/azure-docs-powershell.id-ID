...
## DESCRIPTION
Sumber Get-AzureRmNetworkWatcherPacketCapture mendapatkan properti dan status sumber daya penangkapan paket.

## EXAMPLES

### --- Contoh 1: Membuat Penangkapan Paket dengan beberapa filter dan mengambil status ---
```
...
Dalam contoh ini, kami membuat penyimpanan paket bernama "PacketCaptureTest" dengan beberapa filter dan batas waktu. Setelah sesi selesai, sesi akan disimpan ke akun penyimpanan tertentu. Lalu kami Get-AzureRmNetworkWatcherPacketCapture untuk mengambil status sesi pengambilan gambar. 
