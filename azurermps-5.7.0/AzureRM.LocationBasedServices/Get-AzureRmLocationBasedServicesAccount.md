...
## DESCRIPTION
Cmdlet **Get-AzureRmLocationBasedServicesAccount** mendapatkan akun Layanan Berbasis Lokasi yang disediakan, baik menurut grup dan nama sumber daya, atau menurut id sumber daya.

Selain itu, daftar semua akun di Grup Sumber Daya dapat dikembalikan, atau semua akun Layanan Berbasis Lokasi untuk langganan saat ini.
...
Mendapatkan semua akun Layanan Berbasis Lokasi di grup sumber daya MyResourceGroup.
...
Mendapatkan semua akun Layanan Berbasis Lokasi di langganan saat ini.
...
Mendapatkan akun Layanan Berbasis Lokasi yang ditentukan oleh Id Sumber Daya.
...
Cmdlet ini mengembalikan objek **PSLocationBasedServicesAccount.**
Anda bisa mengubah objek ini, lalu menerapkan perubahan dengan menggunakan **Set-AzureRmLocationBasedServices**.
