...
### Memfilter prinsipal layanan menggunakan SPN
```
PS C:\> Get-AzureRmADServicePrincipal -SPN 36f81fc3-b00f-48cd-8218-3879f51ff39f
```

Mendapatkan prinsipal layanan dengan 36f81fc3-b00f-48cd-8218-3879f51ff39f SPN.

### Memfilter prinsipal layanan menggunakan String Pencarian
```
PS C:\> Get-AzureRmADServicePrincipal -SearchString "Web"
```

Memfilter semua prinsipal layanan iklan yang memiliki nama tampilan dimulai dengan "Web".

### Daftar prinsipal layanan AD
```
PS C:\> Get-AzureRmADServicePrincipal
```

Mendapatkan semua prinsipal layanan AD.
...
### -SearchString
Mengambil semua prinsipal layanan yang memiliki nama tampilan dimulai dengan nilai ini.
...
### System.Collections.generic.List'1[Microsoft.Azure.Graph. RBAC. Version1_6.ActiveDirectory.DIRECTDServicePrincipal]
