...
Perintah terakhir membatalkan pendaftaran server Windows dari vault Azure Backup.
...
### AzureBackupJob
Cmdlet ini $Null jika tipe wadah adalah Windows Server.
