...
Perintah pertama mengonversi string menjadi string aman dengan menggunakan cmdlet **ConvertTo-SecureString,** lalu menyimpan string itu dalam $Secret variabel. Untuk informasi selengkapnya, ketik `Get-Help
