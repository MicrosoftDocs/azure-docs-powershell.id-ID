...
## DESCRIPTION
Cmdlet **Submit-AzureRmDataLakeAnalyticsJob** mengirimkan pekerjaan Analitik Danau Azure Data.
...
Parameter skrip SQL tambahan tambahan di atas konten skrip utama, misalnya:

STRING DECLARE @Department = "Penjualan"; DECLARE @NumRecords int = 1000; DECLARE @StartDateTime DateTime = new DateTime(2017, 12, 6, 0, 0, 0, 0);
...
### String
Parameter 'Script' menerima nilai tipe 'String' dari saluran

## OUTPUTS

### JobInformation
Detail pekerjaan awal untuk pekerjaan yang dikirimkan.
