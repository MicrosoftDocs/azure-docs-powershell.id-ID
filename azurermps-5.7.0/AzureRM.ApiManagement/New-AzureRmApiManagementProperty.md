...
### Contoh 1: Membuat properti yang menyertakan tag
```
...
Perintah kedua membuat properti dan menetapkan string di daftar $Tags tag pada properti.
...
### -Tag
Tag yang akan dikaitkan dengan Properti. Parameter ini bersifat opsional.
