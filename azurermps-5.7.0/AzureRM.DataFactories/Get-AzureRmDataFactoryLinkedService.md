...
Perintah pertama menggunakan cmdlet Get-AzureRmDataFactory cmdlet untuk mendapatkan pabrik data bernama ContosoFactory, lalu menyimpannya di $DataFactory lain.
