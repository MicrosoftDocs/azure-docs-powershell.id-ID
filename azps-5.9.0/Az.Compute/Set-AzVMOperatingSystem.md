...
ms.openlocfilehash: e9b43c19f6800e492c54b1dec59ff4cd994824c5
ms.sourcegitcommit: 6dce6f7972b2236b87b25b31465bffaad2435711
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 09/13/2021
ms.locfileid: "136036258"
---
...
Mesin virtual tersebut merupakan bagian dari ketersediaan yang diatur untuk $AvailabilitySet.
...
### -CustomData
Menentukan string yang akan diteruskan ke komputer virtual. Untuk informasi selengkapnya lihat [Data Kustom di VM Azure.](https://docs.microsoft.com/en-us/azure/virtual-machines/custom-data)
...
Nilai yang mungkin dapat [TimeZoneInfo.Id](https://docs.microsoft.com/dotnet/api/system.timezoneinfo.id?#System_TimeZoneInfo_Id) dari zona waktu yang dikembalikan oleh [Zona WaktuInfo.GetSystemTimeZones.](https://docs.microsoft.com/dotnet/api/system.timezoneinfo.getsystemtimezones)
