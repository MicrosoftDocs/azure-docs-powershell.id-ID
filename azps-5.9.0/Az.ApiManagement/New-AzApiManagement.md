...
Perintah ini membuat layanan Manajemen API Premium tingkat dalam subnet jaringan virtual Azure yang memiliki titik akhir gateway internal dengan kawasan master di AS Barat.
