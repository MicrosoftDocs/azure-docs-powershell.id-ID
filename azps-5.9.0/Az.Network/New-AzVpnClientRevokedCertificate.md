...
Anda bisa mengembalikan informasi yang dapat dicetak dengan jempol untuk sertifikat Anda menggunakan Windows PowerShell seperti ini:`Get-ChildItem -Path Cert:\LocalMachine\Root`
