...
Anda dapat mengambil data ini menggunakan Windows PowerShell perintah seperti berikut:`$Text = Get-Content -Path "C:\Azure\Certificates\ExportedCertificate.cer"`
