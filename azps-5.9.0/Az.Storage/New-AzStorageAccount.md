...
ms.openlocfilehash: 62dea204286d649f600bd423ded7374b72092a63
ms.sourcegitcommit: 6dce6f7972b2236b87b25b31465bffaad2435711
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 09/13/2021
ms.locfileid: "136043098"
---
...
### Contoh 6: Buat akun Storage dengan Autentikasi DS Azure AAD, dan aktifkan berbagi file berukuran besar.
```powershell
PS C:\>New-AzStorageAccount -ResourceGroupName "MyResourceGroup" -AccountName "mystorageaccount" -Location "eastus2euap" -SkuName "Standard_LRS" -Kind StorageV2  -EnableAzureActiveDirectoryDomainServicesForFile $true -EnableLargeFileShare
```

Perintah ini akan membuat akun Storage dengan Autentikasi DS Azure AAD, dan mengaktifkan berbagi file berukuran besar.
...
Perintah ini akan membuat akun Storage Autentikasi Layanan Domain Direktori Aktif File yang dapat digunakan.
...
Perintah ini membuat akun Storage dengan Layanan Antrean dan Tabel menggunakan kunci enkripsi akun yang scoped dan Perlu Enkripsi Infrastruktur, sehingga Queue dan Table akan menggunakan kunci enkripsi yang sama dengan layanan Blob dan File, dan layanan akan menerapkan lapisan enkripsi sekunder dengan kunci yang dikelola platform untuk data saat data tidak digunakan.
Lalu dapatkan kunci Storage, dan tampilkan tipe keytype enkripsi dari Queue dan Table Service, dan nilai RequireInfrastructureEncryption.
...
### Contoh 11: Buat Storage Anda dengan EdgeZone
```powershell
...
Perintah ini membuat akun Storage dengan EdgeZone sebagai "microsoftlosangeles1", lalu memperlihatkan properti ExtendedLocation akun yang dibuat.
