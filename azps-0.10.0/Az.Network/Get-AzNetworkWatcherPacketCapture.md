...
## DESCRIPTION
Get-AzNetworkWatcherPacketCapture mendapatkan properti dan status sumber daya penangkapan paket.

## EXAMPLES

### --- Contoh 1: Membuat Tangkapan Paket dengan beberapa filter dan mengambil statusnya ---
```
...
Dalam contoh ini, kami membuat tangkapan paket bernama "PacketCaptureTest" dengan beberapa filter dan batas waktu. Setelah sesi selesai, sesi akan disimpan ke akun penyimpanan yang ditentukan. Kami kemudian memanggil Get-AzNetworkWatcherPacketCapture untuk mengambil status sesi penangkapan. 
