...
## DESCRIPTION
Cmdlet **Set-AzLoadBalancerFrontendIpConfig** menetapkan status tujuan untuk konfigurasi IP ujung depan dalam penyeimbang muatan Azure.
