...
Catatan: Anda harus terlebih dahulu menghapus semua koneksi ke Gateway Jaringan Lokal menggunakan cmdlet **Remove-AzVirtualNetworkGatewayConnection** .
