...
## DESCRIPTION
Cmdlet **Remove-AzLoadBalancerInboundNatRuleConfig** menghapus konfigurasi aturan penerjemahan alamat jaringan masuk (NAT, InLoadBalancerInboundNatRuleConfig) menghapus konfigurasi aturan penerjemahan alamat jaringan masuk (NAT, Inbound Network Address Translation) dari penyeimbang muat Azure.
