...
ms.locfileid: "136030106"
---
# Get-AzSqlInstanceDatabaseSensitivityRecommendation

## SYNOPSIS
Mendapatkan tipe informasi yang direkomendasikan dan label kolom sensitivitas di Azure SQL database instans terkelola.
...
## DESKRIPSI
Cmdlet Get-AzSqlInstanceDatabaseSensitivityRecommendation mengembalikan tipe informasi yang direkomendasikan dan label sensitivitas kolom di database Azure SQL terkelola.
...
### Contoh 2: Dapatkan tipe informasi yang direkomendasikan dan label sensitivitas database Azure SQL terkelola menggunakan Piping.
```powershell
