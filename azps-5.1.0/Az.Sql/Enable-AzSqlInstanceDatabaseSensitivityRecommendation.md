...
### Contoh 1: Mengaktifkan rekomendasi sensitivitas pada kolom tertentu dalam database instans terkelola Azure SQL.
```powershell
...
### Contoh 2: Mengaktifkan rekomendasi sensitivitas pada kolom tertentu dalam database azure SQL terkelola dengan Piping.
```powershell
