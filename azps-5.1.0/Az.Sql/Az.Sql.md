...
Menonaktifkan (menghilangkan) rekomendasi sensitivitas pada kolom di database Azure SQL instans terkelola.
...
Mendapatkan link replikasi geo antara sumber daya Azure SQL Database dan grup sumber daya atau SQL Server.
...
Mendapatkan agen Azure SQL Elastis Pekerjaan
...
Dapatkan tipe informasi saat ini dan label sensitivitas kolom di Azure SQL database instans terkelola.

### [Get-AzSqlInstanceDatabaseSensitivityRecommendation](Get-AzSqlInstanceDatabaseSensitivityRecommendation.md)
Mendapatkan tipe informasi yang direkomendasikan dan label sensitivitas kolom di Azure SQL managed instance.
...
Mendapatkan SQL operasi instans terkelola Anda.
...
Mendapatkan SQL Kunci Vault server.
...
Dapatkan tujuan layanan untuk server Azure SQL Database baru.
...
Menghapus tipe informasi dan label sensitivitas kolom di Azure SQL database instans terkelola.
...
Menghapus Agen Sinkronisasi Azure SQL Aktif.
...
Mengubah pengaturan audit untuk database Azure SQL baru.
...
Mengatur tipe informasi dan label sensitivitas kolom di Azure SQL database instans terkelola.
...
Memodifikasi server tempat Alias DNS Azure SQL Server ditandaandai
