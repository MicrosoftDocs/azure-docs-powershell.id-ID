...
## DESKRIPSI
Dapatkan daftar Alias DNS SQL Server Azure tertentu atau list semua Alias DNS Server untuk server
...
Mendapatkan Alias DNS Server yang ditentukan berdasarkan nama server dan alias
