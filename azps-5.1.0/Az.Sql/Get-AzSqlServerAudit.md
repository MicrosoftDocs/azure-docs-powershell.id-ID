...
## DESKRIPSI
Cmdlet **Get-AzSqlServerAudit** mendapatkan pengaturan pengauditan dari server SQL Azure.
Tentukan parameter *ResourceGroupName* *dan ServerName* untuk mengidentifikasi server.

## CONTOH

### Contoh 1: Dapatkan pengaturan pengauditan server Azure SQL baru
```
...
### Contoh 3: Dapatkan pengaturan pengauditan server Azure SQL baru
```
PS C:\>Get-AzSqlServerAudit -ResourceGroupName "resourcegroup01" -ServerName "server01"
ServerName                          : server01
ResourceGroupName                   : resourcegroup01
