...
## DESKRIPSI
Cmdlet Disable-AzSqlInstanceDatabaseSensitivityRecommendation menonaktifkan (menghilangkan) rekomendasi sensitivitas pada kolom di database Azure SQL instans terkelola.

## CONTOH

### Contoh 1: Menonaktifkan rekomendasi sensitivitas pada kolom tertentu dalam database Azure SQL terkelola.
```powershell
...
### Contoh 2: Nonaktifkan rekomendasi sensitivitas pada kolom yang memiliki rekomendasi sensitivitas dalam database azure SQL terkelola dengan Piping.
```powershell
...
### Contoh 3: Menonaktifkan rekomendasi sensitivitas pada kolom tertentu dalam database azure SQL terkelola dengan Piping.
```powershell
...
### -DatabaseName
Nama database instans SQL terkelola Azure.
