...
### Contoh 1: Hapus tipe informasi dan label sensitivitas kolom di database azure SQL terkelola.
```powershell
...
### Contoh 3: Hapus tipe informasi dan label sensitivitas kolom dalam database instans terkelola Azure SQL dengan Piping.
```powershell
