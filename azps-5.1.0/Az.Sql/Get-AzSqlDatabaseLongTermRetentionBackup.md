...
Perintah ini mendapatkan semua cadangan penyimpanan jangka panjang untuk semua database (yang mungkin hidup atau dihapus) di northeurope, grup sumber daya hanya akan diatur jika server ada.
