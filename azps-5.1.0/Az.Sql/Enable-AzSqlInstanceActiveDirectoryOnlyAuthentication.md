...
## DESKRIPSI
Cmdlet **Enable-AzSqlInstanceActiveDirectoryOnlyAuthentication** hanya mengaktifkan persyaratan autentikasi Azure Active Directory (Azure AD) untuk Instans Terkelola AzureSQL dalam langganan saat ini.
...
Perintah ini hanya mengaktifkan Azure Active Directory autentikasi untuk Instans Terkelola AzureSQL bernama ManagedInstance01 yang terkait dengan grup sumber daya bernama ResourceGroup01.
