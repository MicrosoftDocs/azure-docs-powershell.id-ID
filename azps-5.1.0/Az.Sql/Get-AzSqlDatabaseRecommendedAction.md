...
## DESKRIPSI
Cmdlet **Get-AzSqlDatabaseRecommendedAction** mendapatkan satu atau beberapa tindakan yang disarankan untuk Azure SQL Database Penasihat.
