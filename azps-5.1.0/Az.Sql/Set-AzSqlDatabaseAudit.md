...
### Contoh 3: Mengaktifkan kebijakan pengauditan penyimpanan blob dari database SQL Azure dengan pemfilteran tingkat lanjut menggunakan predikat SQL T
```powershell
...
### Contoh 4: Menghapus pengaturan pemfilteran tingkat lanjut dari kebijakan pengauditan database SQL Azure
```powershell
...
### Contoh 6: Menonaktifkan kebijakan pengauditan hub kejadian database Azure SQL
```powershell
...
### Contoh 10: Menonaktifkan pengiriman catatan audit database Azure SQL ke penyimpanan blob, dan memungkinkan pengirimannya untuk analitik log.
```powershell
