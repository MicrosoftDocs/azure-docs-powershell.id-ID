...
## CATATAN
* Cmdlet **Resume-AzSqlDatabase** hanya berfungsi di Azure SQL database Gudang Data. Operasi ini tidak didukung di Azure SQL Database edisi Azure SQL Database Basic, Standard Premium.
