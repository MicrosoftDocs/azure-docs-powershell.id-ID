...
Perintah pertama mendapatkan antarmuka jaringan yang sudah ada yang disebut NetworkInterface1 dan menyimpannya dalam $nic variabel. Perintah kedua mendapatkan grup keamanan jaringan yang sudah ada yang disebut MyNSG dan menyimpannya dalam $nsg jaringan. Perintah ketiga menetapkan $nsg ke $nic. Akhirnya, perintah di depannya menerapkan perubahan pada antarmuka Jaringan. Untukssociate grup keamanan jaringan dari antarmuka jaringan, ganti $nsg di perintah ketiga dengan $null.
