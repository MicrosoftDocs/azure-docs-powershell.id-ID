...
### Contoh 1: Membuat konfigurasi aturan keluar untuk penyeimbang muat
```powershell
...
Perintah ketiga membuat konfigurasi pool alamat ujung-belakang yang bernama BackendAddressPool01, lalu menyimpannya di $backend akhir.
