...
ms.locfileid: "136025878"
---
# Get-AzDeploymentWhatIfResult

## SYNOPSIS
Mendapatkan hasil templat ARM What-If untuk penyebaran pada lingkup langganan. 
...
Perintah ini mendapatkan What-If di lingkup langganan saat ini dengan menggunakan file templat kustom dan file parameter di disk.
...
### Contoh 2: Mendapatkan What-If pada lingkup langganan dengan ResourceIdOnly
```powershell
PS C:\> Get-AzDeploymentWhatIfResult `
    -DeploymentName "deploy-01" `
    -Location "West US" `
