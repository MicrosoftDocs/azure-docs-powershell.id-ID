...
Sumber daya Azure adalah entitas Azure yang dikelola pengguna, seperti server database, database, situs web, mesin virtual, atau Storage lokal.
...
Ini bisa merupakan templat kustom atau templat galeri yang disimpan sebagai file JSON, seperti yang dibuat dengan menggunakan cmdlet **Save-AzResourceGroupGalleryTemplate.**
...
File ini bisa merupakan templat kustom atau templat galeri yang disimpan sebagai file JSON, seperti dengan menggunakan **Save-AzResourceGroupGalleryTemplate**.
