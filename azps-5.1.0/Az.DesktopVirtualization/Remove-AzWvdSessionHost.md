...
### Contoh 1: Delete a Windows Virtual Desktop SessionHost by name
```powershell
PS C:\> Remove-AzWvdSessionHost -ResourceGroupName ResourceGroupName -HostPoolName HostPoolName -Name SessionHostName
```

Perintah ini menghapus Windows Virtual Desktop SessionHost dalam Pool Host.
...
### -Force
Memaksa bendera untuk memaksa penghapusan sessionHost bahkan ketika userSession ada.
