...
## DESKRIPSI
Cmdlet Get-AzActivityLog cmdlet untuk mengambil kejadian Log Aktivitas. Kejadian bisa dikaitkan dengan ID langganan, ID korelasi, grup sumber daya, ID sumber daya, atau penyedia sumber daya.
