...
File JSON adalah file teks yang menggunakan sintaks seperti ini: { "Name": "ContosoAuthorizationRule",  
  ...
  "Hak": \[  
        ...
        "Kirim"  
    \]  
  } Ketika digunakan bersama dengan cmdlet New-AzNotificationHubAuthorizationRule, contoh JSON sebelumnya mengubah aturan otorisasi bernama ContosoAuthorizationRule untuk memberi pengguna hak Dengarkan dan Kirim ke hub.
