...
### Contoh 1: Mengubah Storage wadah blob dan akses publik dengan nama akun Storage dan nama wadah
```
...
Perintah ini mengubah metadata Storage blob dan akses publik wadah blob dengan nama akun Storage wadah.
...
Perintah ini mengatur akses publik sebagai Blob untuk Storage wadah blob dalam Storage dengan saluran.
