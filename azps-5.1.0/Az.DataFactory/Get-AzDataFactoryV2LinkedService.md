...
Untuk informasi selengkapnya, ketik Get-Help Format-Daftar.
...
Perintah pertama menggunakan cmdlet Get-AzDataFactoryV2 cmdlet untuk mendapatkan pabrik data bernama ContosoFactory, lalu menyimpannya di $DataFactory lain.
