...
## DESKRIPSI
Cmdlet **Remove-AzDataBoxEdgeStorageAccount** menghapus akun Storage Edge terkait untuk perangkat Data Box Edge. Anda dapat menentukan nama Akun edge Storage yang akan dihapus sebagai parameter dalam cmdlet.
