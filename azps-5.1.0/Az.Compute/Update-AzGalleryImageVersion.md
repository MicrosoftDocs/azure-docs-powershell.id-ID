...
ms.openlocfilehash: 4c7479dec53f9401f5c8cdad52f7f836b0d92f6e
ms.sourcegitcommit: 04221336bc9eed46c05ed1e828a6811534d4b4ab
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 12/08/2020
ms.locfileid: "136033100"
---
...
### Contoh 1: Perbarui versi gambar galeri
```powershell
...
### Contoh 2: Menyertakan versi gambar untuk dipertimbangkan sebagai yang terbaru dalam definisinya
```powershell
...
### Contoh 3: Mengecualikan versi gambar dari pertimbangan sebagai yang terbaru dalam definisinya
```powershell
