...
## DESKRIPSI
Cmdlet **Publish-AzVMDscConfiguration** mengunggah skrip Konfigurasi Status Diinginkan (DSC, Desired State Configuration) ke penyimpanan blob Azure, yang nantinya dapat diterapkan ke komputer virtual Azure menggunakan cmdlet Set-AzVMDscExtension.

## CONTOH

### Contoh 1: Buat .zip berisi unggahan ke penyimpanan Azure
```
