...
Mencadangkan data domain keamanan dari HSM terkelola untuk memulihkan.
...
Memulihkan data domain keamanan yang dicadangkan sebelumnya ke HSM yang dikelola.
...
Memulihkan kunci yang dihapus dalam HSM terkelola ke dalam keadaan aktif.
...
Memperbarui atribut yang dapat diedit dari Kunci Vault yang Azure Storage Anda.

### [Update-AzKeyVaultManagedStorageAccountKey](Update-AzKeyVaultManagedStorageAccountKey.md)
Meregenerasi kunci tertentu Kunci Vault Azure Storage Akun.
