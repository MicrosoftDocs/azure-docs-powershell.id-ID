...
## DESKRIPSI
Cmdlet **Get-AzManagedHsmKey** mendapatkan tombol Azure Managed Hsm.
Cmdlet ini mendapatkan **Microsoft.Azure.Commands.KeyVault.Models.KeyBundle** tertentu atau daftar semua objek **KeyBundle** dalam Hsm terkelola atau menurut versi.

## CONTOH

### Contoh 1: Get all the keys in a managed HSM
```powershell
PS C:\> Get-AzManagedHsmKey -HsmName testmhsm
```

Nama Vault/HSM : Nama testmhsm : testkey001 Versi : Id : Diaktifkan : True Kedaluwarsa : Bukan Sebelum : Dibuat https://testmhsm.managedhsm.azure.net:443/keys/testkey001 : 14/10/2020 03:39:16 DIPERBARUI : 14/10/2020 3:39:16 AM Tingkat Pemulihan : Recoverable+Purgeable Tags :

Nama Vault/HSM : nama testmhsm : testkey002 Versi : Id : Diaktifkan : False Kedaluwarsa https://testmhsm.managedhsm.azure.net:443/keys/testkey002 : 14/10/2022 8:13:29 AM Not Before : 14/10/2020 8:13:33 AM Created : 14/10/2020 8:14:01 AM Diperbarui : 14/10/2020 8:14:01 AM Tingkat Pemulihan : Recoverable+Purgeable Tags : Name Value Severity high Accounting true

Perintah ini mendapatkan semua tombol di HSM terkelola yang bernama testmhsm.
...
Perintah ini mendapatkan versi terbaru kunci bernama testkey001 dalam HSM yang dikelola bernama testmhsm.
Catatan: Nama Hsm dapat diperoleh dengan $hsm. VaultName
...
Perintah ini mendapatkan semua versi kunci bernama testkey001 dalam HSM terkelola yang bernama testmhsm.
...
Perintah ini mendapatkan versi tertentu dari kunci bernama testkey dalam HSM terkelola bernama testmhsm.
Setelah menjalankan perintah ini, periksa berbagai properti kunci dengan menavigasi objek $Key.

### Contoh 5: Get all the keys that have been deleted but not purged for this managed HSM
```powershell
...
Perintah ini mendapatkan semua tombol yang telah dihapus sebelumnya, tetapi tidak di pembersihan, di HSM terkelola yang bernama testmhsm.

### Contoh 6: Mendapatkan kunci testkey yang telah dihapus tapi tidak di pembersihan untuk HSM yang dikelola ini
```powershell
...
Perintah ini mendapatkan kunci testkey yang telah dihapus sebelumnya, namun tidak di pembersihan, di HSM terkelola bernama testmhsm.
...
### Contoh 7: Get all the keys in a managed HSM using filtering
```powershell
...
Perintah ini mendapatkan semua tombol di HSM terkelola bernama testmhsm yang dimulai dengan "test".
...
### -IncludeVersions
Menentukan apakah akan menyertakan versi kunci dalam output.
...
### -OutFile
Menentukan file output tempat cmdlet ini menyimpan kunci.
Kunci publik disimpan dalam format PEM secara default.
