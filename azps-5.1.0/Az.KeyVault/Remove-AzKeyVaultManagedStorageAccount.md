...
## DESKRIPSI
Memisahkan akun Azure Storage dari Key Vault. Hal ini tidak akan Azure Storage Akun Pengguna, tetapi menghapus kunci akun agar tidak dikelola oleh Azure Key Vault. Semua kunci vault yang terkait Storage definisi SAS juga dihapus.
...
### Contoh 3: Menghapus (membersihkan) Key Vault yang dikelola Azure Storage dan semua definisi SAS yang terkait dari vault dengan dukungan penghapusan sementara.
```powershell
