...
Anda dapat menjalankan cmdlet Set-DscLocalConfigurationManager cmdlet agar folder ini dapat onboard komputer ini ke akun Azure Automation sebagai node DSC.
