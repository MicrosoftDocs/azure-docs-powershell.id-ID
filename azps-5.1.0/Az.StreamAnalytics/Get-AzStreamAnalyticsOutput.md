...
## DESKRIPSI
Cmdlet **Get-AzStreamAnalyticsOutput** mencantumkan semua output yang ditetapkan dalam pekerjaan Analitik Stream yang ditentukan atau mendapatkan informasi tentang output tertentu.
