...
## DESKRIPSI
**Switch-AzWebAppSlot** menukar dua slot yang terkait dengan Azure Web App.
...
Perintah ini akan mengalihkan slot "sourceslot" slot dengan "destinationslot" slot Web App ContosoWebApp terkait dengan grup sumber daya Default-Web-WestUS
