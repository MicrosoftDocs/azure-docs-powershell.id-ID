...
Menentukan konfigurasi disk untuk udpated bagi disk terkelola Vm (Azure ke Azure DR scenrio).
...
### -PrimaryNic
Menentukan NIC yang akan digunakan sebagai NIC utama untuk recvcovery VM setelah failover.
...
### -UpdateNic
Menentukan NIC dari mesin virtual di mana cmdlet ini mengatur properti jaringan pemulihan perlu udpated.
