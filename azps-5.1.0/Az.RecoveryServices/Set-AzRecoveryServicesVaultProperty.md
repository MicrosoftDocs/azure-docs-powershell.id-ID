...
## DESKRIPSI
Cmdlet **Set-AzRecoveryServicesVaultProperty** memperbarui properti vault layanan Pemulihan.
Cmdlet ini mengembalikan properti vault yang diperbarui setelah operasi set saat ini.
Menggunakan properti cmdlet vault seperti penghapusan sementara ini dapat diaktifkan kapan saja.
**Properti SoftDeleteFeatureState** dari vault dapat dinonaktifkan hanya jika tidak ada wadah terdaftar di vault.
