...
Membuat objek ASRVmNicConfig dengan pengaturan jaringan samar-samar dan menguji failover yang dikonfigurasi untuk NIC. Properti apa pun yang tidak lolos di atas diambil dari item terproteksi yang lolos.
...
Membuat konfigurasi NIC ASR yang berisi detail konfigurasi terkait failover dan test failover. (otomatisgenerated)
...
Menentukan NOMOR kolam renang alamat backend untuk NIC pemulihan.
...
Menentukan alamat IP NIC pemulihan.
...
Menentukan ID alamat IP publik yang terkait dengan pemulihan NIC.
...
Menentukan alamat IP uji failover NIC.
...
Menentukan ID alamat IP publik yang terkait dengan test failover NIC.
