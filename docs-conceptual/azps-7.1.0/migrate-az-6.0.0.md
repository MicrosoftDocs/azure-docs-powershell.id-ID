...
description: Panduan migrasi ini berisi daftar perubahan terbaru yang dibuat untuk Azure PowerShell rilis Az versi 6.0.0.
ms.devlang: powershell
ms.topic: conceptual
ms.date: 01/04/2022
ms.custom: devx-track-azurepowershell
ms.service: azure-powershell
ms.openlocfilehash: bd7d1a882df1ddb06fd197c4178e3352b3c10333
ms.sourcegitcommit: e109cc5320478db6aa8a52d49996b133007a65b9
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 01/12/2022
ms.locfileid: "135958553"
---
...
Untuk detail selengkapnya, lihat siklus [hidup Azure PowerShell dukungan baru](https://aka.ms/azpslifecycle)
...
Dihapus Set-AzRecoveryServicesBackupProperties bentuk jamak, Set-AzRecoveryServicesBackupProperty cmdlet baru ke depan

### `Get-AzRecoveryServicesBackupJobDetail`

Dihapus Get-AzRecoveryServicesBackupJobDetails bentuk jamak, Get-AzRecoveryServicesBackupJobDetail cmdlet baru ke depan
