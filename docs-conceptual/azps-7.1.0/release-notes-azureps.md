...
ms.openlocfilehash: 80672268003c5a27b1900d93168c9b14513bac6e
ms.sourcegitcommit: e109cc5320478db6aa8a52d49996b133007a65b9
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 01/12/2022
ms.locfileid: "135958480"
---
# <a name="azure-powershell-release-notes"></a>Azure PowerShell rilis
## <a name="710---january-2022"></a>7.1.0 - Januari 2022
#### <a name="azaccounts"></a>Az.Accounts
* Salin 'ServicePrincipalSecret' dan 'CertificatePassword' dari profil buildin Az.Accounts ke profil set pelanggan. [#16617]
* Memperbarui pesan bantuan dan markdown bantuan untuk parameter 'Penyewa' cmdlet 'Set-AzContext'. [#16515]
* Memperbaiki masalah yang menyebabkan Azure PowerShell bekerja dalam alur kerja. [#16408]
* Memperbaiki Versi Api ganda dalam URI permintaan dasar yang dikeluarkan oleh 'Invoke-Az FixedMethod'. [#16615]

#### <a name="azaks"></a>Az.Aks
* Menambahkan dukungan 'penyeimbang muat' dan 'akses server api' di 'New-AzAksCluster' dan 'Set-AzAksCluster'. [#16575]

#### <a name="azautomation"></a>Az.Automation
* 'New-AzAutomationSchedule' memungkinkan def sedang StartTime dengan offset.
*  Memperbaiki bug: memperbarui 'Set-AzAutomationModule' untuk menggunakan panggilan PUT selagi memperbarui modul dengan versi tertentu [#12552]

#### <a name="azcognitiveservices"></a>Az.CognitiveServices
* Memperbarui PowerShell untuk menggunakan versi 2021-10-01.
* Cmdlet CommitmentTier dan CommitmentPlan ditambahkan.
* Menambahkan cmdlet Penyebaran.
* Ditambahkan cmdlet 'New-AzCognitiveServicesObject' untuk menghasilkan objek CommitmentPlan/Deployment.

#### <a name="azcompute"></a>Az.Compute
* Memperbarui parameter 'UserData' dalam cmdlet VM dan VMSS untuk pipa dengan Nama Properti guna memastikan skenario pemipaan terjadi dengan benar.
...
* Exposed BackupPolicyMigrationState sebagai bagian dari Get-AzCosmosDBAccount anda.
...
* Memperbarui versi .Net SDK ADF ke 5.0.0

#### <a name="azfunctions"></a>Az.Functions
* Pratinjau yang dihapus dari tumpukan PowerShell 7.0 di Linux

#### <a name="azkeyvault"></a>Az.KeyVault
* Cmdlet tambahan: 'Invoke-AzKeyVaultKeyRotation', 'Get-AzKeyVaultKeyRotationPolicy' dan 'Set-AzKeyVaultKeyRotationPolicy'

#### <a name="azmysql"></a>Az.MySql
* Ketersediaan umum Az.MySql

#### <a name="aznetwork"></a>Az.Network
* Menggunakan perbandingan insensitif huruf besar-besar untuk ResourceId (Set/New-NetworkWatcherFlowLog)
...
* Ditambahkan OrdinalIgnoreCase untuk perbandingan string tipe 'ResourceIdentifier' untuk cmdlet FlowLog
...
* Menambahkan parameter 'IdentityType' dan 'UserAssignedIdentity' dalam cmdlet 'New-AzRedisCache' dan 'Set-AzRedisCache'.
    - Identitas Singgahan Azure untuk Redis digunakan untuk menetapkan dan mengubah Identitas Cache Azure untuk Merah.

#### <a name="azresourcemover"></a>Az.ResourceMover
* Dukungan tambahan untuk Tag di pindah sumber daya Azure
* Dukungan tambahan untuk SystemData di azure resource mover
* Versi api yang dirilis 2021-08-01

#### <a name="azresources"></a>Az.Resources
* Memperbaiki alias yang tidak benar untuk 'Get-AzADSpCredential' [#16592]
...
* Parameter tambahan 'Web' untuk 'New-AzADApplication' [#16659]
* Menambahkan teks rahasia sebagai respons dari 'New-AzADApplication' dan 'New-AzADServicePrincipal' [#16659]
* Deserialisasi 'Nilai' dalam 'DeploymentVariable' sebagai larik objek jika tipenya adalah Array [#16523]
...
* Memperbaiki bug cmdlet 'Update-AzSignalR' yang mereset negara bagian sumber daya dengan tidak sengaja.

#### <a name="azsql"></a>az.sql
* Menambahkan parameter 'ZoneRedundant' ke 'New-AzSqlDatabaseCopy', 'New-AzSqlDatabaseSecbase' dan 'Restore-AzSqlDatabase' untuk mengaktifkan salinan berlebihan zona, geo sekunder dan PITR untuk database hiperscale

#### <a name="azstorage"></a>Az.Storage
* Memperbaiki kegagalan sinkronisasi salinan blob dengan nama blob tujuan panjang [#16628]
    -  'Copy-AzStorageBlob'

#### <a name="azsynapse"></a>Az.Synapse
* Ketersediaan umum Az.Synapse
* Fitur Azure AD yang dimigrasikan di Az.Synapse ke API MSGraph. Cmdlet di bawah ini disebut API MSGraph sesuai dengan parameter input:
...
* Menambahkan nilai default untuk parameter [-AutoPauseDelayInMinute] perintah 'New-AzSynapseSparkpool' dan 'Update-AzSynapseSparkpool'

### <a name="thanks-to-our-community-contributors"></a>Terima kasih kepada kontributor komunitas kami
* @adishiritwick, diperbarui Set-AzAutomationModule menggunakan panggilan PUT saat memperbarui modul dengan versi tertentu (#16505)
...
* Hen Itlurki ( @HenItzhaki ), Contoh tambahan lainnya (#16424)
* Chris ( @isjwuk ), Penyempurnaan pemformatan (#15826)
* Jaromir Kaspar ( @jaromirk ), Contoh ditambahkan untuk kredensial kata sandi (#16600)
* MartinPalkus ( ), Memperbaiki kesalahan ketik dalam Update Az-Tags doc where "Repalces" yang ditentukan bukan @mfalkus "Replaces" (#16541)
* Rad yugoslavia Gatev ( ), [Az.Accounts] Memperbaiki Versi Api ganda di Uri dari permintaan yang dikeluarkan oleh @RadoslavGatev Invoke-AzRestMethod (#16616)
* @Skuldo, Kesalahan ketik (#16585)
* SujitJit ( @sujitks ), Update Set-AzApplicationGatewayFirewallPolicy.md (#16583)
...
* SKU akun penyimpanan yang didukung 'Standard_GZRS' [#14633]
...
* Ditambahkan cmdlet New-AzHDInsightIPConfiguration untuk membuat objek konfigurasi ip dalam memori.
* Menambahkan cmdlet New-AzHDInsightPrivateLinkConfiguration untuk membuat objek konfigurasi tautan pribadi dalam memori.
* Perbaikan tipe output dalam dokumen cmdlet Set-AzHDInsightClusterDiskEncryptionKey bantuan dari 'Microsoft.Azure.Management.HDInsight.Models.Cluster' hingga 'Microsoft.Azure.Commands.HDInsight.Models.AzureHDInsightCluster' agar tetap konsisten dengan tipe objek asli yang dikembalikan.
* Mengubah pengaturan:
...
* Memperkenalkan Get-AzCosmosDBLocation menampilkan Akun Azure CosmosDB dan properti lokasinya.
...
* Azure Backup memperbaiki Get-AzRecoveryServicesBackupContainer mendukung BackupManagementType MAB, bukan MARS.
...
* Peringatan perubahan yang ditambahkan AAD cmdlet
...
* Mats Docnsen ( @matsest ), docs: menambahkan contoh untuk Update-AzSubscription (#15748)
...
* Parameter yang sudah tidak t asal 'ManagedServiceHostName', 'ManagedServicePort' dan 'ManagedServiceSecret' dari cmdlet 'Koneksi-AzAccount', variabel lingkungan 'MSI_ENDPOINT' dan 'MSI_SECRET' dapat digunakan sebagai gantinya
...
#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Memperbaiki masalah keamanan yang SQL pulihkan, hal ini merupakan perubahan yang perlu dilakukan. TargetContainer menjadi wajib untuk Pemulihan Lokasi Alternatif.
...
#### <a name="azcompute"></a>Az.Compute
* Perbaikan bug ketika 1 disk data yang terhubung ke VMSS untuk Remove-AzVmssDataDisk [#13368]
...
* Membuat beberapa parameter New-AzMigrateServerReplication, New-AzMigrateDiskMapping peka huruf besar/batnya.
...
* Peningkatan penanganan pengecualian untuk Azure PowerShell pengecualian terkait.
...
* Format tampilan daftar dan format tabel yang diperbarui untuk Get-AzVirtualNetworkGatewayConnectionIkeSa
...
#### <a name="azresources"></a>Az.Resources
* Tipe pokok yang dihapus New-AzRoleAssignment dan Set-AzRoleAssignment karena pemetaan saat ini telah memecahkan skenario tertentu
...
* Completer lokasi tetap New-AzAutomationUpdateManagementAzureQuery cmdlet
...
* Memperbarui logika di mana schemaName, tableName dan columnName diekstrak dari id SQL Klasifikasi Data.
...
* Tmadat Belmansour ( @BelRarr ), Pembaruan Get-AzBillingInvoice.md (#13634)
...
### <a name="thanks-to-our-community-contributors"></a>Terima kasih kepada kontributor komunitas kami
* Andrew Dawson ( ), Pembaruan Get-AzKeyVaultCertificate.md - Dapatkan sertifikat dan simpan sebagai bagian pfx untuk bekerja dengan @dawsonar802 PowerShell Core (#13557)
...
* Memperbaiki masalah yang menyebabkan Write-Object kesalahan selama Connect-AzAccount [#13419]
...
#### <a name="azlogicapp"></a>Az.LogicApp
* Diperbaiki untuk Get-AzLogicAppRunHistory yang hanya mengambil halaman pertama hasil
...
* Memperbarui contoh teks bantuan skrip untuk Set-AzRecoveryServicesBackupProtectionPolicy cmdlet.
...
#### <a name="azsql"></a>az.sql
* Memperbaiki masalah ketika New-AzSqlDatabaseExport gagal jikasolasi jaringan tidak ditentukan [#13097]
* Memperbaiki masalah ketika New-AzSqlDatabaseExport dan New-AzSqlDatabaseImport tidak mengembalikan OperationStatusLink dalam objek hasil [#13097]
* URL Perbarui Wilayah Azure yang Dipasangkan dalam Storage Peringatan Kelebihan Data
...
* Added BackupStorageRedundancy to the following:
    ...
    - 'New-AzSqlDatabaseCopy'
    - 'New-AzSqlDatabaseSecbasery'
* Sensitivitas kasus yang dihapus untuk parameter cadanganSusuan penyimpanan untuk SQL referensi DB
* Nama pesan peringatan BackupStorageRedundancy diperbarui

#### <a name="azstorage"></a>Az.Storage
* Mendukung aktifkan/nonaktifkan/dapatkan properti penghapusan sementara untuk file Layanan Storage
    - 'Update-AzStorageFileServiceProperty'
    - 'Get-AzStorageFileServiceProperty'
* Berbagi file daftar yang didukung mencakup file daftar yang telah dihapus dari Storage, dan Mendapatkan penggunaan berbagi satu file
    - 'Get-AzRmStorageShare'
...
* Mengubah cmdlet untuk mengubah properti layanan blob, tidak akan mendapatkan properti asli dari server, tetapi hanya mengatur properti yang dimodifikasi ke server.
    ...
    - 'Disable-AzStorageBlobRestorePolicy'
    - 'Update-AzStorageBlobServiceProperty'
* Memperbaiki masalah bantuan terkait New-AzStorageAccount parameter -Kind nilai default [#12189]
...
* @jack-education, Diperbarui Set-AzVirtualNetworkSubnetConfig mengizinkan NSG dan Tabel Rute dihapus dari subnet (#12351)
...
* Cmdlet baru 'Get-AzTenantWhatIfResult' untuk mendapatkan templat ARM What-If hasil pada lingkup penyewa
...
* Dukungan aktifkan/nonaktifkan ChangeFeed di Layanan Blob layanan Storage ini
    - 'Update-AzStorageBlobServiceProperty'
...
* Cmdlet yang diperbarui:
    - 'New-AzeventGridSubscription'/'Update-AzEventGridSubscription':
        ...
        - Tambahkan parameter opsional baru untuk mendukung web yang aman menggunakan AAD.
...
* Akun pembuatan/pembaruan yang Storage dengan MinimumTlsVersion dan AllowBlobPublicAccess
    -  'New-AzStorageAccount'
    -  'Set-AzStorageAccount'
...
* Menambahkan 'Premium_LRS' ke argument completer parameter StorageAccountType untuk New-AzGalleryImageVersion cmdlet.
* Menambahkan Substatus ke VMCustomScriptExtension [#11297]
* Menambahkan 'Delete' ke selesai argumen parameterCybespolicy New-AzVM New-AzVMConfig cmdlets.
...
#### <a name="azresources"></a>Az.Resources
* Menambahkan parameter Tail Get-AzDeploymentScriptLog dan Save-AzDeploymentScriptLog cmdlet
...
* Menambahkan dukungan pencarian pengguna Tamu ke Set SQL Server Azure Active Directory cmdlet Admin
...
#### <a name="aziothub"></a>Az.IotHub
* Cmdlet ditambahkan untuk menjalankan kueri dalam hub IoT untuk mengambil informasi menggunakan SQL seperti ini.
...
* Membuat KeyVersion menjadi opsional ketika Storage dengan KeyvaultEncryption, untuk mendukung rotasi otomatis tombol
    - 'Set-AzStorageAccount'
...
* Didukung untuk membuat atau memperbarui Storage dengan Autentikasi Layanan Domain Azure Files Active Directory
    -  'New-AzStorageAccount'
    -  'Set-AzStorageAccount'
* Tombol Kerberos baru atau daftar yang didukung Storage anda
...
#### <a name="azaccounts"></a>Az.Accounts
* Buka Azure PowerShell survei anda di 'Kirim-Umpan Balik' [#11020]
...
#### <a name="azstorage"></a>Az.Storage
* Kumpulan dukungan atur Table/Queue Encryption Keytype dalam Membuat Storage Anda
    - New-AzStorageAccount
...
* Mutakhirkan ke Microsoft.Azure.Management. Storage 14.2.0, untuk mendukung API versi 2019-06-01 yang baru.
...
* Ubah parameter SourceImageId cmdlet New-AzGalleryImageVersion cmdlet menjadi opsional
...
#### <a name="aznetwork"></a>Az.Network
* Mengubah contoh opsi FilterData 'Start-AzVirtualnetworkGatewayPacketCapture.md' dan 'Start-AzVirtualNetworkGatewayConnectionPacketCapture.md' FilterData.
...
- Ubah New-AzAdServicePrincipal menambahkan kredensial hanya ke aplikasi terkait.
...
* Jika tidak ditentukan, nilai default `Scope` akan diatur ke sekarang `PSAutoUserSpecification` `Pool` (berada pada Windows dan di `Task` `Pool` Linux).
...
* Menambahkan ScaleInPolicy ke New-AzVmss, New-AzVmssConfig dan Update-AzVmss cmdlets
* Memutus perubahan
...
#### <a name="azhdinsight"></a>Az.HDInsight
* Perbaikan bug yang akan muncul ketika pelanggan mendapatkan kesalahan 'Bukan string Base-64' yang valid ketika menggunakan Get-AzHDInsightCluster untuk mendapatkan kluster dengan penyimpanan ADLSGen1.
...
#### <a name="azcompute"></a>Az.Compute
* Menambahkan parameter Priority, CmdletPolicy, dan MaxPrice New-AzVM dan New-AzVmss cmdlets
* Memperbaiki pesan peringatan dan dokumen bantuan Add-AzVMAdditionalUnattendContent dan Add-AzVMSshPublicKey cmdlets
...
* Perbaikan bug minor: Get-AzIothub mengembalikan SubscriptionId
...
#### <a name="aznetwork"></a>Az.Network
* Tambahkan cmdlet Get-AzAvailableServiceAlias yang dapat disebut untuk mendapatkan alias yang dapat digunakan untuk Kebijakan Titik Akhir Layanan.
...
* Perbaikan Start-AzAutomationRunbook referensi null cmdlet Null untuk opsi -Wait.
...
* Perbaiki masalah referensi VM Get-AzAvailabilitySet cmdlet setelah mencantumkan semua kumpulan ketersediaan dalam langganan.
...
#### <a name="azcdn"></a>Az.Cdn
* Memperbaiki kesalahan ketik CDN bantuan konversi modul
...
#### <a name="azdatalakestore"></a>Az.DataLakeStore
* Perbaiki masalah Get-DataLakeStoreDeletedItem kesalahan apa pun atau pengecualian jarak jauh.
...
* Perintah cmdlet yang Get-AzNetworkServiceTag
...
* Perintah yang diperbarui di bawah ini untuk fitur: Atur Opsi AAD autentikasi ke Sumber daya gateway jaringan virtual.
...
#### <a name="azstorage"></a>Az.Storage
* Dukungan FileStorage dan SkuName Premium_ZRS saat membuat Storage saya
    - New-AzStorageAccount
...
#### <a name="azresources"></a>Az.Resources
* Menambahkan perintah cmdlet Get-AzureRmDenyAssignment cmdlet untuk mengambil penetapan penolakan
...
* Parameter alih SkipSdown ditambahkan ke Stop-AzVM dan Stop-AzVmss
* Memutus perubahan
...
* Perbarui perintah Get-AzHDInsightJobOutput untuk membedakan peran pembaca dan peran operator hdinsight:
...
* Mutakhirkan ke Microsoft.Azure.Management. Storage 11.0.0, untuk mendukung VERSI API baru 2019-04-01.
* Tipe akun Storage default dalam Membuat akun Storage berubah dari 'Storage' menjadi 'StorageV2'
    - New-AzStorageAccount
...
* Membuat Add-AzureASAccount menjadi pembungkus Connect-AzAccount untuk menghindari perubahan yang tak terhindarkan
...
* Dukungan tambahan untuk sumber data Baru dan Get ApplicationInsights.
    ...
    - Ditambahkan New-AzOperationalInsightsApplicationInsightsDataSource cmdlet untuk membuat sumber data dengan parameter sumber Application-Insights tertentu: Id langganan, resourceGroupName dan nama.
...
* Pengecualian ref null diperbaiki Get-AzSqlCapability
...
#### <a name="azcompute"></a>Az.Compute
* Menambahkan Invoke-AzVMReimage cmdlet
...
#### <a name="azstorage"></a>Az.Storage
* Memperbarui URL bantuan online yang tidak benar
* Berikan pesan kesalahan detail ketika mendapatkan/mengatur Pembuatan Log/Metrik klasik Premium Storage, karena Premium Storage Bukan Pembuatan Log/Metrik klasik.
...
#### <a name="azstorage"></a>Az.Storage
* Mengatur StorageAccountName Storage konteks sebagai nama Storage asli, saat dibuat dengan Sas Token, OAuth atau Anonymous
    - New-AzStorageContext
...
### <a name="azmonitor"></a>Az.Monitor
- Az.Insights diubah namanya menjadi Az.Monitor dan perubahan minor lainnya, lihat [Panduan Migrasi](https://aka.ms/azps-migration-guide) untuk detail
...
* Memperbaiki beberapa tautan yang rusak
    - Dalam artikel New-AzureRmFrontDoor dan Set-AzureRmFrontDoor, perbaikan tautan ke artikel cmdlet New-AzureRmFrontDoorHealthProbeSettingObject cmdlet.
...
* Dokumentasi bantuan yang diubah terkait cmdlet SQL Audit.
...
* Set-AzureRmWebApp dan Set-AzureRmWebAppSlot
    - Parameter baru (-AzureStoragePath) ditambahkan untuk menentukan jalur Azure Storage akan terpasang di aplikasi wadah Windows Linux. Gunakan output cmdlet baru yang New-AzureRmWebAppAzureStoragePath parameter untuk mengatur jalur Azure Storage.
