...
#### <a name="azstorage"></a>Az.Storage
* Mendukung aktifkan/nonaktifkan/dapatkan properti penghapusan sementara untuk file Layanan Storage ini
...
* Memutus perubahan
    ...
    - Tipe AvailabilitySets, VirtualMachines dan VirtualMachineScaleSets diubah dari IList <SubResource> menjadi <SubResourceWithColocationStatus> IList.
...
* Diperbaiki [#9880]: Change NetWorkRule DefaultAction value defination to align with swagger.
    - 'Update-AzStorageAccountNetworkRuleSet'
...
* Tambahkan parameter 'DataProxyIntegrationRuntimeName', 'DataProxyStagingLinkedServiceName' dan 'DataProxyStagingPath' untuk cmd 'Set-AzureRmDataFactoryV2IntegrationRuntime' untuk mengaktifkan konfigurasi Self-Hosted Integration Runtime sebagai proksi untuk SSIS Integration Runtime
...
#### <a name="azservicebus"></a>Az.ServiceBus
* Perbaikan masalah #9658 : Typo VirtualNetworkRule parameter Set-AzServiceBusNetworkRuleSet
* Perbaikan untuk masalah #9786 : tidak dapat membuat aturan dengan hak Dengarkan saja
...
#### <a name="azlogicapp"></a>Az.LogicApp
* Perbaikan agar Get-AzIntegrationAccountMap mencantumkan semua tipe peta
...
#### <a name="azcognitiveservices"></a>Az.CognitiveServices
* Menambahkan CustomSubdomainName sebagai parameter opsional baru untuk New-AzCognitiveServicesAccount yang digunakan untuk menentukan subdomain bagi sumber daya.
