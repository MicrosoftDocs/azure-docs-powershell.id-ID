...
> [!IMPORTANT]
> Saat AzureRM diinstal dalam lingkup Windows PowerShell, maka AzureRM diinstal di lokasi yang merupakan bagian dari `AllUsers` `$env:PSModulePath` PowerShell 7. Hal ini tidak didukung karena adanya konflik antara modul AzureRM dan Az PowerShell.
