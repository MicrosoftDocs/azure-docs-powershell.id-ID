...
ms.openlocfilehash: 7a6b490b1a231ccdfe1e2f699b6295f11fc50008
ms.sourcegitcommit: 53ef403038f665f1b3a9f616185b31f5de9bd7bb
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 11/03/2021
ms.locfileid: "132429463"
---
...
#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Diperbaiki Nonaktifkan SQL Proteksi Otomatis AG.

#### <a name="azsecurity"></a>Az.Security
* Ketersediaan umum modul Az.Security
* Mengubah nama akun Get-AzRegulatoryComplainceAssessment Get-AzRegulatoryComplianceAssessment memperbaiki kesalahan ketik
...
#### <a name="azaccounts"></a>Az.Accounts
* Memperbaiki masalah proksi Http tidak dihargai dalam Windows PowerShell [#13647]
...
* Memperbarui logika di mana schemaName, tableName dan columnName sedang diekstrak dari id SQL Klasifikasi Data.
...
* @jack-education, diperbarui Set-AzVirtualNetworkSubnetConfig agar memperbolehkan NSG dan Route Table dihapus dari subnet (#12351)
...
* Menambahkan 'Delete' ke selesai argumen parameterPolicyCy untuk New-AzVM dan New-AzVMConfig cmdlets.
...
* Saat membuat pool menggunakan 'New-AzBatchPool', properti 'VirtualMachineImageId' dari 'PSImageReference' sekarang hanya bisa merujuk ke gambar Galeri Gambar Bersama.
...
#### <a name="azcompute"></a>Az.Compute
* Batasi jumlah status VM ke 100 agar tidak dibatasi saat Get-AzVM -Status dijalankan tanpa nama VM.
...
* Usangkan Get-AzSqlDatabaseSecureConnectionPolicy cmdlet
...
#### <a name="azstorage"></a>Az.Storage
* Mutakhirkan ke Storage Klien 10.0.1 (ruang nama semua objek dari perubahan SDK ini dari 'Microsoft.WindowsAzure.Storage. *' ke 'Microsoft.Azure. Storage.*')
...
#### <a name="azstorage"></a>Az.Storage
* Memperbarui URL bantuan online yang tidak benar
* Berikan pesan kesalahan mendetail ketika mendapatkan/mengatur Pembuatan Log/Metrik klasik Premium Storage Metrik, karena Premium Storage bukan Pembuatan Log/Metrik klasik.
...
* Perbaikan untuk https://github.com/Azure/azure-powershell/issues/7679
    - Perbarui Get-AzureRmRoleAssignment untuk menggunakan lingkup langganan jika telah disediakan saat meminta administrator klasik.
