...
ms.openlocfilehash: a1cfac3d52ddd62579a2672a46751240967c1b87
ms.sourcegitcommit: 293c9cd17bc9d795b98c03fc727e8164f37c04a4
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 10/13/2021
ms.locfileid: "132429425"
---
...
* Perbaikan bug Pemulihan Situs Azure untuk VMware pada Azure Reprotect, Kebijakan pembaruan, dan Nonaktifkan skenario.
...
* Bug tetap: Menutup gagang file input Import-AzAutomationRunbook
...
* Azure Backup memperbaiki targetPhysicalPath masalah SQL CRR
...
* [Breaking Change] Tipe PSCognitiveServicesAccount.Sku.Tier yang diubah dari SkuTier menjadi string.
...
* Menambahkan dua pengaturan aplikasi tambahan (WEBSITE_CONTENTSHARE dan WEBSITE_CONTENTAZUREFILECONNECTIONSTRING) untuk aplikasi Pemakaian Linux. [15124]
...
* Perbaikan SQL ag memulihkan dan menghapus pemeriksaan nama wadah.
...
#### <a name="azstorage"></a>Az.Storage
* EnkripsiScope buat/perbarui/dapatkan/daftar yang didukung dari akun Storage
    - 'New-AzStorageEncryptionScope'
...
#### <a name="azaccounts"></a>Az.Accounts
* Memperbaiki masalah id TenantId yang mungkin tidak dihargai jika menggunakan 'Koneksi-AzAccount -DeviceCode'[#13477]
...
* Memperbaiki referensi null dan kasus metode insensitive dalam 'Invoke-AzMethod'
...
* Diperbarui 'New-AzFunctionApp':
  ...
  - [Breaking Change] Mengubah versi runtime default dalam Fungsi versi 3 pada aplikasi fungsi Python dari 3.7 menjadi 3.8 ketika parameter RuntimeVersion tidak ditentukan.
...
* Tipe sumber daya baru yang didukung: HSM terkelola
    - CRUD dari HSM terkelola dan cmdlet untuk mengoperasikan tombol di HSM terkelola
...
#### <a name="azsql"></a>az.sql
* Memperbaiki masalah ketika New-AzSqlDatabaseExport gagal jika networkIsolation tidak ditentukan [#13097]
...
* Added BackupStorageRedundancy to the following:
    ...
    - 'New-AzSqlDatabaseCopy'
    - 'New-AzSqlDatabaseSecbasery'
* Menghapus sensitivitas huruf besar/kecil untuk parameter cadanganSpemunyataan dan SQL DB
...
* Ditambahkan 'Get-AzDeploymentManagementGroupWhatIfResult' untuk mendapatkan What-If templat ARM di lingkup Grup manajemen
* Menambahkan cmdlet baru 'Get-AzTenantWhatIfResult' untuk mendapatkan templat ARM What-If hasil pada lingkup penyewa
* Overrode '-WhatIf' dan '-Confirm' untuk 'New-AzManagementGroupDeployment' dan 'New-AzTenantDeployment' untuk menggunakan templat ARM What-If pencarian
...
* Menambahkan dukungan untuk Azure SQL Managed Instance failover: 'Invoke-AzSqlInstanceFailover'
...
* Menambahkan 'Premium_LRS' ke selesai argumen parameter StorageAccountType untuk New-AzGalleryImageVersion cmdlet.
* Menambahkan Substatus ke VMCustomScriptExtension [#11297]
* Menambahkan 'Delete' ke selesai argumen parameterMentpolicy pada New-AzVM dan New-AzVMConfig cmdlets.
...
#### <a name="azaccounts"></a>Az.Accounts
* Diperbarui Azure PowerShell URL survei dalam 'Resolve-AzError' [#11507]
...
* Contoh Get-AzNetworkSecurityGroup yang diperbaiki untuk memperlihatkan contoh untuk NSG, bukan antarmuka jaringan.
...
#### <a name="azstorage"></a>Az.Storage
* Kumpulan dukungan yang diatur dalam Enkripsi Keytype Tabel/Antrean dalam Storage Baru
    - New-AzStorageAccount
...
#### <a name="azaccounts"></a>Az.Accounts
* Pembaruan Add-AzEnvironment lalu Set-AzEnvironment untuk menerima parameter AzureAttestationServiceEndpointResourceId dan AzureAttestationServiceEndpointUpdatefix

#### <a name="azcdn"></a>Az.Cdn
* Menampilkan detail respons kesalahan dalam New-AzCdnEndpoint cmdlet
...
#### <a name="azcompute"></a>Az.Compute
* Fitur Reapply VM
    - Menambahkan menerapkan kembali parameter ke Set-AzVM cmdlet
...
#### <a name="aznetwork"></a>Az.Network
* Ubah contoh opsi FilterData 'Start-AzVirtualNetworkGatewayConnectionPacketCapture.md' dan 'Start-AzVirtualnetworkGatewayPacketCapture.md' FilterData.
...
* Jika tidak ditentukan, nilai default `Scope` dari on `PSAutoUserSpecification` sekarang `Pool` (berada pada Windows dan di `Task` `Pool` Linux).
...
* Memutus perubahan
    - Parameter UploadSizeInBytes digunakan sebagai ganti DiskSizeGB untuk digunakan New-AzDiskConfig saat CreateOption Upload
...
#### <a name="aznetwork"></a>Az.Network
* Tambahkan cmdlet Get-AzAvailableServiceAlias yang bisa disebut untuk mendapatkan alias yang bisa digunakan untuk Kebijakan Titik Akhir Layanan.
...
* Hapus validasi EmailAddresses dan periksa bahwa EmailAdmins tidak false jika EmailAddresses kosong di bagian Set-AzSqlServerAdvancedThreatProtectionPolicy dan Set-AzSqlDatabaseAdvancedThreatProtectionPolicy
