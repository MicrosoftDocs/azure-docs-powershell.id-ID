...
ms.openlocfilehash: 04c0ddd3737ce792b85cfbf432b7824d17bc29b6
ms.sourcegitcommit: 293c9cd17bc9d795b98c03fc727e8164f37c04a4
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 10/13/2021
ms.locfileid: "132429429"
---
...
Untuk kata sandi yang diberikan pengguna, `PasswordCredential` parameter mengambil `Microsoft.Azure.Commands.ActiveDirectory.PSADPasswordCredential` objek. Objek tersebut harus memiliki teks yang valid `StartDate` dan , serta menggunakan teks `EndDate` `Password` biasa. Saat membuat kata sandi, pastikan Anda mengikuti Azure Active Directory [kata sandi dan pembatasan](/azure/active-directory/active-directory-passwords-policy).
