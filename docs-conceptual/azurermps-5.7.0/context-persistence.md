...
Untuk membuat konteks, Anda harus masuk ke Azure. Cmdlet `Connect-AzureRmAccount` (atau aliasnya, `Login-AzureRmAccount`) menetapkan konteks default yang digunakan oleh cmdlet Azure PowerShell berikutnya, dan memungkinkan Anda mengakses penyewa atau langganan apa pun yang diizinkan oleh info masuk Anda.
