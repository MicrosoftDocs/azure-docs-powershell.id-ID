...
* Ditambahkan Cmdlet baru: 'Koneksi-AzContainerRegistry', 'Import-AzContainerRegistry', 'Get-AzContainerRegistryUsage', 'New-AzContainerRegistryNetworkRule', 'Set-AzContainerRegistryNetworkRule'
...
* [Breaking Change] Argumen 'Connectionlink' wajib ada di 'Start-AzVpnConnectionPacketCapture' dan 'Stop-AzVpnConnectionPacketCapture'
...
#### <a name="azsql"></a>az.sql
* Memperbaiki masalah yang New-AzSqlDatabaseExport jikasolasi jaringan tidak ditentukan [#13097]
...
* Added BackupStorageRedundancy to the following:
    ...
    - 'New-AzSqlDatabaseCopy'
    - 'New-AzSqlDatabaseSecbasery'
* Sensitivitas huruf besar/kecil untuk parameter cadanganSusuan SQL referensi DB
...
* Berbagi file daftar yang didukung mencakup file yang telah dihapus dari Storage, dan Mendapatkan penggunaan berbagi file tunggal
    - 'Get-AzRmStorageShare'
...
* Menambahkan bidang 'AssignedHost' ke tampilan contoh 'Get-AzVM' dan 'Get-AzVmss'. Bidang memperlihatkan id sumber daya contoh mesin virtual
...
* @jack-education, diperbarui Set-AzVirtualNetworkSubnetConfig agar NSG dan Route Table dihapus dari subnet (#12351)
...
* Ditambahkan 'Get-AzDeploymentManagementGroupWhatIfResult' untuk mendapatkan hasil What-If arm di lingkup Grup manajemen
...
* Menambahkan dukungan tautan pribadi untuk Storage sumber daya Layanan Aplikasi Web, Keyvault, dan Storage
...
* Memperbaiki pesan bantuan untuk parameter '-Nama' pembuatan dan pembuatan What-If cmdlet
...
#### <a name="azresources"></a>Az.Resources
* Menambahkan parameter Tail Get-AzDeploymentScriptLog dan Save-AzDeploymentScriptLog cmdlets
...
* Terintegrasi Storage klien v12 ke cmdlet Antre dan File
...
* Dokumentasi 'Set-AzApiManagementGroup' Diperbarui untuk menentukan parameter GroupId
...
* Versi SDK SQL benturan untuk Az.Network

#### <a name="azstorage"></a>Az.Storage
* Supported AllowProtectedAppendWrite in ImmutabilityPolicy
    - 'Set-AzRmStorageContainerImmutabilityPolicy'
* Pesan peringatan perubahan yang ditambahkan untuk perubahan tipe AzureStorageTable pada rilis mendatang
    - 'New-AzStorageTable'
    - 'Get-AzStorageTable'
...
#### <a name="azdatalakestore"></a>Az.DataLakeStore
* Dokumentasi pembaruan tentang Get-AzDataLakeStoreDeletedItem dan Restore-AzDataLakeStoreDeletedItem
...
* Menunjuk ke MONITOR SDK terbaru, misalnya 0.24.1-preview
   ...
   - Urutan argumen untuk konstruktif dari kelas **Sumber** (terkait dengan kelas **ScheduledQueryRuleSource)** diubah dari SDK sebelumnya. Perubahan ini memerlukan dua pengujian unit untuk diperbaiki: disusun, tetapi gagal lolos tes.
   - Urutan argumen untuk konstruksi kelas **AlertingAction** (terkait dengan kelas **ScheduledQueryRuleSource)** diubah dari SDK sebelumnya. Perubahan ini memerlukan dua pengujian unit untuk diperbaiki: disusun, tetapi gagal lolos tes.
...
* Cmdlet yang diperbarui:
    - New-AzureRmEventGridSubscription/Update-AzureRmEventGridSubscription:
        - Tambahkan parameter wajib baru untuk mendukung pemipaan untuk Domain Kisi Kejadian yang baru dan Topik Domain Kisi Acara untuk memungkinkan pembuatan langganan acara baru di bawah sumber daya ini.
...
* Mutakhirkan ke Microsoft.Azure.Management. Storage 11.0.0, untuk mendukung API versi 2019-04-01 yang baru.
...
#### <a name="azstorage"></a>Az.Storage
* BlockBlobStorage Jenis Dukungan ketika Storage saya - New-AzStorageAccount
...
#### <a name="azprofile"></a>Az.Profile
* Memperbarui kode umum untuk menggunakan versi terbaru ClientRuntime
* Ganti nama Id Tenant param Connect-AzAccount cmdlet ke Tenant dan tambahkan alias untuk TenantId
...
* Perbaiki Salin Blob/File tidak akan menyalin metadata ketika tujuan memiliki masalah metadata
    ...
    - Start-AzureStorageFileCopy
* Dukungan mendapatkan Storage sumber daya penggunaan lokasi tertentu, dan menambahkan pesan peringatan untuk penggunaan sumber Storage global sudah tak t fungsi.
    - Get-AzStorageUsage
...
* Menambahkan contoh 'SimpleParameterSet' ke New-AzVmss cmdlet baru.
