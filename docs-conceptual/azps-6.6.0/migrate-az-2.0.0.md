...
- Meskipun bukan secara teknis merupakan perubahan, Anda akan menyadari perbedaan output dalam properti Sku.Name dari akun Storage yang dihasilkan `New/Get/Set-AzStorageAccount` dari perubahan adalah sebagai berikut. (Setelah perubahan, output dan SkuName input diratakan.)
