...
ms.openlocfilehash: fbeca6ba7d12ab9fb713321c09f13e0480d62969
ms.sourcegitcommit: dcb33efdfc53ba0b2f271e883021de84878d1f31
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 04/18/2022
ms.locfileid: "143303615"
---
# Stop-AzAksCluster
...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.aks/stop-azakscluster) untuk informasi terbaru.
...
### Contoh 2: Hentikan klaster Aks dengan pipeline
```powershell
PS C:\> Get-AzAksCluster -ResourceGroupName group -Name myCluster | Stop-AzAksCluster
```

Hentikan kluster Aks dengan pipeline.
