...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.dedicatedhsm/update-azdedicatedhsm) untuk informasi terkini.
...
### Contoh 1: Perbarui tag parameter HSM Khusus menurut nama
```powershell
...
### Contoh 2: Perbarui tag parameter dari objek HSM Khusus menurut objek
```powershell
...
Perintah ini memperbarui tag parameter objek HSM Khusus menurut
