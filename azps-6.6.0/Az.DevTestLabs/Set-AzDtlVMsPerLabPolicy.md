...
ms.openlocfilehash: 19083c64c833d3bbf38eb46db06781846cd88c46
...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.devtestlabs/set-azdtlvmsperlabpolicy) untuk informasi terbaru.
...
## DESCRIPTION
Cmdlet **Set-AzDtlVMsPerLabPolicy** mengatur mesin virtual per kebijakan lab lab, yang mengatur jumlah total mesin virtual yang diperbolehkan di laboratorium.
...
### -Non-fungsikan
Menunjukkan bahwa cmdlet ini menonaktifkan kebijakan laboratorium.
...
### -LabName
Menentukan nama lab tempat cmdlet ini mengatur mesin virtual per kebijakan lab.
