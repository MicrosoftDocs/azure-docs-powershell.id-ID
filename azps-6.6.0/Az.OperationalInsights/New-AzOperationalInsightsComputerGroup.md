...
ms.openlocfilehash: 9cadfb576d74c379cff75cea0f0eac41ee241928
...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.operationalinsights/new-azoperationalinsightscomputergroup) untuk informasi terbaru.
...
## DESCRIPTION
Cmdlet **New-AzOperationalInsightsComputerGroup** membuat grup komputer dalam grup dan lokasi sumber daya.

## EXAMPLES

### Contoh 1

Membuat grup komputer. (autogenerasi)
...
### -Kategori
Menentukan kategori grup komputer.
...
### -DisplayName
Menentukan nama tampilan grup komputer.
...
### -Query
Menentukan kueri grup komputer.
...
Cmdlet membuat grup komputer dalam grup sumber daya ini.
