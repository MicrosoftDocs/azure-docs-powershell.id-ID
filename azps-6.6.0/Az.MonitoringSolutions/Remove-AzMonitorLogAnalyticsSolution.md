...
ms.openlocfilehash: 301d6ed3dcaa55f0313c82c390987f5153310791
ms.sourcegitcommit: 1927316437817d48f97c62dceced0067c41b95f2
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 03/15/2022
ms.locfileid: "139937131"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.monitoringsolutions/remove-azmonitorloganalyticssolution) untuk informasi terkini.
...
### Contoh 1: Menghapus solusi analitik log monitor menurut nama
```powershell
PS C:\> Remove-AzMonitorLogAnalyticsSolution  -ResourceGroupName azureps-manual-test -Name 'Containers(monitoringworkspace-2vob7n)'

```

Perintah ini menghapus solusi analitik log monitor menurut nama.
...
Perintah ini menghapus solusi analitik log monitor menurut objek.

### Contoh 3: Menghapus solusi analitik log monitor menurut saluran
```powershell
PS C:\> $monitor = Get-AzMonitorLogAnalyticsSolution -ResourceGroupName azureps-manual-test -Name 'Containers(monitoringworkspace-asdehu)' | Remove-AzMonitorLogAnalyticsSolution

```

Perintah ini menghapus solusi analitik log monitor menurut saluran.
