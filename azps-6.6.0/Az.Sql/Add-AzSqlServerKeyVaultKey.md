...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.sql/add-azsqlserverkeyvaultkey) untuk informasi terbaru.
...
Server harus memiliki izin 'get, wrapKey, unwrapKey' ke kubah.

## EXAMPLES

### Contoh 1: Tambahkan kunci Key Vault
```
