...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.sql/get-azsqlinstancedatabasesensitivityrecommendation) untuk informasi terkini.
...
## DESCRIPTION
Cmdlet Get-AzSqlInstanceDatabaseSensitivityRecommendation mengembalikan tipe informasi yang direkomendasikan dan label sensitivitas kolom di database Azure SQL Instans Terkelola.
