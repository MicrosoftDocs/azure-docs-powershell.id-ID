...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.sql/new-azsqlelasticjob) untuk informasi terkini.
...
### Contoh 1: Membuat pekerjaan baru
```powershell
