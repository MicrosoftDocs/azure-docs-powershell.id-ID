...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.sql/remove-azsqlserver) untuk informasi terkini.
...
Perintah ini akan menghapus server Azure SQL Database bernama Server01.
