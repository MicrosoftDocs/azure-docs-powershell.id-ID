...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.sql/remove-azsqlsyncmember) untuk informasi terkini.
...
## DESCRIPTION
Cmdlet **Remove-AzSqlSyncMember** menghapus anggota Azure SQL Database Sinkronisasi Anda.

## EXAMPLES

### Contoh 1: Hapus anggota sinkronisasi
```
...
Perintah ini menghapus Azure SQL Database Sinkronisasi Bernama syncMember01.
