...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.sql/set-azsqlelasticjob) untuk informasi terkini.
...
## DESCRIPTION
Cmdlet Set-AzSqlElasticJob memperbarui pekerjaan
...
### -IntervalCount
Jumlah interval jadwal berulang
...
### -RunOnce
Bendera untuk menunjukkan pekerjaan akan dijalankan sekali
