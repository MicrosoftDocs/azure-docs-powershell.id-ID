...
Jika tidak ditentukan, cmdlet ini mencari brankas kunci dalam langganan saat ini.
...
Tentukan ID aplikasi, juga dikenal sebagai ID klien, yang terdaftar untuk aplikasi di Azure Active Directory.
