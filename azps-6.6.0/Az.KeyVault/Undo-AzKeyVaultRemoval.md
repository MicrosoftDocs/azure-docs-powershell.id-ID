...
## DESCRIPTION
Cmdlet **Undo-AzKeyVaultRemoval** akan memulihkan brankas kunci yang dihapus sebelumnya. Vault yang dipulihkan akan aktif setelah pemulihan
...
Perintah ini akan memulihkan brankas kunci 'MyKeyVault' yang sebelumnya dihapus dari wilayah eastus2 dan grup sumber daya 'MyResourceGroup', ke dalam status aktif dan dapat digunakan. Ini juga mengganti tag dengan tag baru.
...
### -Lokasi
Menentukan wilayah Azure asli vault yang dihapus.
