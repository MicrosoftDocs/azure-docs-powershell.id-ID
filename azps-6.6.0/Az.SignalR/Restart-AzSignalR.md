...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.signalr/restart-azsignalr) untuk informasi terbaru.
...
### Memulai ulang layanan SignalR tertentu
```powershell
