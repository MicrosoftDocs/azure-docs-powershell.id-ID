...
ms.openlocfilehash: 46349c3aa6890c2420fbced89da3eebb84c35a40
ms.sourcegitcommit: dcb33efdfc53ba0b2f271e883021de84878d1f31
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 04/14/2022
ms.locfileid: "142051841"
---
...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.desktopvirtualization/remove-azwvdapplication) untuk informasi terbaru.
...
### Contoh 1: Menghapus Aplikasi Desktop Virtual Windows menurut nama
```powershell
PS C:\> Remove-AzWvdApplication -ResourceGroupName ResourceGroupName -ApplicationGroupName ApplicationGroupName -Name ApplicationName
```

Perintah ini menghapus Aplikasi Desktop Virtual Windows dalam Grup aplikasi.
