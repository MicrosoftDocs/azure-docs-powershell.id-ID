...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.desktopvirtualization/remove-azwvdhostpool) untuk informasi terbaru.
...
### Contoh 1: Hapus Windows Virtual Desktop HostPool menurut nama
```powershell
