...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.desktopvirtualization/remove-azwvdapplicationgroup) untuk informasi terkini.
...
### Contoh 1: Hapus Windows Virtual Desktop ApplicationGroup menurut nama
```powershell
