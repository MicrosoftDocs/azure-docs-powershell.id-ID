...
### Contoh 1: Dapatkan aplikasi Windows Ruang Kerja Desktop Virtual dengan nama
```powershell
...
Perintah ini akan Windows Kerja Desktop Virtual dalam Grup Sumber Daya.
