...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.desktopvirtualization/new-azwvdapplication) untuk informasi terkini.
...
### Contoh 1: Membuat Windows Aplikasi Desktop Virtual
```powershell
...
Perintah ini akan membuat Windows Desktop Virtual dalam Grup aplikasi.
