...
### Contoh 1: Hapus Windows Paket Skala Desktop Virtual menurut nama
```powershell
PS C:\> Remove-AzWvdScalingPlan -ResourceGroupName ResourceGroupName -Name scalingPlan1
```

Perintah ini menghapus Windows Skala Desktop Virtual dalam Grup Sumber Daya.
