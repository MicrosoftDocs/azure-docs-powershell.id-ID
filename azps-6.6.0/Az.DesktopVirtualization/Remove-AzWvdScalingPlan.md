...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.desktopvirtualization/remove-azwvdscalingplan) untuk informasi terbaru.
...
### Contoh 1: Menghapus Windows Virtual Desktop Scaling Plan menurut nama
```powershell
PS C:\> Remove-AzWvdScalingPlan -ResourceGroupName ResourceGroupName -Name scalingPlan1
```

Perintah ini menghapus Windows Rencana Penskalhan Desktop Virtual dalam Grup Sumber Daya.
