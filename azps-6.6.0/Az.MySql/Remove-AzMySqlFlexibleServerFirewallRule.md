...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.mysql/remove-azmysqlflexibleserverfirewallrule) untuk informasi terbaru.
...
### Contoh 1: Hapus Aturan MySql Firewall menurut nama
```powershell
...
Cmdlet ini menghapus Aturan Firewall MySql menurut nama.

### Contoh 2: Hapus Aturan MySql Firewall menurut identitas
```powershell
...
Cmdlet ini menghapus Aturan MySql Firewall menurut identitas.
