...
ms.openlocfilehash: 2994611b41ca7d182f92de248de18700efcc1b8b
ms.sourcegitcommit: 1927316437817d48f97c62dceced0067c41b95f2
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 03/15/2022
ms.locfileid: "140308237"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.mysql/remove-azmysqlflexibleserver) untuk informasi terkini.
...
### Contoh 1: Hapus server MySql berdasarkan resourceGroup dan nama server
```powershell
...
### Contoh 2: Hapus server MySql berdasarkan identitas
```powershell
...
Cmdlets ini menghapus server MySql berdasarkan identitas.
