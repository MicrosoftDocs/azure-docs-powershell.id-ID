...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.mysql/update-azmysqlserverconfigurationslist) untuk informasi terkini.
...
### Contoh 2: Perbarui daftar konfigurasi MySQL berdasarkan identitas
```powershell
