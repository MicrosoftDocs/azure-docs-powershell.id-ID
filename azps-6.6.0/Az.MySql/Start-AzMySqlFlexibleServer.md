...
ms.openlocfilehash: 21b9ab1c8908b5ed43ef35a21f89dbde17ff55ee
ms.sourcegitcommit: 1927316437817d48f97c62dceced0067c41b95f2
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 03/15/2022
ms.locfileid: "140308165"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.mysql/start-azmysqlflexibleserver) untuk informasi terkini.
...
### Contoh 1: Mulai server dengan nama sumber daya
```powershell
...
### Contoh 2: Mulai server berdasarkan identitas
```powershell
...
Memulai server berdasarkan identitas
