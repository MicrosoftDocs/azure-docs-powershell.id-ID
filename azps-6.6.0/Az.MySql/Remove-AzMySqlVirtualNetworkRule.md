...
ms.openlocfilehash: 86f37057bba6f05f299d783cb4ee375489755ac4
ms.sourcegitcommit: 1927316437817d48f97c62dceced0067c41b95f2
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 03/15/2022
ms.locfileid: "140308201"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.mysql/remove-azmysqlvirtualnetworkrule) untuk informasi terkini.
...
### Contoh 1: Hapus Aturan Jaringan Virtual server MySql menurut nama
```powershell
PS C:\> Remove-AzMySqlVirtualNetworkRule -Name vnet -ResourceGroupName PowershellMySqlTest-ServerName mysql-test

```

Cmdlet ini menghapus MySql server Virtual Network Rule menurut nama.

### Contoh 2: Hapus Aturan Jaringan Virtual server MySql menurut identitas
```powershell
...
Cmdlets ini menghapus MySql server Virtual Network Rule menurut identitas.
