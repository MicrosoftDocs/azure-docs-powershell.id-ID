...
## DESCRIPTION
Cmdlet **Update-AzDataFactoryV2IntegrationRuntimeNode** memperbarui properti node runtime integrasi yang dihosting sendiri di pabrik data. Saat ini hanya mendukung pembaruan 'ConcurrentJobsLimit'.

## EXAMPLES

### Contoh 1: Memperbarui node runtime integrasi yang dihosting sendiri
```
