...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.springcloud/restart-azspringcloudappdeployment) untuk informasi terkini.
...
### Contoh 1: Mulai Ulang Spring Cloud Service by name.
```powershell
PS C:\> Restart-AzSpringCloudAppDeployment -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service -AppName gateway -DeploymentName default
```

Mulai ulang Spring Cloud Service menurut nama.

### Contoh 2: Mulai Ulang Musim Semi Cloud Service dari pipa.
```powershell
