...
ms.openlocfilehash: 1835d3cfd7e42009951bb6f281d0579b29749ea2
ms.sourcegitcommit: dcb33efdfc53ba0b2f271e883021de84878d1f31
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 04/14/2022
ms.locfileid: "142299139"
---
...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.springcloud/restart-azspringcloudappdeployment) untuk informasi terbaru.
...
### Contoh 1: Restart Spring Cloud Service by name.
```powershell
PS C:\> Restart-AzSpringCloudAppDeployment -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service -AppName gateway -DeploymentName default
```

Mulai ulang Layanan Cloud Musim Semi berdasarkan nama.

### Contoh 2: Restart Spring Cloud Service from pipe.
```powershell
PS C:\> Get-AzSpringCloudAppDeployment -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service -AppName gateway -DeploymentName default | Restart-AzSpringCloud
```

Mulai ulang Layanan Cloud Musim Semi dari pipa.
