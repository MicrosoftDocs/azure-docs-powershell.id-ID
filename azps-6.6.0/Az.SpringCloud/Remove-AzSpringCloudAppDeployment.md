...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.springcloud/remove-azspringcloudappdeployment) untuk informasi terbaru.
...
### Contoh 1: Remove Spring Cloud Deployment by name.
```powershell
PS C:\> Remove-AzSpringCloudAppDeployment -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service -AppName gateway -DeploymentName default
```

Hapus Spring Cloud Deployment menurut nama.

### Contoh 2: Remove Spring Cloud Deployment from pipe.
```powershell
PS C:\> Get-AzSpringCloudAppDeployment -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service -AppName gateway -DeploymentName default | Remove-AzSpringCloudAppDeployment
```

Hapus Penyebaran Cloud Musim Semi dari pipa.
