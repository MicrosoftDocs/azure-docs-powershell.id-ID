...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.springcloud/new-azspringcloudapp) untuk informasi terbaru.
...
### Contoh 1: Membuat aplikasi cloud musim semi.
```powershell
...
Buat aplikasi cloud musim semi.
