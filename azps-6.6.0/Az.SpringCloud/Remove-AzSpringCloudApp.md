...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.springcloud/remove-azspringcloudapp) untuk informasi terbaru.
...
### Contoh 1: Hapus Aplikasi Spring Cloud menurut nama.
```powershell
PS C:\> Remove-AzSpringCloudApp -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service -AppName gateway
```

Hapus Aplikasi Cloud Musim Semi menurut nama.

### Contoh 2: Hapus Aplikasi Cloud Musim Semi dari pipe.
```powershell
PS C:\> Get-AzSpringCloudApp -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service -AppName gateway | Remove-AzSpringCloudApp
```

Hapus Aplikasi Cloud Musim Semi dari pipa.
