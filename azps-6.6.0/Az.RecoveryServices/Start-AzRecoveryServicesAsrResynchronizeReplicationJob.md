...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.recoveryservices/start-azrecoveryservicesasrresynchronizereplicationjob) untuk informasi terkini.
...
## DESCRIPTION
Cmdlet **Start-AzRecoveryServicesAsrResynchronizeReplicationJob** mulai menyinkronkan ulang replikasi untuk item terproteksi tertentu jika item yang diproteksi berada dalam status resynchronization diperlukan.
