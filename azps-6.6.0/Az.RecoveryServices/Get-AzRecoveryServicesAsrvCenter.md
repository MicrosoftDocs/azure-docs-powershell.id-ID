...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.recoveryservices/get-azrecoveryservicesasrvcenter) untuk informasi terkini.
...
## DESCRIPTION
Cmdlet **Get-AzRecoveryServicesAsrvCenter** mendapatkan detail server vCenter yang terdaftar untuk penemuan pada server Configuration yang ditentukan oleh kain ASR.
