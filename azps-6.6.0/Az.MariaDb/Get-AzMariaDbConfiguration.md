...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.mariadb/get-azmariadbconfiguration) untuk informasi terbaru.
...
### Contoh 2: Dapatkan konfigurasi MariaDB
```powershell
