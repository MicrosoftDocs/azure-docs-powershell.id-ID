...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.privatedns/new-azprivatednsvirtualnetworklink) untuk informasi terbaru.
...
### -RemoteVirtualNetworkId
Id sumber daya jaringan virtual di penyewa lain.
...
### -VirtualNetwork
Objek jaringan virtual yang terkait dengan tautan.
...
### -ZoneName
Menentukan nama zona yang akan ditautkan ke tautan jaringan virtual.
