...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.postgresql/update-azpostgresqlconfiguration) untuk informasi terbaru.
...
### Contoh 1: Memperbarui konfigurasi PostgreSql menurut nama
```powershell
...
### Contoh 2: Memperbarui konfigurasi PostgreSql menurut identitas.
```powershell
...
Cmdlet ini memperbarui konfigurasi PostgreSql menurut identitas.
