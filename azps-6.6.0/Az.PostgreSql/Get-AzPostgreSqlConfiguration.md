...
ms.openlocfilehash: 27bfffe22965a189d3fd0191b136b03960743d7b
ms.sourcegitcommit: 1927316437817d48f97c62dceced0067c41b95f2
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 03/15/2022
ms.locfileid: "140100359"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.postgresql/get-azpostgresqlconfiguration) untuk informasi terkini.
...
### Contoh 1: Mencantumkan semua konfigurasi di server PostgreSql
```powershell
...
### Contoh 2: Dapatkan konfigurasi PostgreSql tertentu menurut nama
```powershell
