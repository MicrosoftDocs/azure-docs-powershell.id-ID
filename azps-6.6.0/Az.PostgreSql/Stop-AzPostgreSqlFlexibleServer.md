...
ms.openlocfilehash: 41b38c6ba9312713a076c25a92c907092e96cf72
ms.sourcegitcommit: 1927316437817d48f97c62dceced0067c41b95f2
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 03/15/2022
ms.locfileid: "140100036"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.postgresql/stop-azpostgresqlflexibleserver) untuk informasi terkini.
...
### Contoh 1: Hentikan server dengan nama sumber daya
```powershell
PS C:\> Stop-AzPostgreSqlFlexibleServer -ResourceGroupName PowershellPostgreSqlTest -Name postgresql-test
```

Menghentikan server menurut nama

### Contoh 2: Menghentikan server menurut identitas
```powershell
...
Menghentikan server menurut identitas
