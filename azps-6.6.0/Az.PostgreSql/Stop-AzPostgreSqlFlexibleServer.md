...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.postgresql/stop-azpostgresqlflexibleserver) untuk informasi terbaru.
...
### Contoh 1: Hentikan server menurut nama sumber daya
```powershell
...
### Contoh 2: Hentikan server menurut identitas
```powershell
