...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.eventgrid/new-azeventgriddomaintopic) untuk informasi terbaru.
...
Membuat Topik \`Domain Kisi Kejadian1\` di Domain \`Domain1\` di bawah grup \`sumber daya MyResourceGroupName\`.
