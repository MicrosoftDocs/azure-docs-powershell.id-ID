...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.storage/get-azstorageblobserviceproperty) untuk informasi terkini.
...
## DESCRIPTION
Cmdlet **Get-AzStorageBlobServiceProperty** mendapatkan properti layanan untuk Azure Storage Blob Anda.

## EXAMPLES

### Contoh 1: Dapatkan Azure Storage layanan Blob dari akun Storage tertentu
```powershell
...
Perintah ini mendapatkan properti layanan Blob dari Akun Storage tertentu.
...
### -ResourceId
Id Sumber Daya Properti Layanan Blob.
