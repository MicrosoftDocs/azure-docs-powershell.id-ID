...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.storage/set-azdatalakegen2aclrecursive) untuk informasi terkini.
...
## DESCRIPTION
Cmdlet **Set-AzDataLakeGen2AclRecursive** mengatur ACL secara rekursif pada jalur yang ditentukan. ACL input akan menggantikan ACL asli sepenuhnya.

## EXAMPLES

### Contoh 1: Set ACL secara rekursif pada direktori
```
...
Perintah ini pertama-pertama membuat objek ACL dengan entri 3cl, lalu mengatur ACL secara rekursif pada direktori.

### Contoh 2: Atur ACL secara rekursif pada direktori akar filesystem
```
...
Perintah ini pertama menetapkan ACL secara rekursif pada direktori akar dan gagal, lalu lanjutkan dengan ContinuationToken setelah pengguna memperbaiki file yang gagal.

### Contoh 3: Set aCL secara rekursif chunk by chunk
```
$token = $null
...
Skrip ini mengatur ACL secara bertahap pada bagian direktori menurut bagian, dengan ukuran bagian sebagai BatchSize * MaxBatchCount. Ukuran bagian adalah 200 dalam skrip ini.
...
Perintah ini pertama mengatur ACL secara rekursif ke direktori dengan ContinueOnFailure, dan beberapa item gagal, lalu melanjutkan item yang gagal satu per satu.
