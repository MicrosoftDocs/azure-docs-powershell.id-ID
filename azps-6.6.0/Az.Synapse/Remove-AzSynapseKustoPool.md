...
ms.openlocfilehash: 7a98b287ff8c692a5e553ebbc8b9375ae3ba0cfb
ms.sourcegitcommit: 1927316437817d48f97c62dceced0067c41b95f2
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 03/15/2022
ms.locfileid: "140242711"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.synapse/remove-azsynapsekustopool) untuk informasi terkini.
...
### Contoh 1: Delete an existing Kusto pool by name
```powershell
PS C:\> Remove-AzSynapseKustoPool -ResourceGroupName testrg -WorkspaceName testws -Name testnewkustopool
```

Perintah di atas menghapus kolam Kusto bernama "testnewkustopool" di ruang kerja "testws".
