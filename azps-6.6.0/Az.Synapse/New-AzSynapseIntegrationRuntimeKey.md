...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.synapse/new-azsynapseintegrationruntimekey) untuk informasi terkini.
...
## DESCRIPTION
Cmdlet **New-AzSynapseIntegrationRuntimeKey** meregenerasi kunci runtime integrasi dengan nama kunci yang ditentukan oleh parameter 'KeyName'. Kunci sebelumnya tidak valid.
