...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.synapse/remove-azsynapsekustopoollanguageextension) untuk informasi terkini.
...
### Contoh 1: Hapus daftar ekstensi bahasa dari kusto pool
```powershell
