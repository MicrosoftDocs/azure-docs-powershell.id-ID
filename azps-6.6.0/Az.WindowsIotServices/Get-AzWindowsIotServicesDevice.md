...
### Contoh 1: Dapatkan Windows IoT dalam langganan
```powershell
...
Perintah ini akan Windows IoT di bawah grup sumber daya.
...
Perintah ini mendapatkan Windows IoT berdasarkan objek.
