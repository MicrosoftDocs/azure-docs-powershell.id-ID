...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.connectedkubernetes/remove-azconnectedkubernetes) untuk informasi terkini.
...
### Contoh 1: Menghapus file tersambung
```powershell
PS C:\> Remove-AzConnectedKubernetes -ResourceGroupName azureps-manual-test -ClusterName ps-connaks-t01

```

Perintah ini menghapus hubungan yang tersambung

### Contoh 2: Menghapus objek terhubung dengan objek
```powershell
...
Perintah ini menghapus objek tersambung ke objek
