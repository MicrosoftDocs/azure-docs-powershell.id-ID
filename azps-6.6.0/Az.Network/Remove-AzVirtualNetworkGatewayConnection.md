...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.network/remove-azvirtualnetworkgatewayconnection) untuk informasi terkini.
...
### -Nama
Menentukan nama koneksi gateway jaringan virtual yang dihapus cmdlet ini.
...
### -ResourceGroupName
Menentukan nama grup sumber daya yang berisi koneksi gateway jaringan virtual.
