...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.network/new-azexpressrouteconnection) untuk informasi terbaru.
...
## DESCRIPTION
Membuat koneksi ExpressRoute antara peering BGP sirkuit ExpressRoute lokal ke gateway ExpressRoute di dalam hub Virtual.
...
Hal di atas akan membuat grup sumber daya, Virtual WAN, Virtual Network, Virtual Hub, gateway Rute Express dan sirkuit ExpressRoute dengan peering privat di As Tengah Barat dalam grup sumber daya "testRG" di Azure. Setelah gateway dibuat, gateway tersambung ke Peering Sirkuit ExpressRoute menggunakan perintah New-AzExpressRouteConnection.
