...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.network/get-azapplicationgatewaytrustedclientcertificate) untuk informasi terkini.
...
## DESCRIPTION
Cmdlet Get-AzApplicationGatewayTrustedClientCertificate mendapatkan rantai sertifikat CA klien tepercaya dengan nama spesifik dari Gateway Aplikasi.
...
Perintah pertama mendapatkan Gateway Aplikasi dan menyimpannya dalam $gw baru. Perintah kedua mendapatkan rantai sertifikat CA klien tepercaya dengan nama yang ditentukan dari Gateway Aplikasi.
