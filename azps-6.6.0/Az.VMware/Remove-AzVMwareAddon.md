...
ms.openlocfilehash: 670fd66f15298485d39eb7ab89b52d7788627ee6
ms.sourcegitcommit: 1927316437817d48f97c62dceced0067c41b95f2
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 03/15/2022
ms.locfileid: "139930363"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.vmware/remove-azvmwareaddon) untuk informasi terkini.
...
### Contoh 1: Menghapus add-on di awan pribadi
```powershell
...
### Contoh 2: Menghapus add-on di awan pribadi
```powershell
