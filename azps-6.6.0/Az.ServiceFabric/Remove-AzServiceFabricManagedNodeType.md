...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.servicefabric/remove-azservicefabricmanagednodetype) untuk informasi terkini.
...
## DESCRIPTION
Hapus tipe node atau node tertentu di dalam tipe node. Jika paremter -NodeName digunakan maka hanya simpul yang ditentukan yang akan dihapus.
...
Hapus tipe node, dengan pemipaan.
...
Hapus 2 node dari tipe simpul, dengan pemipaan.
...
Berhati-hatilah karena hal ini dapat menyebabkan hilangnya data jika beban kerja yang berat dijalankan di simpul, atau mungkin membawa kluster menurun jika tidak terdapat cukup node awal setelah opearion.
