...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.automation/start-azautomationdscnodeconfigurationdeployment) untuk informasi terkini.
...
## DESCRIPTION
Cmdlet **Start-AzAutomationDscNodeConfigurationDeployment** menempatkan konfigurasi node Desired State Configuration (DSC) dalam Azure Automation.
