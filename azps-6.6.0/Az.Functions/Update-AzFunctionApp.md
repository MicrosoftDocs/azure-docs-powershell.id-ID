...
ms.openlocfilehash: 7cc4f8aee761c1958ca448fc5993c4ea68e57711
ms.sourcegitcommit: 53ef403038f665f1b3a9f616185b31f5de9bd7bb
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 11/03/2021
ms.locfileid: "136348977"
---
...
### Contoh 1: Perbarui fungsi paket hosting aplikasi.
```powershell
PS C:\> Update-AzFunctionApp -Name MyUniqueFunctionAppName -ResourceGroupName MyResourceGroupName -PlanName NewPlanName 
```

Perintah ini memperbarui rencana hosting aplikasi fungsi.

### Contoh 2: Set a SystemAssigned managed identity for a function app.
```powershell
PS C:\> Update-AzFunctionApp -Name MyUniqueFunctionAppName -ResourceGroupName MyResourceGroupName -IdentityType SystemAssigned 
```

Perintah ini mengatur identitas terkelola SystemAssigned untuk aplikasi fungsi.

### Contoh 3: Update function app Application Insights.
```powershell
...
Perintah ini memperbarui fungsi aplikasi Aplikasi Insights.
...
Tipe 'Tidak Ada' akan menghapus identitas apa pun dari aplikasi fungsi.
...
INPUTOBJECT <ISite> : 
  ...
  - `[CloningInfoTrafficManagerProfileName <String>]`: Nama Traffic Manager profil untuk dibuat. Ini hanya diperlukan Traffic Manager profil pengguna tersebut belum ada.
