...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.functions/get-azfunctionappsetting) untuk informasi terbaru.
...
### Contoh 1: Dapatkan pengaturan aplikasi dari aplikasi fungsi.
```powershell
