...
ms.locfileid: "141807026"
---
# Get-AzBlockchainTransactionNodeApiKey

## SYNOPSIS
Cantumkan kunci API untuk simpul transaksi.

> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.blockchain/get-azblockchaintransactionnodeapikey) untuk informasi terbaru.
...
### Contoh 1: List Api keys for a transaction node
```powershell
