...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.apimanagement/remove-azapimanagementuserfromgroup) untuk informasi terbaru.
...
### -GroupId
Menentukan ID grup tempat untuk menghapus pengguna.
...
### -UserId
Menentukan ID pengguna untuk dihapus dari grup.
