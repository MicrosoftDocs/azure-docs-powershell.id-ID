...
ms.openlocfilehash: f04fef662ee454ed6f493d570328ef685bcd12c6
ms.sourcegitcommit: 1927316437817d48f97c62dceced0067c41b95f2
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 03/15/2022
ms.locfileid: "140110655"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.apimanagement/new-azapimanagementapirelease) untuk informasi terkini.
...
Cmdlet **New-AzApiManagementApiRelease** membuat Rilis API untuk Revisi API dalam konteks Manajemen API. Rilis digunakan untuk membuat Revisi Api sebagai Revisi Saat Ini.

## EXAMPLES

### Contoh 1: Membuat Rilis API untuk Revisi API
```powershell
...
Perintah ini akan membuat Rilis API Revisi `2` .`echo-api`

## PARAMETERS

### -ApiId
Pengidentifikasi untuk API baru.
...
### -ApiRevision
Pengidentifikasi untuk Revisi Api.
...
### -ReleaseId
Pengidentifikasi untuk Rilis Api.
Parameter ini bersifat opsional.
Jika pengidentifikasi yang tidak ditentukan akan dihasilkan.
