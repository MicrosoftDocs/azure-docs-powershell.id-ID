...
ms.openlocfilehash: b8a23ea5e96fceb80ba2840986d431a9cb6715ed
ms.sourcegitcommit: 1927316437817d48f97c62dceced0067c41b95f2
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 03/15/2022
ms.locfileid: "140502447"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.logicapp/remove-azintegrationaccount) untuk informasi terkini.
...
### Contoh 1: Hapus akun integrasi
```
PS C:\>Remove-AzIntegrationAccount -ResourceGroupName "ResourceGroup11" -Name "IntegrationAccount31" -Force
```

Perintah ini akan menghapus akun integrasi bernama IntegrationAccount31.
