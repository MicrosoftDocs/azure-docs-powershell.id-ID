...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.streamanalytics/remove-azstreamanalyticsjob) untuk informasi terbaru.
...
### Contoh 1: Menghapus pekerjaan analitik stream
```powershell
PS C:\> Remove-AzStreamAnalyticsJob -ResourceGroupName azure-rg-test -Name sajob-01-pwsh

```

Perintah ini menghapus pekerjaan analitik stream.

### Contoh 2: Menghapus pekerjaan analitik stream menurut pipeline
```powershell
PS C:\> Get-AzStreamAnalyticsJob -ResourceGroupName azure-rg-test -Name sajob-02-pwsh | Remove-AzStreamAnalyticsJob

```

Perintah ini menghapus pekerjaan analitik stream menurut saluran.
