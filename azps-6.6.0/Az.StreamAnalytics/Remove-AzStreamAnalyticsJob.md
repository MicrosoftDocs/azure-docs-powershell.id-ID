...
ms.openlocfilehash: e772f1082e69e9656113720588f0ffdfdab3ad10
ms.sourcegitcommit: 1927316437817d48f97c62dceced0067c41b95f2
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 03/15/2022
ms.locfileid: "140130075"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.streamanalytics/remove-azstreamanalyticsjob) untuk informasi terkini.
...
### Contoh 1: Menghapus pekerjaan analitik streaming
```powershell
PS C:\> Remove-AzStreamAnalyticsJob -ResourceGroupName azure-rg-test -Name sajob-01-pwsh

```

Perintah ini akan menghapus pekerjaan analitik streaming.

### Contoh 2: Menghapus pekerjaan analitik aliran menurut saluran
```powershell
PS C:\> Get-AzStreamAnalyticsJob -ResourceGroupName azure-rg-test -Name sajob-02-pwsh | Remove-AzStreamAnalyticsJob

```

Perintah ini menghapus pekerjaan analitik streaming menurut saluran.
