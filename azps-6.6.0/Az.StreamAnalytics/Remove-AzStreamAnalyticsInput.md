...
### Contoh 1: Menghapus input Analitik Streaming
```powershell
...
### Contoh 2: Menghapus input Analitik Streaming menurut saluran
```powershell
...
Perintah ini menghapus input dari pekerjaan menurut saluran.
