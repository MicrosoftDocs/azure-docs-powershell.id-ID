...
ms.openlocfilehash: 4d782dec9b93ad826d4aa171cba256f784cee16f
ms.sourcegitcommit: b30367cf7752ecec16cdb98aa94322a69487bdf6
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 05/06/2022
ms.locfileid: "144795652"
---
# Connect-AzAccount
...
AuthScope digunakan untuk mendukung skenario bahwa sumber daya data plane telah meningkatkan autentikasi daripada sumber daya ARM, misalnya penyimpanan membutuhkan MFA tetapi ARM tidak.
...
> [!CAUTION]
> Token akses adalah jenis kredensial. Anda harus mengambil tindakan pencegahan keamanan yang sesuai untuk menjaganya tetap rahasia. Token akses juga kehabisan waktu dan dapat mencegah tugas jangka panjang selesai.
...
ID Akun untuk token akses dalam set parameter **AccessToken** . ID akun untuk layanan **terkelola dalam set parameter ManagedService** . Dapat berupa ID sumber daya layanan terkelola, atau ID klien terkait.
...
### -FederatedToken
Menentukan token yang disediakan oleh IdP lain. Penerbit dan subjek dalam token ini harus terlebih dahulu dikonfigurasi agar dipercaya oleh ApplicationId.

> [!CAUTION]
> Token federasi adalah jenis kredensial. Anda harus mengambil tindakan pencegahan keamanan yang sesuai untuk menjaganya tetap rahasia. Token federasi juga kehabisan waktu dan dapat mencegah penyelesaian tugas yang berjalan lama.
