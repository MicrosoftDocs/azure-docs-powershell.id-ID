...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.containerregistry/new-azcontainerregistrywebhook) untuk informasi terbaru.
...
### Contoh 1: Membuat webhook registri kontainer.
```
...
### -Status
Status webhook, nilai default diaktifkan
