...
ms.openlocfilehash: a894767ecf75f0d54a133d5a4f130348f1f3cf9c
ms.sourcegitcommit: dcb33efdfc53ba0b2f271e883021de84878d1f31
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 04/14/2022
ms.locfileid: "142209979"
---
# Get-AzADGroupMember
...
> [!IMPORTANT]
> Karena keterbatasan dengan API Graph saat ini, prinsipal layanan tidak dikembalikan oleh Get-AzAdGroupMember dalam Az 7.x. Untuk solusinya, lihat [Memecahkan masalah modul PowerShell Azure Az](/powershell/azure/troubleshooting#get-azadgroupmember-doesnt-return-service-principals).

## EXAMPLES

### Contoh 1: Daftar anggota menurut nama tampilan grup
```powershell
PS C:\> Get-AzADGroupMember -GroupDisplayName $name
```

Daftar anggota menurut nama tampilan grup

### Contoh 2: Daftar anggota menurut input saluran
```powershell
PS C:\> Get-AzADGroup -DisplayName $name | Get-AzADGroupMember
```

Daftar anggota menurut input saluran
