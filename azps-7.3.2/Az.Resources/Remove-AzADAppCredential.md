...
### Contoh 1: Hapus kredensial dari aplikasi menurut id kunci
```powershell
...
Untuk membangun, lihat bagian CATATAN untuk properti APPLICATIONOBJECT dan membuat tabel hash.
...
APPLICATIONOBJECT <IMicrosoftGraphApplication>: Objek aplikasi, dapat digunakan sebagai input saluran.
