...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.resources/remove-azmanagedapplication) untuk informasi terbaru.
...
## DESCRIPTION
Cmdlet **Remove-AzManagedApplication** menghapus aplikasi yang dikelola

## EXAMPLES

### Contoh 1: Hapus aplikasi terkelola menurut ID sumber daya
```
