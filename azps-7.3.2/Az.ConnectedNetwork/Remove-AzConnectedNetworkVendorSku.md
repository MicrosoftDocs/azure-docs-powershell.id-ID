...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.connectednetwork/remove-azconnectednetworkvendorsku) untuk informasi terbaru.
...
### Contoh 1: Remove-AzConnectedNetworkVendorSku melalui nama Sku dan Nama vendor
```powershell
PS C:\> Remove-AzConnectedNetworkVendorSku -SkuName MySku -VendorName MyVendor

```

Menghapus sku MySku dengan nama vendor MyVendor.

### Contoh 2: Remove-AzConnectedNetworkVendorSku melalui Identitas
```powershell
...
Membuat identitas dengan nama sku MySku1 dan nama vendor MyVendor.
Menghapus sku dengan Identitas yang diberikan.
