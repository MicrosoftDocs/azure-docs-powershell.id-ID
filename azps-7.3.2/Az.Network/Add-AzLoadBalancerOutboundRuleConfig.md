...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.network/add-azloadbalanceroutboundruleconfig) untuk informasi terbaru.
...
## DESCRIPTION
Cmdlet **Add-AzLoadBalancerOutboundRuleConfig** menambahkan konfigurasi aturan keluar ke penyeimbang muatan Azure.
