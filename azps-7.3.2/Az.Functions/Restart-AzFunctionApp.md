...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.functions/restart-azfunctionapp) untuk informasi terbaru.
...
Perintah ini mendapatkan aplikasi fungsi berdasarkan nama dan memulai ulang aplikasi tersebut.

### Contoh 2: Hidupkan ulang aplikasi fungsi menurut nama.
```powershell
