...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.functions/update-azfunctionapp) untuk informasi terbaru.
...
### Contoh 1: Perbarui paket hosting aplikasi fungsi.
```powershell
...
### Contoh 2: Atur SystemAssigned managed identity untuk aplikasi fungsi.
```powershell
...
### Contoh 3: Perbarui aplikasi fungsi Insights aplikasi.
```powershell
...
Aplikasi fungsi pembaruan perintah ini Insights Aplikasi.
