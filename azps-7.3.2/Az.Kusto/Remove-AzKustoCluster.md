...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.kusto/remove-azkustocluster) untuk informasi terbaru.
...
### Contoh 1: Hapus klaster Kusto yang sudah ada menurut nama
```powershell
PS C:\> Remove-AzKustoCluster -ResourceGroupName testrg -Name testnewkustocluster
```

Perintah di atas menghapus klaster Kusto bernama "testnewkustocluster" dalam grup sumber daya "testrg".
