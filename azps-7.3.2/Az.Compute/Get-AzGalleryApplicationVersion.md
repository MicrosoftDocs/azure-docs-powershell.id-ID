...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.compute/get-azgalleryapplicationversion) untuk informasi terbaru.
...
Ambil sumber daya Versi Aplikasi Galeri dengan nama versi, Galeri, nama Aplikasi Galeri, dan Grup Sumber Daya yang disediakan.

### Contoh 2: Dapatkan semua Versi Aplikasi Galeri di GalleryApplication
```powershell
