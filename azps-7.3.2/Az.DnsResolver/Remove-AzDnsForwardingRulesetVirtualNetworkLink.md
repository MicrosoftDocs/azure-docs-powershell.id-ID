...
### Contoh 1: Hapus link jaringan virtual menurut nama.
```powershell
...
Perintah ini menghapus link jaringan virtual menurut nama.

### Contoh 2: Hapus link jaringan virtual menurut identitas
```powershell
...
Perintah ini menghapus link jaringan virtual menurut identitas.
