...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.dnsresolver/remove-azdnsresolver) untuk informasi terbaru.
...
### Contoh 1: Menghapus Pemecah DNS menurut nama
```powershell
Remove-AzDnsResolver -ResourceGroupName powershell-test-rg -Name psdnsresolvername33nmy1fz
```

Perintah ini menghapus Pemecah DNS menurut nama.

### Contoh 2: Menghapus Pemecah DNS menurut identitas
```powershell
...
Perintah ini menghapus Pemecah DNS menurut identitas.
