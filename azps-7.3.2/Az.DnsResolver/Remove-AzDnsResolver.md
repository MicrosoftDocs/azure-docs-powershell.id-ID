...
### Contoh 1: Hapus Resolver DNS menurut nama
```powershell
Remove-AzDnsResolver -ResourceGroupName powershell-test-rg -Name psdnsresolvername33nmy1fz
```

Perintah ini menghapus Dns Resolver menurut nama.

### Contoh 2: Menghapus Resolver DNS menurut identitas
```powershell
...
Perintah ini menghapus Dns Resolver menurut identitas.
