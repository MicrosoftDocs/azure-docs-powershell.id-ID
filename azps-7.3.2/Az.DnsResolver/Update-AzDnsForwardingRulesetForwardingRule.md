...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.dnsresolver/update-azdnsforwardingrulesetforwardingrule) untuk informasi terbaru.
...
### Contoh 1: Memperbarui aturan penerusan menurut nama (menambahkan metadata)
```powershell
...
Perintah ini memperbarui aturan penerusan menurut nama (menambahkan metadata)
