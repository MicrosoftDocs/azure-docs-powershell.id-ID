...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.digitaltwins/remove-azdigitaltwinsendpoint) untuk informasi terbaru.
...
### Contoh 1: Hapus azDigitalTwinsEndPoint dengan EndPointName
```powershell
...
Menghapus azDigitalTwinsEndPoint menurut Objek
