...
## DESCRIPTION
Cmdlet **Set-AzSqlDatabaseGeoBackupPolicy** mengatur kebijakan geo backup yang didaftarkan ke database.
...
Mengatur kebijakan database geo backup. (otomatisgenerated)
