...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.sql/disable-azsqlserveractivedirectoryonlyauthentication) untuk informasi terbaru.
...
## DESCRIPTION
Cmdlet **Disable-AzSqlServerActiveDirectoryOnlyAuthentication** menonaktifkan Azure Active Directory (Azure AD) hanya persyaratan autentikasi untuk AzureSQL Server dalam langganan saat ini.
