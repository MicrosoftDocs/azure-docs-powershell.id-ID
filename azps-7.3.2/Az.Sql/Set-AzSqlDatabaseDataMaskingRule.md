...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.sql/set-azsqldatabasedatamaskingrule) untuk informasi terbaru.
...
## DESCRIPTION
Cmdlet **Set-AzSqlDatabaseDataMaskingRule** mengatur aturan masking data untuk database Azure SQL.
...
Mengatur properti aturan masking data untuk database. (autogenerasi)
