...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.labservices/get-azlabservicesvm) untuk informasi terbaru.
...
### Contoh 1: Mendapatkan semua mesin Virtual di lab.
```powershell
