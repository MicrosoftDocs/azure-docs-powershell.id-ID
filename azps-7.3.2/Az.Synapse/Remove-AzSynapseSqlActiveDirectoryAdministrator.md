...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.synapse/remove-azsynapsesqlactivedirectoryadministrator) untuk informasi terbaru.
...
## DESCRIPTION
Cmdlet **Remove-AzSynapseSqlActiveDirectoryAdministrator** menghapus administrator Azure Active Directory (Azure AD) untuk Ruang Kerja Analitik Azure Synapse.
