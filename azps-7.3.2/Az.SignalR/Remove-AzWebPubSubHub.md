...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.signalr/remove-azwebpubsubhub) untuk informasi terbaru.
...
### Contoh 1: Menghapus pengaturan hub.
```powershell
