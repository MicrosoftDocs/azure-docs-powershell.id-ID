...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.springcloud/stop-azspringcloudappdeployment) untuk informasi terbaru.
...
### Contoh 1: Hentikan Spring Cloud Service menurut nama.
```powershell
PS C:\> Stop-AzSpringCloudAppDeployment -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service -AppName gateway -DeploymentName default
```

Hentikan Layanan Cloud Musim Semi menurut nama.

### Contoh 2: Hentikan Spring Cloud Service dari pipe.
```powershell
