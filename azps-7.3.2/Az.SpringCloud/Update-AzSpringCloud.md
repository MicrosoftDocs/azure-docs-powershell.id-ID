...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.springcloud/update-azspringcloud) untuk informasi terbaru.
...
### Contoh 1: Perbarui Spring Cloud Service menurut nama.
```powershell
...
Perbarui Layanan Awan Musim Semi berdasarkan nama.

### Contoh 2: Update Spring Cloud Service from pipe.
```powershell
...
Perbarui Layanan Cloud Musim Semi dari pipa.
