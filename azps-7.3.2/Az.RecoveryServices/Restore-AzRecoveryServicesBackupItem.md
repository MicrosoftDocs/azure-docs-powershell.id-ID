...
ms.openlocfilehash: d3432a0922484ffe65a2745eb6dce8068e5d6df4
ms.sourcegitcommit: 1927316437817d48f97c62dceced0067c41b95f2
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 03/15/2022
ms.locfileid: "140570470"
---
...
Perintah keempat mendapatkan tanggal saat ini, lalu menyimpannya dalam variabel $EndDate baru.
Perintah kelima mendapatkan daftar poin pemulihan untuk item cadangan tertentu yang difilter oleh tim $StartDate dan $EndDate.
Perintah keenam memicu Pemulihan Lokasi Alternatif (ALR, Alternate Location Restore) untuk membuat VM baru dalam grup sumber daya Target_RG sesuai input yang ditentukan oleh parameter TargetVMName, TargetVNetName, TargetVNetResourceGroup, TargetSubnetName. Atau, jika pengguna ingin melakukan pemulihan di tempat pada VM yang awalnya dicadangkan di lokasi asli, vm dapat dilakukan dengan perintah terakhir. Hindari **menggunakan** TargetResourceGroupName, RestoreAsUnmanagedDisks, TargetVMName, TargetVNetName, TargetVNetResourceGroup, TargetSubnetName parameter untuk menjalankan OLR.

### Contoh 3: Memulihkan disk tertentu dari disk yang dikelola yang dicadangkan Azure VM dari titik pemulihan tertentu
...
### Contoh 4: Memulihkan disk dari VM yang dikelola sebagai Disk tak terkelola
...
### Contoh 5: Pulihkan VM yang tidakageage sebagai Disk tak terageage menggunakan akun penyimpanan asli
...
### Contoh 6: Pulihkan Beberapa file dari item AzureFileShare
...
### Contoh 7: Pulihkan SQL DB dalam Azure VM ke target VM lainnya untuk poin pemulihan penuh yang berbeda
...
### Contoh 8: Pulihkan SQL DB dalam Azure VM ke target VM lainnya untuk titik pemulihan log
...
### Contoh 9: Pemulihan Rehydrate untuk IaasVM dari titik pemulihan yang diarsipkan
...
Di sini, kami memfilter titik-titik pemulihan yang ada dalam tier VaultArchive serta memicu pemulihan dengan prioritas rehydration dan durasi rehydration.
...
### -TargetSubnetName
Nama subnet tempat VM target akan dibuat, dalam hal Pemulihan Lokasi Alternatif pada VM baru
...
### -TargetVMName
Nama VM tempat data harus dipulihkan, dalam hal Pemulihan Lokasi Alternatif pada VM baru
...
### -TargetVNetName
Nama VNet yang menjadi target VM yang akan dibuat, dalam hal Pemulihan Lokasi Alternatif pada VM baru
...
Nama grup sumber daya yang berisi VNet target, dalam kasus Pemulihan Lokasi Alternatif pada VM baru
