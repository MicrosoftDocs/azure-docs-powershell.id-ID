...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.eventgrid/remove-azeventgriddomain) untuk informasi terbaru.
...
Menghapus Domain \`Kisi Kejadian1\` dalam grup \`sumber daya MyResourceGroupName\`.
