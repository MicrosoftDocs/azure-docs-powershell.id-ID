...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.desktopvirtualization/remove-azwvdworkspace) untuk informasi terbaru.
...
### Contoh 1: Menghapus Windows Ruang Kerja Desktop Virtual menurut nama
```powershell
