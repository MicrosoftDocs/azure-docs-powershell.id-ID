...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.desktopvirtualization/update-azwvdapplication) untuk informasi terbaru.
...
### Contoh 1: Memperbarui Aplikasi Desktop Virtual Windows
```powershell
...
Perintah ini memperbarui Aplikasi Desktop Virtual Windows dalam Grup aplikasi.
