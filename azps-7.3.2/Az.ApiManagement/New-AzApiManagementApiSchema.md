...
ms.openlocfilehash: d1f31f4a96dc6f14274bd24393a3e0e653a9ca18
ms.sourcegitcommit: dcb33efdfc53ba0b2f271e883021de84878d1f31
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 04/14/2022
ms.locfileid: "141792986"
---
...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.apimanagement/new-azapimanagementapischema) untuk informasi terbaru.
...
## DESCRIPTION
Membuat Skema API api api yang baru.

## EXAMPLES

### Contoh 1: Buat Skema baru untuk API Ekstensif Swagger Petstore
```powershell
...
Cmdlet **New-AzApiManagementApiSchema** membuat atau memperbarui skema `swagger-petstore-extensive` aPI.

## PARAMETERS

### -ApiId
Pengidentifikasi api. Parameter ini diperlukan.
...
### -SchemaDocument
Dokumen skema api sebagai string. Parameter ini diperlukan adalah -SchemaDocumentFile tidak ditentukan.
...
ContentType dari api Schema. Parameter ini diperlukan.
