...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.automation/get-azautomationdsconboardingmetaconfig) untuk informasi terbaru.
...
## DESCRIPTION
Cmdlet **Get-AzAutomationDscOnboardingMetaconfig** membuat file meta-configuration Managed Object Format (MOF) APS Desired State Configuration (DSC).
