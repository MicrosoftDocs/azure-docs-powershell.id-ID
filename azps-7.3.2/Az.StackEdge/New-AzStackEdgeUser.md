...
> [!NOTE]
>Ini adalah versi dokumentasi kami sebelumnya. Silakan lihat [versi terbaru](/powershell/module/az.stackedge/new-azstackedgeuser) untuk informasi terbaru.
...
## DESCRIPTION
Cmdlet **New-AzStackEdgeUser** membuat pengguna baru untuk perangkat Stack Edge. Pembuatan hanya pengguna tipe `Share` yang didukung.
