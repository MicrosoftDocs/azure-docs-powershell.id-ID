...
## DESCRIPTION
Cmdlet Remove-AzVirtualHubBgpConnection menghapus sumber daya HubBgpConnection yang menambahkan peers Azure Virtual WAN Hub Router dengan peer yang didukung BGP di jaringan virtual yang tersambung ke Virtual WAN Hub.
