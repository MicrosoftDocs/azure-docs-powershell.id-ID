...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.network/remove-azipallocation) untuk informasi terkini.
...
## DESCRIPTION
Cmdlet **Remove-AzIpAllocation** menghapus cmdlet Azure IpAllocation
