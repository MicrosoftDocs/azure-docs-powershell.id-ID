...
## DESCRIPTION
Cmdlet **Set-AzLoadBalancerProbeConfig** memperbarui konfigurasi konfigurasi configuration configuration untuk load balancer.
...
Memperbarui konfigurasi konfigurasi configuration configuration untuk load balancer. (otomatisgenerated)
...
Cmdlet ini memperbarui konfigurasi konfigurasi utama untuk penyeimbang muat yang ditentukan parameter ini.
