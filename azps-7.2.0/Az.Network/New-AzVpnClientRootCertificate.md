...
Perintah pertama menggunakan cmdlet **Get-Content** untuk mendapatkan representasi teks akar yang diekspor sebelumnya; bahwa data teks disimpan di variabel yang bernama $Text.
