...
Perintah ini membuat entri pengecualian baru untuk variabel bernama RequestHeaderNames dan operator yang bernama StartsWith, Selector bernama xyz dan ExclusionManagedRuleSet $exclusionManagedRuleSet. Entri pengecualian disimpan di $exclusionEntry.
