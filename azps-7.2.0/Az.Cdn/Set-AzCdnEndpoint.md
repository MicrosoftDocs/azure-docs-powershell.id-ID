...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.cdn/set-azcdnendpoint) untuk informasi terkini.
...
### Contoh 1: Setel protokol yang diperbolehkan ke HTTPS saja
```powershell
...
Properti yang diperbolehkan untuk diubah adalah: `ContentTypesToCompress`, `IsCompressionEnabled`, `IsHttpAllowed`, `IsHttpsAllowed`, `QueryStringCachingBehavior`, `GeoFilters` dan `Tags`.
