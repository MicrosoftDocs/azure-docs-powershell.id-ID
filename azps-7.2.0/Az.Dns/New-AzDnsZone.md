...
Perintah ini akan membuat zona DNS Privat baru bernama myprivatezone.com dalam grup sumber daya tertentu dengan jaringan virtual resolusi terkait (yang dirujuk oleh variabel $ResVirtualNetwork), lalu menyimpannya dalam variabel $Zone.
...
Perintah ini membuat zona DNS anak baru yang bernama mychild.zone.com dalam grup dan toko sumber daya tertentu dalam $Zone sumber daya tersebut.
Tugas ini juga menambahkan delegasi dalam zona DNS induk yang bernama zone.com dalam grup sumber daya lainnya yang disediakan untuk langganan yang sama dengan zona anak yang dibuat.
