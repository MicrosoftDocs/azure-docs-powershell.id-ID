...
## DESCRIPTION
Cmdlet **Remove-AzRmStorageContainer** menghapus wadah Storage blob

## EXAMPLES

### Contoh 1: Menghapus Storage blob dengan nama Storage dan wadah nama akun
```
...
### Contoh 2: Menghapus Storage blob dengan wadah Storage dan nama wadah akun
```
...
Perintah ini menghapus semua Storage blob dalam akun Storage dengan saluran.
...
### -Force
Paksa untuk menghapus wadah dan semua konten di dalamnya
