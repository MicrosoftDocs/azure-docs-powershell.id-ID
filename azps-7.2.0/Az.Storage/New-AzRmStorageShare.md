...
## DESCRIPTION
Cmdlet **New-AzRmStorageShare** membuat dokumen Storage bersama file.

## EXAMPLES

### Contoh 1: Buat file Storage berbagi file dengan nama Storage dan nama berbagi, dengan metadata dan kuota berbagi sebagai 100 GiB.
```
...
### Contoh 2: Buat Storage file gratis dengan Storage akun Anda
```
...
Perintah ini akan membuat Storage berbagi file dengan Storage objek dan nama berbagi mereka.
