...
ms.locfileid: "138301259"
---
# Update-AzKeyVaultManagedStorageAccount

## SYNOPSIS
Memperbarui atribut yang dapat diedit dari Key Vault yang dikelola Azure Storage Anda.
...
## DESCRIPTION
Perbarui atribut yang dapat diedit dari Key Vault yang Azure Storage Anda.

## EXAMPLES

### Contoh 1: Perbarui kunci aktif ke 'key2' di Kunci Vault yang dikelola Azure Storage Anda.
```powershell
...
Memperbarui atribut yang dapat diedit dari Key Vault yang dikelola Azure Storage Anda. (otomatisgenerated)
