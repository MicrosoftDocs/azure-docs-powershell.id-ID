...
## DESCRIPTION
Menghapus kunci Vault yang dikelola Azure Storage definisi SAS. Ini juga menghapus rahasia yang digunakan untuk mendapatkan token SAS per definisi SAS ini.
...
### Contoh 2: Hapus Key Vault yang Azure Storage sas definition tanpa konfirmasi pengguna.
```powershell
