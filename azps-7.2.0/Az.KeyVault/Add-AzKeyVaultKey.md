...
Perintah pertama mengonversi string menjadi string yang aman dengan menggunakan cmdlet **ConvertTo-SecureString** , lalu menyimpan string tersebut dalam $Password variabel. Untuk informasi selengkapnya, ketik `Get-Help
...
Perintah pertama mengonversi string menjadi string yang aman dengan menggunakan cmdlet **ConvertTo-SecureString** , lalu menyimpan string tersebut dalam $Password variabel.
...
Menghasilkan kunci (disebut sebagai Kunci Exchange (KEK)). KEK harus merupakan kunci RSA-HSM yang hanya memiliki operasi kunci impor. Hanya Kunci Vault Premium SKU yang mendukung tombol RSA-HSM.
