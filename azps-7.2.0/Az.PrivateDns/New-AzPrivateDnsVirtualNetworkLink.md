...
## DESCRIPTION
Cmdlet **New-AzPrivateDnsVirtualNetworkLink** membuat link jaringan virtual Sistem Nama Domain (DNS) privat baru di grup sumber daya dan zona privat yang ditentukan. Anda harus menentukan nama link *unik untuk parameter* Nama atau cmdlet akan mengembalikan kesalahan. Anda dapat menggunakan *variabel* $ConfirmPreference Windows PowerShell konfirmasi dan parameter Konfirmasi untuk mengontrol apakah cmdlet meminta konfirmasi Anda.

## EXAMPLES

### Contoh 1: Membuat link jaringan virtual DNS Privat
```
...
### -EnableRegistration
Alihkan parameter yang menyatakan jika link diaktifkan atau tidak.
...
### -Nama
Menentukan nama link jaringan virtual untuk dibuat.
...
### -RemoteVirtualNetworkId
Id sumber daya jaringan virtual dalam penyewa lain.
...
### -ResourceGroupName
Menentukan grup sumber daya untuk membuat tautan.
...
### -VirtualNetwork
Objek jaringan virtual yang terkait dengan link.
...
### -VirtualNetworkId
Id sumber daya jaringan virtual yang terkait dengan link.
...
### -ZoneName
Menentukan nama zona yang akan ditautkan ke link jaringan virtual.
