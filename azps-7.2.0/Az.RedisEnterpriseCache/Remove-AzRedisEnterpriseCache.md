...
ms.openlocfilehash: 933e88e6dd0ac38a48fb4d05ca95d03dd13a7ef9
ms.sourcegitcommit: 1927316437817d48f97c62dceced0067c41b95f2
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 03/15/2022
ms.locfileid: "140050007"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.redisenterprisecache/remove-azredisenterprisecache) untuk informasi terkini.
...
### Contoh 1: Hapus cache Redis Enterprise dan kembalikan hasilnya
```powershell
...
### Contoh 2: Hapus cache Redis Enterprise dan tidak menampilkan hasilnya
```powershell
PS C:\> Remove-AzRedisEnterpriseCache -Name "MyCache" -ResourceGroupName "MyGroup"
```

Perintah ini akan menghapus cache Redis Enterprise.
