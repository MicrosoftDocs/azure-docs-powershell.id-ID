...
Perintah kedua mendapatkan item Cadangan tipe AzureVM, dari nama "V2VM", dan menyimpannya di $BackupItem cadangan.
...
Perintah terakhir memulihkan disk tertentu, dari LUN yang ditentukan, ke grup Sumber Daya target Target_RG, lalu menyediakan informasi konfigurasi VM dan templat penyebaran dalam Akun penyimpanan DestAccount di grup sumber daya DestRG.
...
Perintah kedua mendapatkan item Cadangan lalu menyimpannya dalam $BackupItem baru.
Perintah ketiga mendapatkan tanggal dari tujuh hari sebelumnya, lalu menyimpannya dalam $StartDate variabel.
Perintah keempat mendapatkan tanggal saat ini, lalu menyimpannya dalam variabel $EndDate baru.
Perintah kelima mendapatkan daftar poin pemulihan untuk item cadangan tertentu yang difilter oleh tim $StartDate dan $EndDate.
...
Perintah pertama mendapatkan vault Layanan Pemulihan dan menyimpannya dalam $vault variabel.
Perintah kedua mendapatkan item Cadangan bernama fileshareitem lalu menyimpannya di $BackupItem pengguna.
...
### Contoh 6: Pulihkan SQL DB dalam Azure VM ke target VM lainnya untuk titik pemulihan penuh yang berbeda
