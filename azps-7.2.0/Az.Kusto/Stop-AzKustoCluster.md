...
ms.openlocfilehash: 38c729e97d7756ac8737ec81a3af110d2f16b7f7
ms.sourcegitcommit: 1927316437817d48f97c62dceced0067c41b95f2
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 03/15/2022
ms.locfileid: "139957875"
---
# Stop-AzKustoCluster
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.kusto/stop-azkustocluster) untuk informasi terkini.
...
### Contoh 1: Stop a Kusto cluster
```powershell
PS C:\> Stop-AzKustoCluster -ResourceGroupName testrg -Name testnewkustocluster
```

Perintah di atas menghentikan kluster Kusto
