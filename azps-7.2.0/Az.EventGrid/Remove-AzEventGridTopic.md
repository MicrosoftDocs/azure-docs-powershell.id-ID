...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.eventgrid/remove-azeventgridtopic) untuk informasi terkini.
...
Menghapus topik Kisi Kejadian Topic1 \`di grup\` sumber daya \`MyResourceGroupName\`.
