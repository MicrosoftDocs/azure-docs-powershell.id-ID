...
## DESCRIPTION
Cmdlet Invoke-AzSqlDatabaseFailover failover Azure SQL database. Jika database berada dalam pool elastis, perintah ini akan membuat database tertentu tanpa mempengaruhi database lain dalam pool elastis yang sama.
