...
## DESCRIPTION
Cmdlet **New-AzSqlDatabaseSec cmdletry** menggantikan cmdlet Start-AzSqlDatabaseCopy saat digunakan untuk menyiapkan replikasi geo untuk database. Area ini mengembalikan objek link replikasi geo dari database utama ke sekunder.
...
### -AllowConnections
Menentukan tujuan baca alamat email Azure SQL Database.
...
### -PartnerServerName
Menentukan nama server database Azure SQL berfungsi sebagai sekunder.
