...
ms.openlocfilehash: c6854596ac31d3c7fd4b9a5f8fb88c491896fb2a
ms.sourcegitcommit: 1927316437817d48f97c62dceced0067c41b95f2
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 03/15/2022
ms.locfileid: "140114595"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.sql/remove-azsqlinstanceactivedirectoryadministrator) untuk informasi terkini.
...
## DESCRIPTION
Cmdlet **Remove-AzSqlInstanceActiveDirectoryAdministrator** menghapus administrator Azure Active Directory (Azure AD) untuk Instans Terkelola AzureSQL dalam langganan saat ini.

## EXAMPLES

### Contoh 1: Hapus administrator
```
...
Perintah ini menghapus administrator Azure AD untuk instans terkelola bernama ManagedInstanceName01 yang terkait dengan grup sumber daya ResourceGroup01.
...
Perintah ini akan menghapus administrator Azure AD dari objek instans terkelola.
...
Perintah ini menghapus administrator Azure AD menggunakan pengidentifikasi sumber daya instans terkelola.
...
### -PassThru
Menentukan apakah akan mengembalikan administrator AD yang dihapus
