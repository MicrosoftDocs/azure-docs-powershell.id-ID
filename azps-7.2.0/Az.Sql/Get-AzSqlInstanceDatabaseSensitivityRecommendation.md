...
## DESCRIPTION
Cmdlet Get-AzSqlInstanceDatabaseSensitivityRecommendation mengembalikan tipe informasi yang direkomendasikan serta label sensitivitas kolom di database Azure SQL Instans Terkelola.

## EXAMPLES

### Contoh 1: Dapatkan tipe informasi yang direkomendasikan dan label sensitivitas dari database Azure SQL Instans Terkelola.
```powershell
