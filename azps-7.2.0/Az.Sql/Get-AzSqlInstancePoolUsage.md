...
Mendapatkan penggunaan instancepool0 SQL Azure.
...
### Contoh 3: Mendapatkan penggunaan azure SQL instance menggunakan id sumber daya instance pool
```powershell
