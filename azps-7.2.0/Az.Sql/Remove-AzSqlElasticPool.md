...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.sql/remove-azsqlelasticpool) untuk informasi terkini.
...
## DESCRIPTION
Cmdlet **Remove-AzSqlElasticPool** menghapus sebuah kolam Azure SQL Database elastis tersebut.
