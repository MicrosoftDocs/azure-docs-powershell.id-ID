...
### Contoh 1: Melanjutkan database Gudang SQL Azure
```
...
## CATATAN
* Cmdlet **Resume-AzSqlDatabase** hanya berfungsi di Azure SQL database Gudang Data. Operasi ini tidak didukung di Azure SQL Database dasar, Standar dan Premium terbatas.
