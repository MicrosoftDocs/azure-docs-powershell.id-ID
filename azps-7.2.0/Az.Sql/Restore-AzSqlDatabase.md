...
Perintah pertama mendapatkan cadangan geo berlebihan untuk database yang bernama Database01, lalu menyimpannya dalam $GeoBackup nya.
...
### -PointInTime
Menentukan titik dalam waktu, sebagai objek **DateTime**, yang ingin Anda pulihkan SQL database Anda.
Untuk mendapatkan objek **DateTime** , gunakan cmdlet **Get-Date** .
