...
ms.openlocfilehash: d530a85be73c1de7c2da8a99ec9c91c0d4fb6432
ms.sourcegitcommit: 1927316437817d48f97c62dceced0067c41b95f2
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 03/15/2022
ms.locfileid: "139925107"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.databricks/remove-azdatabricksvnetpeering) untuk informasi terkini.
...
### Contoh 1: Remove a vnet peering of databricks by name
```powershell
PS C:\> Remove-AzDatabricksVNetPeering -WorkspaceName databricks-test01 -ResourceGroupName lucas-manual-test -Name vnetpeering-t01

```

Perintah ini menghapus perekanan vnet dari tanda bintang menurut nama

### Contoh 2: Menghapus peering vnet dari databricks by object
```powershell
PS C:\> Get-AzDatabricksVNetPeering -ResourceGroupName lucas-manual-test -WorkspaceName databricks-test01 -PeeringName MyPeering-test01 | Remove-AzDatabricksVNetPeering

```

Perintah ini menghapus peering vnet dari tanda bintang data menurut objek
