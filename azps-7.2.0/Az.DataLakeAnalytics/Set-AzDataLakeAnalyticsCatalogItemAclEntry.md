...
ms.openlocfilehash: d5b42bd5ad7c41bb9a072e3d2d8e75df3aa2a96a
ms.sourcegitcommit: 7e47562b11e670049c3a18af7498414da853a921
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 02/09/2022
ms.locfileid: "138318116"
---
...
## DESCRIPTION
Cmdlet **Set-AzDataLakeAnalyticsCatalogItemAclEntry** menambahkan atau mengubah entri (ACE) dalam daftar kontrol akses (ACL, Access Control List) dari katalog atau item katalog di Analitik Danau Data.

## EXAMPLES

### Contoh 1: Mengubah izin pengguna untuk katalog
```powershell
...
### Contoh 5: Mengubah izin pemilik pengguna untuk katalog
```powershell
