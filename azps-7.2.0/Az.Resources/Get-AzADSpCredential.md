...
### Contoh 1: Kredensial daftar dari prinsipal layanan menurut nama tampilan
```powershell
PS C:\> Get-AzADSpCredential -DisplayName $name
```

Kredensial daftar dari prinsipal layanan menurut nama tampilan
