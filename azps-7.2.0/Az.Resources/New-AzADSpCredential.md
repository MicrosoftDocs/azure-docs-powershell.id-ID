...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.resources/new-azadspcredential) untuk informasi terkini.
...
### Contoh 1: Buat kredensial kunci untuk prinsipal layanan
```powershell
...
Buat kredensial kunci untuk prinsipal layanan

### Contoh 2: Buat kredensial kata sandi untuk prinsipal layanan
```powershell
PS C:\> Get-AzADServicePrincipal -ApplicationId $appId | New-AzADSpCredential -StartDate $startDate -EndDate $endDate
```

Buat kredensial kata sandi untuk prinsipal layanan
