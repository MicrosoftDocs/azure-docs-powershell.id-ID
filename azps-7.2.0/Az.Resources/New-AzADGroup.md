...
Anda dapat menggunakannya sebagai argumen $filter untuk mendapatkan grup yang memiliki anggota dengan kesalahan lisensi (dengan kata lain, filter untuk properti ini benar).
Mendukung $filter (eq).
...
### -PreferredLanguage
Bahasa pilihan untuk Microsoft 365 grup.
...
ACCEPTEDSENDER <IMicrosoftGraphDirectoryObject[]>: Daftar pengguna atau grup yang diperbolehkan untuk membuat acara postingan atau kalender di grup ini. Jika daftar ini tidak kosong, maka hanya pengguna atau grup yang terdaftar di sini yang diperbolehkan untuk memposting.
