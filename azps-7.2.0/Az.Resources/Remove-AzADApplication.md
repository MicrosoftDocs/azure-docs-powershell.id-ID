...
ms.openlocfilehash: 25e00f19aeeffc0be41e8e9b7de334545dea38fc
ms.sourcegitcommit: 1927316437817d48f97c62dceced0067c41b95f2
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 03/15/2022
ms.locfileid: "140264405"
---
...
### Contoh 1: Hapus aplikasi dengan nama tampilan
```powershell
PS C:\> Remove-AzADApplication -DisplayName $name
```

Hapus aplikasi dengan nama tampilan

### Contoh 2: Hapus aplikasi dengan input pipeline
```powershell
PS C:\> Get-AzADApplication -ObjectId $id | Remove-AzADApplication
```

Menghapus aplikasi dengan input saluran
...
INPUTOBJECT <IMicrosoftGraphApplication>: Objek aplikasi, bisa digunakan sebagai input saluran.
