...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.labservices/stop-azlabservicesuservm) untuk informasi terkini.
...
### Contoh 1: Stop user assigned VM in the lab.
```powershell
