...
INPUTOBJECT <IImageBuilderIdentity>: Parameter Identitas
  ...
  - `[SubscriptionId <String>]`: Kredensial langganan yang secara unik mengidentifikasi Microsoft Azure langganan. Id langganan merupakan bagian dari URI untuk setiap panggilan layanan.
