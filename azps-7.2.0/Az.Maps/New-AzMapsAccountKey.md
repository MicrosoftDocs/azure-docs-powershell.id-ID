...
### Contoh 1: Regenerasi kunci utama atau sekunder untuk digunakan dengan API Peta
```powershell
...
### Contoh 2: Meregenerasi kunci utama atau sekunder untuk digunakan dengan Peta API menurut pipeline
```powershell
