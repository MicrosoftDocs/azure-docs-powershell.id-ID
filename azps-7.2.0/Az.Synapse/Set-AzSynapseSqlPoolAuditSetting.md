...
Nonaktifkan kebijakan pengauditan hub kejadian dari layanan Analitik Azure Synapse SQL bernama ContosoSqlPool.
...
```
 ...
 Menonaktifkan pengiriman catatan audit analitik Azure Synapse SQL Pool ke penyimpanan blob, dan memungkinkan pengirimannya untuk membuat log analitik.
