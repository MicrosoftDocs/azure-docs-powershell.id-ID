...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.desktopvirtualization/remove-azwvdapplication) untuk informasi terkini.
...
### Contoh 1: Hapus Windows Desktop Virtual berdasarkan nama
```powershell
PS C:\> Remove-AzWvdApplication -ResourceGroupName ResourceGroupName -ApplicationGroupName ApplicationGroupName -Name ApplicationName
```

Perintah ini akan menghapus Windows Desktop Virtual dalam Grup aplikasi.
