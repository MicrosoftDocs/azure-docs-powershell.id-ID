...
### Contoh 1: Dapatkan semua Windows IoT dalam langganan
```powershell
...
Perintah ini memerintahkan Windows IoT dalam grup sumber daya.
...
Perintah ini akan Windows IoT berdasarkan namanya.
...
Perintah ini memberikan Windows IoT berdasarkan objek.
