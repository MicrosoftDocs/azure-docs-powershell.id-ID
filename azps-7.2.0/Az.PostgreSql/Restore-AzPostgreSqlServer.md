...
ms.openlocfilehash: 558adacc697b43f8336ed6375e4eaa47f358e911
ms.sourcegitcommit: 1927316437817d48f97c62dceced0067c41b95f2
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 03/15/2022
ms.locfileid: "140229067"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan [lihat versi terbaru](/powershell/module/az.postgresql/restore-azpostgresqlserver) untuk informasi terkini.
...
### Contoh 1: Pulihkan server PostgreSql menggunakan GeoReplica Restore
```powershell
...
### Contoh 2: Pulihkan server PostgreSql menggunakan PointInTime Restore
```powershell
