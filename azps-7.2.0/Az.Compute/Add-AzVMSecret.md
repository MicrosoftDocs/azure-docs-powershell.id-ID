...
> [!NOTE] 
> Untuk menginstal sertifikat di mesin virtual, disarankan untuk menggunakan ekstensi mesin [virtual Azure Key Vault untuk Linux](https://docs.microsoft.com/azure/virtual-machines/extensions/key-vault-linux) atau ekstensi mesin [virtual Azure Key Vault Windows](https://docs.microsoft.com/azure/virtual-machines/extensions/key-vault-windows) dan bukan `Add-AzVMSecret`.
