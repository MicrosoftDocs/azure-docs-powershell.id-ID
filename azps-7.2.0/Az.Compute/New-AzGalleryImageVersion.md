...
Tambahkan versi gambar baru dari mesin virtual ke definisi gambar.
...
### Contoh 5: Tambahkan versi gambar baru dari disk terkelola dan tambahkan disk data tambahan
...
Buat versi gambar di empat wilayah. Dalam contoh ini, jumlah replika global adalah 1 dan tipe akun penyimpanan global Standard_ZRS. AS Timur akan memiliki 3 replika, masing-masing Standard_LRS penyimpanan akun. As Barat akan mewarisi dari pengaturan global dan memiliki 1 replika yang disimpan di Standard_ZRS. Inggris Barat akan memiliki replika 2 hitungan yang disimpan di Standard_ZRS. Di Bagian Tengah Selatan AS akan ada satu replika yang disimpan di Standard_LRS.
...
Tambahkan versi gambar baru ke definisi gambar tapi kecualikan untuk dipertimbangkan untuk versi terbaru dalam definisi gambarnya.
