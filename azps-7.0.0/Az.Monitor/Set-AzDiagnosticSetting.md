...
### Contoh 5: Mengaktifkan time grain dan beberapa kategori
```powershell
...
Perintah ini memungkinkan semua kategori log untuk langganan.
...
Tentukan $True untuk mengaktifkan diagnostik, $False untuk menonaktifkan diagnostik.
