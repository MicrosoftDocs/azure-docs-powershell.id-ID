...
Id Azure Active Directory pelanggan (AAD) untuk mendapatkan token akses yang akan disertakan sebagai token bearer dalam permintaan pengiriman. Hanya berlaku untuk webhook sebagai tujuan.
