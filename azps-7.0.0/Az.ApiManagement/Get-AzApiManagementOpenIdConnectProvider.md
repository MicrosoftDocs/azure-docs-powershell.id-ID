...
## DESCRIPTION
Cmdlet **Get-AzApiManagementOpenIdConnectProvider** mendapatkan OpenID Koneksi lain di Manajemen API Azure.
...
Perintah ini akan mendapatkan semua penyedia OpenID Koneksi untuk konteks yang ditentukan.
