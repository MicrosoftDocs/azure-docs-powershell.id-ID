...
### Contoh 1: Delete an existing Kusto cluster PrincipalAssignment by name
```powershell
...
Perintah di atas menghapus PrincipalAssignment yang bernama "kustoprincipal1" dalam kluster Kusto "testnewkustocluster".
