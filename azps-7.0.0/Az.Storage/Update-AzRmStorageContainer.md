...
Perintah ini mengubah metadata Storage blob dan akses publik dengan nama akun Storage dan nama wadah.
...
### Contoh 3: Mengatur akses publik sebagai Blob untuk Storage wadah blob dalam akun Storage dengan pipeline
```
