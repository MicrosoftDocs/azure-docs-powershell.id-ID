...
### Contoh 2: Menghapus Storage blob dengan wadah Storage nama wadah dan objek akun
```
...
### Contoh 3: Hapus Storage blob dalam akun Storage dengan pipeline
```
