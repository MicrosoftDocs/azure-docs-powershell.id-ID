...
### Contoh 1: Hapus Storage berbagi file dengan Storage nama akun dan nama berbagi
```
...
### Contoh 2: Hapus file Storage bersama dengan objek Storage dan bagikan namanya
```
PS C:\>$accountObject = Get-AzStorageAccount -ResourceGroupName "myResourceGroup" -StorageAccountName "myStorageAccount"
PS C:\>Remove-AzRmStorageShare -StorageAccount $accountObject -Name "myshare"
```

Perintah ini menghapus file Storage file yang dibagikan Storage objek akun dan nama berbagi.
...
Perintah ini menghapus Storage file yang dibagikan dan semua snapshotnya, mencakup snapshot yang disewakan dan bukan yang dion jangan sewa.
