...
ms.openlocfilehash: 8a907a02ae4ad2c7714e574b0e8d87db9a43204e
ms.sourcegitcommit: 579224f3f35e223624deb694bceb0033c84a5856
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 12/07/2021
ms.locfileid: "136567319"
---
...
### Contoh 1: Perbarui Spring Cloud Service by name.
```powershell
...
Perbarui Layanan Musim Semi Cloud menurut namanya.

### Contoh 2: Perbarui Spring Cloud Service from pipe.
```powershell
...
Perbarui Layanan Awan Musim Semi dari pipa.
...
### -TraceAppInsightInstrumentationKey
Kunci alat wawasan aplikasi target
...
INPUTOBJECT <ISpringCloudIdentity> : Parameter Identitas
  ...
  - `[SubscriptionId <String>]`: Mendapatkan ID langganan yang secara unik mengidentifikasi Microsoft Azure anda. ID langganan membentuk bagian dari URI untuk setiap panggilan layanan.
