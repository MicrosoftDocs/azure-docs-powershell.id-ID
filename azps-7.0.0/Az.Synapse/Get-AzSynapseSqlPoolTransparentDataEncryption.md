...
## DESCRIPTION
Cmdlet **Get-AzSynapseSqlPoolTransparentDataEncryption** mendapatkan status Enkripsi Data Transparan (TDE) untuk pool SQL Azure Synapse Analytics.
