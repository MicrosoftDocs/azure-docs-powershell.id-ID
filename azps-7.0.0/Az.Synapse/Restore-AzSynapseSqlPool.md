...
## DESCRIPTION
Cmdlet **Restore-AzSynapseSqlPool** memulihkan pool SQL Analitik Azure Synapse dari cadangan geo berlebihan, cadangan pool SQL yang dihapus atau titik pemulihan dari setiap SQL lokal.
...
Perintah ini membuat SQL Analitik Azure Synapse dengan memaksimalkan titik pemulihan dari semua SQL lokal yang sudah ada untuk memulihkan atau menyalin dari status sebelumnya.
...
Perintah ini membuat azure Synapse Analytics SQL yang dipulihkan dari pencadangan SQL otomatis yang dihapus.
...
Perintah ini membuat penyimpanan SQL Analitik Azure Synapse dengan tag tertentu dan tipe akun penyimpanan dengan memaksimalkan titik pemulihan dari setiap pool SQL yang sudah ada untuk memulihkan atau menyalin dari status sebelumnya.
...
### -FromBackup
Menunjukkan untuk memulihkan dari cadangan terbaru dari semua SQL gratis di langganan ini.
