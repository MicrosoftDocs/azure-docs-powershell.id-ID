...
Menonaktifkan kebijakan pengauditan penyimpanan blob dari penyimpanan Azure Synapse Analytics SQL bernama ContosoSqlPool.
...
Menonaktifkan kebijakan pengauditan analitik log dari grup Analitik Azure Synapse SQL bernama ContosoSqlPool.
...
```
 ...
 Nonaktifkan pengiriman catatan audit dari Azure Synapse Analytics SQL Pool ke penyimpanan blob, dan aktifkan pengirimannya untuk membuat log analitik.
...
Mengaktifkan pengiriman catatan audit dari Analitik Azure Synapse SQL Pool ke penyimpanan blob, hub kejadian, dan analitik log.
