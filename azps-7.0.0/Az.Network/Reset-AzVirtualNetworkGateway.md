...
### -GatewayVip
Gateway vip untuk mengatur ulang contoh gateway tertentu (misalnya untuk contoh gateway yang Active-Active diaktifkan fitur.) Secara default, gateway primary instance akan diatur ulang jika tidak ada nilai yang diteruskan.
