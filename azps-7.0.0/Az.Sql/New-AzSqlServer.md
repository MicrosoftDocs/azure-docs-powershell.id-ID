...
Perintah ini akan membuat server administrator Azure SQL Database versi 12 dengan properti administrator eksternal dan hanya autentikasi Azure active directory yang diaktifkan.
...
Menentukan SQL Database administrator server untuk server baru. Untuk mendapatkan objek **PSCredential,** gunakan Get-Credential cmdlet. Untuk informasi selengkapnya, ketik `Get-Help
Get-Credential` .
