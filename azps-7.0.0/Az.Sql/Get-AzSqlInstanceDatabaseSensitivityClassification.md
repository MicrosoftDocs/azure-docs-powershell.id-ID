...
ms.locfileid: "136567140"
---
# Get-AzSqlInstanceDatabaseSensitivityClassification

## SYNOPSIS
Mendapatkan tipe informasi saat ini dan label sensitivitas kolom di database Azure SQL Instans Terkelola.
...
### Contoh 4: Dapatkan tipe informasi saat ini dan label sensitivitas kolom tertentu dari database Azure SQL Managed Instance menggunakan Piping.
```powershell
