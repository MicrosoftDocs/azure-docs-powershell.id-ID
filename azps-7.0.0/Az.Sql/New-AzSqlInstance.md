...
### Contoh 7: Buat instans baru dengan Administrator External(Azure Active Directory), hanya Azure Active Directory Autentikasi dan tidak ada SqlAdministratorCredentials
```powershell
