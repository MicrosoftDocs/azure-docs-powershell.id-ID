...
> [!IMPORTANT]
> Agar dapat menggunakan cmdlet ini, firewall di Azure SQL Server perlu dikonfigurasi menjadi "Izinkan layanan dan sumber daya Azure untuk mengakses server ini". Jika ini tidak dikonfigurasi maka kesalahan GatewayTimeout akan dialami.
