...
### Contoh 2: Nonaktifkan rekomendasi sensitivitas pada kolom yang memiliki rekomendasi sensitivitas di database Azure SQL menggunakan Piping.
```powershell
