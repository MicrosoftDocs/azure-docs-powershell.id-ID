...
## DESCRIPTION
Cmdlet Disable-AzSqlDatabaseLedgerDigestUpload menonaktifkan pengunggahan ringkasan Ledger ke penyimpanan Blob Azure atau Azure Confidental Ledger. Untuk menggunakan cmdlet, identifikasi database.
