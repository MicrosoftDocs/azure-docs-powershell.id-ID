...
### Contoh 2: Menonaktifkan kebijakan pengauditan penyimpanan blob Azure SQL Database
```powershell
...
### Contoh 4: Menghapus pemfilteran dari kebijakan pengauditan kebijakan Azure SQL Database
```powershell
...
### Contoh 5: Mengaktifkan kebijakan pengauditan hub kejadian akun Azure SQL Database
```powershell
