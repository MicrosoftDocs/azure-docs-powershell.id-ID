...
### Contoh 3: Mengaktifkan kebijakan pengauditan penyimpanan blob dari server SQL Azure dengan pemfilteran menggunakan predikat SQL T-SQL
```powershell
