...
## DESCRIPTION
Membuat grup Azure SQL Database Contoh Failover baru di antara kawasan tertentu dengan pasangan Instans Terkelola yang noted.
...
Perintah ini akan membuat grup Azure SQL Database Baru Failover. (otomatisgenerated)
