...
Perintah tersebut menamai akun penyimpanan ini Penyimpanan1 dan tipenya dinamai Standard_GRS dan menyimpan hasilnya di dalam variabel yang $StorageAccount.
Perintah kedua membuat objek konfigurasi penyimpanan sebagai akun penyimpanan utama yang terkait dengan layanan media menggunakan informasi ID akun penyimpanan yang disimpan di $StorageAccount penyimpanan.
