...
Perintah pertama membuat rangkaian tag dan menyimpan tag tersebut di variabel yang bernama $Tags.
...
Perintah juga menggunakan array objek konfigurasi penyimpanan yang disimpan $StorageAccounts terbatas.
