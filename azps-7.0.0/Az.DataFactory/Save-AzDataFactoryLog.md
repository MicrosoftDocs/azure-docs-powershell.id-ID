...
Pertama, jalankan cmdlet Get-AzDataFactoryRun untuk mendapatkan ID bagi aktivitas yang dijalankan untuk potongan data, lalu gunakan ID tersebut untuk mengambil file log dari penyimpanan objek besar biner (BLOB) yang terkait dengan kluster HDInsight.
