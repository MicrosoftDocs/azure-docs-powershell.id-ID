...
### Contoh 2: Membuat pabrik data dengan detail konfigurasi repo menggunakan objek pabrik yang sudah ada.
```
...
Perintah ini membuat pabrik data yang bernama WikiADF dalam grup sumber daya yang bernama ADF di lokasi EastUS dengan Azure DevOps kontrol sumber.
...
Perintah ini membuat pabrik data yang bernama WikiADF dalam grup sumber daya yang bernama ADF di lokasi EastUS dengan GitHub sumber konfigurasi..
...
Kamus yang berisi parameter global dari pabrik data.
...
### -HostName
Nama host untuk GitHub konfigurasi repo.
...
### -ProjectName
Nama proyek yang Azure DevOps untuk konfigurasi repo.
...
### -TenantId
Id penyewa untuk Azure DevOps konfigurasi repo.
