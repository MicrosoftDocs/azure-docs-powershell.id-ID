...
### -Nama
Nama CloudEndpoint. Nama adalah GUID, bukan nama mudah yang ditampilkan di portal. Untuk mendapatkan CloudEndpointName, gunakan cmdlet Get-AzStorageSyncCloudEndpoint cmdlet.
