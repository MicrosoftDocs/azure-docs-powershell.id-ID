...
Menghapus Bus Layanan dari ruang `SB-Queue_exampl1` nama `SB-Example1` .
...
Menghapus Bus Layanan yang disediakan di $inputobject untuk parameter -InputObject
