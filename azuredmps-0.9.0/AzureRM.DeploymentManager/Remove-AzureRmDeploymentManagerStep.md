...
## DESCRIPTION
Cmdlet **Remove-AzureRmDeploymentManagerStep** menghapus langkah.
...
### Contoh 3: Menghapus langkah menggunakan objek yang dikembalikan oleh New-AzureRmDeploymentManagerStep
```powershell
