...
### Contoh 1: Membuat profil proteksi
```
...
Menentukan frekuensi, dalam jam, untuk snapshot yang konsisten pada aplikasi.
...
### -CompressionEnabled
Menunjukkan bahwa profil proteksi memungkinkan pemadatan.
...
### -Nama
Menentukan nama untuk profil proteksi.
...
Menentukan interval frekuensi, dalam detik, untuk replikasi. Nilai yang dapat diterima untuk parameter ini adalah:
...
### -ReplicationMethod
Menentukan metode replikasi. Nilai yang dapat diterima untuk parameter ini adalah:

- Online.
Replikasi melalui jaringan.
- Offline.
...
### -ReplicationPort
Menentukan jumlah port tempat replikasi terjadi.
...
### -ReplicationProvider
Menentukan tipe penyedia replikasi. Nilai yang dapat diterima untuk parameter ini adalah: HyperVReplica dan HyperVReplicaAzure.
...
Tentukan waktu dalam waktu 24 jam setelah Anda memulai pekerjaan.
