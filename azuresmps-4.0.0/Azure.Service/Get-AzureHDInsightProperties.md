...
online version: ''
schema: 2.0.0
ms.openlocfilehash: b4ff2ac34cbe4ea82e448a2239a9f24047df7373eeb1dd8747b4bff533af18ac
ms.sourcegitcommit: 49f8ffe5d8e08ba3d22e3b2e76db0e54dd55d4f0
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 08/11/2021
ms.locfileid: "132418972"
---
...
Cmdlet **Get-AzureHDInsightProperties** memiliki properti khusus untuk layanan Azure HDInsight, seperti daftar kawasan Azure yang tersedia, versi kluster HDInsight, dan kapasitas perhitungan yang tersedia.

## EXAMPLES

### Contoh 1: Properti Get HDInsight untuk langganan
```
PS C:\>$SubName = Get-AzureSubscription -Current | %{ $_.SubscriptionName }
PS C:\> Get-AzureHDInsightProperties -Subscription $SubName
```

Perintah pertama akan mendapatkan nama langganan Azure saat ini, lalu menyimpannya dalam $SubName variabel.

Perintah kedua mendapatkan properti HDInsight untuk langganan di $SubName.
...
### -Lokasi
Mengindikasikan bahwa cmdlet ini mendapatkan daftar kawasan Azure tempat layanan HDInsight tersedia.
...
### -Langganan
Menentukan langganan yang berisi properti HDInsight yang akan dapatkan.
...
### -Versions
Menunjukkan bahwa cmdlet ini mendapatkan daftar versi kluster HDInsight yang tersedia di layanan untuk langganan.
