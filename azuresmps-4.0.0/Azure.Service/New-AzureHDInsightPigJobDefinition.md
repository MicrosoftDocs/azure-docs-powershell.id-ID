...
ms.locfileid: "132419912"
---
# New-AzureHDInsightPigJobDefinition

## SYNOPSIS
Menentukan pekerjaan baru Pig untuk layanan HDInsight.
...
**AzureHDInsightPigJobDefinition** menentukan pekerjaan Pig untuk layanan Azure HDInsight.

## EXAMPLES

### Contoh 1: Define a new Pig job
```
PS C:\>$0 = '$0';
...
Perintah pertama mendeklarasikan nilai string, lalu menyimpan dalam variabel $0.

Perintah kedua membuat kueri pekerjaan Pig, lalu menyimpannya dalam variabel $QueryString.

Perintah terakhir membuat definisi pekerjaan Pig yang menggunakan kueri di $QueryString, lalu menyimpan definisi pekerjaan di $PigJobDefinition mereka.

## PARAMETERS

### -Argumen
Menentukan array argumen untuk pekerjaan Pig.
...
### -File
Menentukan kumpulan file yang terkait dengan pekerjaan Pig.
...
### -Query
Menentukan kueri pekerjaan Pig.
