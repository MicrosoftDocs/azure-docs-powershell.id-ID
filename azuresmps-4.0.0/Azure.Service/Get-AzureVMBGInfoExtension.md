...
## DESCRIPTION
Cmdlet **Get-AzureVMBGInfoExtension** menerapkan ekstensi BGInfo di komputer virtual.

## EXAMPLES

### Contoh 1: Dapatkan ekstensi BGInfo diterapkan di komputer virtual yang ditentukan
```
PS C:\> Get-AzureVMBGInfoExtension -VM $VM;
```

Perintah ini akan menerapkan ekstensi BGInfo di komputer virtual yang ditentukan
