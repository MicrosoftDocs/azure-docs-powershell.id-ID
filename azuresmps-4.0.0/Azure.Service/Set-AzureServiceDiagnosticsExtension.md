...
online version: ''
schema: 2.0.0
ms.openlocfilehash: d05b8fb586cbd596927a441927cb439cb9cf8b91
ms.sourcegitcommit: 6dce6f7972b2236b87b25b31465bffaad2435711
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 09/13/2021
ms.locfileid: "132428039"
---
...
## DESCRIPTION
Cmdlet **Set-AzureServiceDiagnosticsExtension** mengaktifkan ekstensi Diagnostik Azure pada peran tertentu atau semua peran pada layanan yang disebarkan atau saat penyebaran.

## EXAMPLES

### Contoh 1: Aktifkan ekstensi Azure Diagnostics
```
...
Perintah ini memungkinkan ekstensi Azure Diagnostics untuk semua peran.

### Contoh 2: Mengaktifkan ekstensi Azure Diagnostics untuk peran tertentu
```
...
Perintah ini mengaktifkan ekstensi Azure Diagnostics untuk peran yang ditentukan.
...
Menentukan array konfigurasi untuk Diagnostik Azure.
...
Anda bisa mengunduh skema dengan menggunakan perintah berikut: 
...
### -Peran
Menentukan array peran opsional yang akan menentukan konfigurasi Diagnostik Azure.
Jika Anda tidak menentukan parameter ini, konfigurasi diagnostik akan diterapkan sebagai konfigurasi default untuk semua peran.
...
### -X509Certificate
Menentukan sertifikat X.509 yang, bila ditentukan, secara otomatis diunggah ke layanan awan dan digunakan untuk mengenkripsi konfigurasi privat ekstensi.
