...
## DESCRIPTION
Cmdlet **Set-AzureServiceDiagnosticsExtension** memungkinkan ekstensi Diagnostik Azure pada peran tertentu atau semua peran pada layanan yang disebarkan atau saat penyebaran.

## EXAMPLES

### Contoh 1: Aktifkan ekstensi Diagnostik Azure
```
...
Perintah ini memungkinkan ekstensi Diagnostik Azure untuk semua peran.

### Contoh 2: Mengaktifkan ekstensi Diagnostik Azure untuk peran tertentu
```
...
Perintah ini memungkinkan ekstensi Diagnostik Azure untuk peran tertentu.
...
Menentukan array konfigurasi untuk Azure Diagnostics.
...
Anda dapat mengunduh skema menggunakan perintah berikut: 
...
### -Peran
Menentukan array peran opsional untuk menentukan konfigurasi Diagnostik Azure.
Jika Anda tidak menentukan parameter ini, konfigurasi diagnostik diterapkan sebagai konfigurasi default untuk semua peran.
...
### -X509Certificate
Menentukan sertifikat X.509 yang, ketika ditentukan, secara otomatis diunggah ke layanan awan dan digunakan untuk mengenkripsi konfigurasi pribadi ekstensi.
