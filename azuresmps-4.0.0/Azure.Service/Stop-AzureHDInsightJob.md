...
### Memulai jobDetails pada HDInsight Cluster (Default)
```
Stop-AzureHDInsightJob -Cluster <String> [-Credential <PSCredential>] -JobId <String>
 [-Profile <AzureSMProfile>] [<CommonParameters>]
```

### Memulai jobDetails pada Kluster HDInsight (dengan Kredensial Langganan Tertentu)
```
...
Cmdlet **Stop-AzureHDInsightJob** menghentikan pekerjaan Azure HDInsight di kluster yang ditentukan.
...
### -JobId
Menentukan ID pekerjaan HDInsight untuk dihentikan.
