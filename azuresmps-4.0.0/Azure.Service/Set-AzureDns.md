...
Perintah ini mengubah alamat IP server DNS bernama Dns07 untuk layanan bernama ContosoService.
...
### -IPAddress
Menentukan alamat IP baru server DNS.
...
### -Nama
Menentukan nama server DNS yang diubah cmdlet ini.
