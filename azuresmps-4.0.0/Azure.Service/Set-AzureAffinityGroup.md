...
## DESCRIPTION
Cmdlet **Set-AzureAffinityGroup** mengubah properti grup Azure affinity.
Anda bisa mengubah label dan deskripsi.

## EXAMPLES

### Contoh 1: Mengubah grup afiliasi
```
...
Perintah ini mengubah label grup afiliasi yang bernama South01 menjadi SouthUSProduction Perintah tersebut juga mengubah deskripsi.

## PARAMETERS

### -Deskripsi
Menentukan deskripsi dari grup afiliasi.
...
Label dapat memiliki panjang hingga 100 karakter.
...
### -Nama
Menentukan nama grup afiliasi yang dimodifikasi cmdlet ini.
