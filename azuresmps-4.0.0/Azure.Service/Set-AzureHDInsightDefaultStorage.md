...
Perintah keempat, kelima, dan keenam menggunakan cmdlet **Get-Credential** untuk mendapatkan kredensial untuk langganan saat ini, lalu menyimpan kredensial di variabel $Creds, $OozieCreds, dan $HiveCreds.
...
- **Set-AzureHDInsightDefaultStorage** untuk mengatur akun penyimpanan default agar konfigurasi diatur MyBlobStorage.blob.core.windows.net.
...
Menentukan nama wadah penyimpanan default untuk kluster.
