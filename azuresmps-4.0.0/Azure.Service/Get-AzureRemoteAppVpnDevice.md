...
## SYNOPSIS
Mengambil informasi tentang perangkat VPN.
...
## DESCRIPTION
Cmdlet **Get-AzureRemoteAppVpnDevice** mengambil informasi tentang perangkat jaringan privat virtual (VPN).

## EXAMPLES

### Contoh 1: Mengembalikan konfigurasi perangkat VPN yang tersedia untuk jaringan virtual
```
