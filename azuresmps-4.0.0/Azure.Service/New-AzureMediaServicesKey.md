...
online version: ''
schema: 2.0.0
ms.openlocfilehash: 8285c9687035ceb1a4692362f9cb82261651f3074b8bb6a3bff2325584e7c4b2
ms.sourcegitcommit: 49f8ffe5d8e08ba3d22e3b2e76db0e54dd55d4f0
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 08/11/2021
ms.locfileid: "132419299"
---
# New-AzureMediaServicesKey

## SYNOPSIS
Memperbarui Azure Media Services akun Anda.
...
Cmdlet **New-AzureMediaServicesKey** memperbarui kunci Primer atau Sekunder untuk akun Media Services tertentu.

## EXAMPLES

### Contoh 1: Memperbarui Media Services akun Anda
```
...
### -Force
Menunjukkan bahwa generasi kunci belum dikonfirmasi.
...
### -KeyType
Menentukan tipe Media Services berikut; Nilai valid adalah:
...
### -Nama
Menentukan nama akun Media Services Anda.
