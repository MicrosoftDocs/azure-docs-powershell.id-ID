...
### Contoh 1: Mengaktifkan pembuatan log HTTP untuk situs web
```
...
Menentukan apakah kesalahan IIS mendetail dicatat untuk situs web.
...
### -HostNames
Menentukan nama host yang sepenuhnya memenuhi syarat yang bisa digunakan untuk mengakses situs web.
...
### -HttpLoggingEnabled
Menentukan apakah pembuatan log http diaktifkan untuk situs web.
...
### -ManagedPipelineMode
Menentukan mode saluran terkelola.
...
Menentukan apakah penelusuran permintaan diaktifkan untuk situs web.
...
### -WebSocketsEnabled
Menentukan apakah akan mengaktifkan WebSockets.
