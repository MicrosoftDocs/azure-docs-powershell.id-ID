...
### Menghapus instalanBGInfoExtension
```
...
## DESCRIPTION
Cmdlet **Set-AzureVMBGInfoExtension** mengatur ekstensi BGInfo untuk mesin virtual.

## EXAMPLES

### Contoh 1: Mengatur ekstensi BGInfo untuk mesin virtual
```
PS C:\> Set-AzureVMBGInfoExtension -VM $VM
```

Perintah ini mengatur ekstensi BGInfo untuk mesin virtual tertentu seperti yang disimpan dalam variabel $VM.
...
Anda dapat menentukan nama referensi yang sebelumnya digunakan saat memperbarui ekstensi.
...
### -Hapus instalan
Menunjukkan bahwa cmdlet ini menghapus instalan ekstensi BGInfo.
