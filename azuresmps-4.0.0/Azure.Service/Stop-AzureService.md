...
Cmdlet **Stop-AzureService** menghentikan layanan yang dihosting saat ini di slot yang ditentukan di Windows Azure.
Jika tidak ada slot yang ditentukan, cmdlet menghentikan layanan di slot Produksi.
...
### -Slot
Menentukan slot tempat layanan dihosting, baik Staging atau Production.
Jika tidak ada slot yang ditentukan, Produksi diasumsikan.
