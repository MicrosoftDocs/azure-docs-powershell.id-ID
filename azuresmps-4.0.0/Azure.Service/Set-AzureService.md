...
## DESCRIPTION
Cmdlet **Set-AzureService** menetapkan label dan deskripsi untuk layanan dalam langganan saat ini.

## EXAMPLES

### Contoh 1: Memperbarui label dan deskripsi untuk layanan
```
PS C:\> C:\PS>Set-AzureService -ServiceName "MySvc1" -Label "MyTestSvc1" -Description "My service for testing out new configurations"
```

Perintah ini mengatur label ke "MyTestSvc1" dan deskripsi ke "Layanan saya untuk menguji konfigurasi baru" untuk layanan MyTestSvc1.
