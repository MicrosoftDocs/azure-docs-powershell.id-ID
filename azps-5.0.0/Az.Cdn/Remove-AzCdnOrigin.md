...
## DESKRIPSI
Remove-AzCdnOrigin akan menghapus origin CDN tersebut dari titik akhir yang diberikan. Jika origin adalah satu-satunya origin dalam titik akhir yang ditentukan, penghapusan akan gagal karena setidaknya diperlukan 1 origin. 
...
```
Cmdlet ini akan menghapus origin tertentu dari titik akhir yang diberikan. 
