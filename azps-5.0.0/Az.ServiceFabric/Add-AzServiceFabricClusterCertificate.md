...
## DESKRIPSI
Gunakan **Add-AzServiceFabricClusterCertificate** untuk menambahkan sertifikat kluster sekunder, baik dari vault kunci Azure yang sudah ada atau membuat kunci vault Azure baru menggunakan sertifikat yang sudah ada yang disediakan atau dari sertifikat baru yang ditandatangani sendiri yang dibuat. Kluster ini akan menimpa kluster sekunder jika ada.
