...
Pintu Depan yang akan diperbarui dapat diidentifikasi menggunakan FrontoorName dan ResourceGroupName, objek PSFrontDoor, atau ResourceId. (Lihat 3 contoh di atas, misalnya) Contoh di bawah ini menggunakan objek PSFrontDoor.
