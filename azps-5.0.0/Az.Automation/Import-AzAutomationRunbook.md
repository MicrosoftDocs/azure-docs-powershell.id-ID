...
## DESKRIPSI
Cmdlet **Import-AzAutomationRunbook** mengimpor runbook Azure Automation. Tentukan jalur ke file skrip wps_2 (.ps1) untuk diimpor ke runbooks wps_2 dan Alur Kerja wps_2, (.graphrunbook) untuk runbooks grafis, atau file (.py) untuk python 2 runbooks. Untuk wps_2 runbooks Alur Kerja, skrip harus berisi satu wps_2 definisi Alur Kerja yang cocok dengan nama file.
...
Mengimpor buku jalankan Otomatisasi. (otomatisgenerated)
