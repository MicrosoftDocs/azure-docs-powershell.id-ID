...
### Contoh 1: Membuat objek filter aturan ManajemenPolicy lalu menambahkannya ke aturan kebijakan manajemen dan mengaturnya Storage anda
```
...
### -PrefixMatch
Array string untuk prefiks agar cocok.
