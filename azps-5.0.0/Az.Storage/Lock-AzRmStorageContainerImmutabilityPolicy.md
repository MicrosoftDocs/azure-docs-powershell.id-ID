...
Perintah ini Mengunci ImmutabilityPolicy penampung Storage blob dengan nama Storage dan kontainer nama akun.

### Contoh 2: Kunci ImmutabilityPolicy of a Storage blob container, with Storage account object
```
