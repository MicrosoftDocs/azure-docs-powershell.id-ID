...
### Contoh 1: Membuat wadah Storage blob dengan nama Storage dan wadah nama, dengan metadata
```
...
Perintah ini akan membuat Storage blob dengan Storage objek akun dan nama wadah, dengan akses publik sebagai Blob.
