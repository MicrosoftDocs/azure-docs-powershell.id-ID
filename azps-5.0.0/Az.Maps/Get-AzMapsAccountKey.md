...
## DESKRIPSI
Cmdlet Get-AzMapsAccountKey cmdlet mendapatkan kunci API untuk akun azure Peta yang disediakan.
...
Gunakan New-AzMapsAccountKey (New-AzMapsAccountKey.md)untuk meregenerasi kunci.
...
### -InputObject
Peta akun dibesin dari Get-AzMapsAccount.
