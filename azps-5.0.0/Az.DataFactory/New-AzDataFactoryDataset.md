...
Perintah pertama membuat set data yang DA_WikipediaClickEvents, seperti dalam contoh sebelumnya, lalu menetapkan set data tersebut ke $Dataset berbeda.
