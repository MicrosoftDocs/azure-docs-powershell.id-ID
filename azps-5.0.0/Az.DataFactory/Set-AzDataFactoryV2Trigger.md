...
Buat pemicu baru yang disebut "ScheduledTrigger" di pabrik data "WikiADF". Pemicu dibuat dalam status 'Dihentikan', yang berarti pemicu tidak langsung dimulai. Pemicu dapat mulai menggunakan `Start-AzDataFactoryV2Trigger` cmdlet.
