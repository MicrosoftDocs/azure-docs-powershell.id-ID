...
### Contoh 1: Create a configuation for krigs cluster
```powershell
...
Perintah ini membuat konfigurasi untuk kluster grup.
...
### -ClusterScoped
Jika lolos, tentukan lingkup Configuration to Cluster (default adalah nameSpace).
