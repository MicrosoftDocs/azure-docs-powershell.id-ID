...
## DESKRIPSI
Perintah ini akan menghapus titik akhir awan tertentu dari grup sinkronisasi. File Azure yang berbagi referensi titik akhir awan tidak tersentuh oleh proses ini. Perintah ini hanya ditujukan untuk pencocokan. Menghapus titik akhir awan adalah operasi perusak. Titik akhir server tidak dapat disinkronkan tanpa ada setidaknya satu titik akhir awan. Operasi ini tidak boleh dilakukan untuk mengatasi masalah sinkronisasi. Jika berbagi file Azure ini ditambahkan lagi ke grup sinkronisasi yang sama, sebagai titik akhir awan, masalah ini dapat menyebabkan file yang berkonflik dan konsekuensi lain yang tidak diinginkan.
