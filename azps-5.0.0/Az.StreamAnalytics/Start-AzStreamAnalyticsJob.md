...
## DESKRIPSI
Cmdlet **Start-AzStreamAnalyticsJob** menyebarkan dan memulai pekerjaan Stream Analytics di Azure.
...
- CustomTime - Nilai ini menunjukkan bahwa titik awal streaming kejadian output harus dimulai pada waktu kustom yang ditentukan dalam parameter *OutputStartTime.* 
 - LastOutputEventTime - Nilai ini menunjukkan bahwa titik awal aliran acara output harus dimulai dari waktu output acara terakhir.
