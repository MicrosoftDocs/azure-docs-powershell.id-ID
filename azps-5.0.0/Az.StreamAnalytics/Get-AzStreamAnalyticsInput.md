...
## DESKRIPSI
Cmdlet **Get-AzStreamAnalyticsInput** mencantumkan semua input yang ditetapkan dalam pekerjaan Analitik Stream atau mendapatkan informasi tentang input tertentu.
