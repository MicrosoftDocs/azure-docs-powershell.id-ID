...
### Contoh 1: Enable data encryption of the app conifguration store by system-assigned managed identity
```powershell
...
### Contoh 2: Enable data encryption of the app conifguration store by user-assigned managed identity
```powershell
PS C:\> $key = Add-AzKeyVaultKey -VaultName kv-Name -Name key-Name -Destination 'Software'
...
### Contoh 3: Disable encryption of an app conifguration store.
```powershell
...
### Contoh 3: Update sku and tag of an app conifguration store by pipeline.
```powershell
