...
## DESKRIPSI
Cmdlet **Get-AzBatchJobPreparationAndReleaseTaskStatus** mendapatkan status persiapan pekerjaan dan rilis tugas Azure Batch untuk pekerjaan Kumpulan.
