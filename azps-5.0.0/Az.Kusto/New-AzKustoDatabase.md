...
### Contoh 1: Membuat database Kusto baru menurut nama
```powershell
...
Perintah di atas membuat database Kusto baru bernama "mykustodatabase" dalam kluster "testnewkustocluster" yang ada yang ditemukan dalam grup sumber daya "testrg".
