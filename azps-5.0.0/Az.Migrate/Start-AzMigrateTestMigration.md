...
## DESKRIPSI
Cmdlet Start-AzMigrateTestMigration memulai migrasi pengujian untuk server yang replikasi.
...
INPUTOBJECT <IMigrationItem> : Menentukan server replikasi tempat migrasi percobaan perlu dimulai. Objek server dapat diambil menggunakan cmdlet Get-AzMigrateServerReplication.
  ...
  - `[CurrentJobId <String>]`: Id ARM dari pekerjaan yang sedang dijalankan.
  - `[CurrentJobName <String>]`: Nama pekerjaan.
  - `[CurrentJobStartTime <DateTime?>]`: Waktu mulai pekerjaan.
