...
Perintah ini akan membuat RecordSet. Parameter Overwrite memastikan bahwa kumpulan catatan ini menimpa kumpulan data apa pun yang sudah ada sebelumnya dengan nama dan tipe yang sama (catatan yang sudah ada di kumpulan catatan hilang). Parameter Konfirmasi dengan nilai $False akan menyembunyikan perintah konfirmasi.
