...
### Contoh 1: Dapatkan pengaturan pengauditan database Azure SQL baru
```
...
### Contoh 2: Dapatkan, melalui pipeline, pengaturan pengauditan database Azure SQL anda
```
...
### Contoh 3: Dapatkan pengaturan pengauditan database Azure SQL baru
```
PS C:\>Get-AzSqlDatabaseAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01"
ServerName                          : server01
DatabaseName                        : database01
