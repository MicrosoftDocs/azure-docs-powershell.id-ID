...
### Contoh 1: Menonaktifkan rekomendasi sensitivitas pada kolom tertentu dalam database instans terkelola Azure SQL.
```powershell
...
### Contoh 3: Nonaktifkan rekomendasi sensitivitas pada kolom tertentu dalam database instans terkelola Azure SQL dengan Piping.
```powershell
