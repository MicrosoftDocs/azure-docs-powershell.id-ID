...
## DESKRIPSI
Cmdlet Enable-AzSqlInstanceDatabaseSensitivityRecommendation memungkinkan rekomendasi sensitivitas pada kolom di database Azure SQL instans terkelola.
...
### Contoh 2: Mengaktifkan rekomendasi sensitivitas pada kolom tertentu dalam database instans terkelola Azure SQL dengan Piping.
```powershell
