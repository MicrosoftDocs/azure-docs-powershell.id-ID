...
## DESKRIPSI
Cmdlet **Set-AzSqlDatabaseAudit** mengubah pengaturan pengauditan database SQL Azure.
...
### Contoh 1: Mengaktifkan kebijakan pengauditan penyimpanan blob untuk database SQL Azure
```powershell
...
### Contoh 2: Menonaktifkan kebijakan pengauditan penyimpanan blob untuk database SQL Azure
```powershell
...
### Contoh 3: Mengaktifkan kebijakan pengauditan penyimpanan blob database Azure SQL dengan pemfilteran tingkat lanjut menggunakan predikat SQL T
```powershell
...
### Contoh 4: Menghapus pengaturan pemfilteran tingkat lanjut dari kebijakan audit database SQL Azure
```powershell
...
### Contoh 5: Mengaktifkan kebijakan pengauditan hub kejadian untuk database SQL Azure
```powershell
...
### Contoh 6: Menonaktifkan kebijakan pengauditan hub kejadian untuk database SQL Azure
```powershell
...
### Contoh 7: Mengaktifkan kebijakan pengauditan analitik log untuk database SQL Azure
```powershell
...
### Contoh 8: Menonaktifkan kebijakan pengauditan analitik log untuk database SQL Azure
```powershell
...
### Contoh 9: Menonaktifkan, melalui saluran, kebijakan pengauditan analitik log untuk database SQL Azure
```powershell
...
### Contoh 10: Menonaktifkan pengiriman catatan audit database Azure SQL ke penyimpanan blob, dan memungkinkan pengirimannya untuk membuat log analitik.
```powershell
...
### Contoh 11: Mengaktifkan pengiriman catatan audit database Azure SQL ke penyimpanan blob, hub kejadian, dan analitik log.
```powershell
...
Untuk informasi selengkapnya, lihat https://docs.microsoft.com/en-us/sql/relational-databases/security/auditing/sql-server-audit-action-groups-and-actions#database-level-audit-actions .
...
Untuk informasi selengkapnya, lihat https://docs.microsoft.com/en-us/sql/relational-databases/security/auditing/sql-server-audit-action-groups-and-actions#database-level-audit-action-groups .
...
### -PredicateExpression
Predikat T-SQL (klausul WHERE) yang digunakan untuk memfilter log audit.
