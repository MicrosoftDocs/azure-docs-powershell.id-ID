...
## DESKRIPSI
Cmdlet Set-AzSqlInstanceTransparentDataEncryptionProtector menetapkan instans tDE tertentu untuk instans SQL terkelola. Mengubah tipe tripoin TDE akan memutar tripoin tersebut.
...
Perintah ini memperbarui tipe instans terkelola TDE luar biasa menjadi Service Managed.
...
### -Tipe
Tipe enkripsi data transparan Database Azure Sql yang luar biasa.
