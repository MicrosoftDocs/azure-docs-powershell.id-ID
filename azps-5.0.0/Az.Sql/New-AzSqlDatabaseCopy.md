...
Membuat salinan data SQL Database yang menggunakan snapshot pada waktu saat ini. (otomatisgenerated)
...
### -ServerName
Menentukan nama file SQL Server berisi database untuk disalin.
