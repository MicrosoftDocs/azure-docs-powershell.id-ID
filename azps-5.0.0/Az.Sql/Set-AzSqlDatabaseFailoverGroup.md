...
Selama pratinjau fitur Grup Failover, hanya nilai yang lebih besar atau sama dengan 1 jam yang didukung untuk parameter '-GracePeriodWithDataLossHours'.
...
Interval sebelum failover otomatis dimulai jika terjadi pemadaman di server utama. Hal ini menunjukkan Azure SQL Database failover otomatis tidak akan dimulai sebelum masa tenggang kedaluwarsa. Harap diingat bahwa operasi failover dengan opsi AllowDataLoss mungkin menyebabkan hilangnya data karena sifat sinkronisasi asinkron.
