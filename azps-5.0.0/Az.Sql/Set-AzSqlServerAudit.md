...
## DESKRIPSI
Cmdlet **Set-AzSqlServerAudit** mengubah pengaturan pengauditan server SQL Azure.
...
### Contoh 10: Nonaktifkan pengiriman rekaman audit server Azure SQL ke penyimpanan blob, dan aktifkan pengirimannya untuk analitik log.
```powershell
