...
## DESKRIPSI
Cmdlet Get-AzSqlDatabaseSensitivityClassification akan mengembalikan tipe informasi saat ini dan label sensitivitas kolom di database Azure SQL.

## CONTOH

### Contoh 1: Dapatkan tipe informasi terkini dan label sensitivitas pesan Azure SQL Database.
```powershell
...
### Contoh 2: Dapatkan tipe informasi saat ini dan label sensitivitas data Azure SQL Database dengan Piping.
```powershell
...
### Contoh 4: Dapatkan tipe informasi saat ini dan label sensitivitas kolom tertentu dari suatu Azure SQL Database menggunakan Piping.
```powershell
