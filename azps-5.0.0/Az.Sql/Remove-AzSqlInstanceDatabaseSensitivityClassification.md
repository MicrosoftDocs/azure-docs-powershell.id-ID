...
## DESKRIPSI
Cmdlet Remove-AzSqlInstanceDatabaseSensitivityClassification menghapus tipe informasi dan label sensitivitas kolom di database Azure SQL terkelola.

## CONTOH

### Contoh 1: Hapus tipe informasi dan label sensitivitas kolom di database instans SQL terkelola Azure.
```powershell
...
### Contoh 2: Hapus tipe informasi saat ini dan label sensitivitas kolom di database SQL terkelola Azure dengan Piping.
```powershell
...
### Contoh 3: Hapus tipe informasi dan label sensitivitas kolom dalam database SQL terkelola Azure dengan Piping.
```powershell
