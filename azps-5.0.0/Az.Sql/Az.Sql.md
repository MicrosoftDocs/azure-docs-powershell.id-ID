...
Mendapatkan tipe informasi yang direkomendasikan dan label sensitivitas kolom di Azure SQL database instans terkelola.
...
Menghapus grup Azure SQL Database Sinkronisasi Otomatis.
...
Memperbarui grup Azure SQL Database Sinkronisasi Bersama.
