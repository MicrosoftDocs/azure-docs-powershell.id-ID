...
## DESKRIPSI
Cmdlet **Get-AzSqlDatabaseImportExportStatus** mendapatkan detail tentang impor file bacpac dari akun penyimpanan ke Azure SQL Database atau mengekspor Azure SQL Database sebagai file bacpac ke akun penyimpanan.
...
### -OperationStatusLink
Menentukan tautan status yang dikembalikan dari cmdlet New-AzSqlDatabaseExport atau New-AzSqlDatabaseImport status.
