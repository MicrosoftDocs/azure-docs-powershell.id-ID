...
### -RequestedServiceObjectiveName
Menentukan nama tujuan layanan untuk ditetapkan ke database. Untuk informasi tentang tujuan layanan, [lihat Azure SQL Database Tingkat Layanan dan Tingkat Kinerja](https://docs.microsoft.com/en-us/azure/sql-database/sql-database-dtu-resource-limits-single-databases) di Pustaka Jaringan Pengembang Microsoft.
