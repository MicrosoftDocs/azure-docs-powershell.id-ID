...
## DESKRIPSI
Cmdlet **Get-AzSqlInstanceDatabaseLogReplay** mendapatkan status layanan Log Replay di database tersebut.
...
Perintah ini akan mendapatkan status layanan pemutaran ulang log pada database tersebut.
