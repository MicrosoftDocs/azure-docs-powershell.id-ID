...
## DESKRIPSI
Cmdlet **Restore-AzSqlDatabase** memulihkan database SQL dari cadangan geo berlebihan, cadangan database yang dihapus, cadangan penyimpanan jangka panjang, atau titik waktu dalam database langsung.
...
Perintah pertama akan mendapatkan SQL database bernama Database01, lalu menyimpannya dalam $Database variabel.
Perintah kedua memulihkan database di $Database dari pencadangan titik waktu yang ditentukan ke database SQL bernama RestoredDatabase di kolam elastis bernama elastispool01.
...
Perintah pertama mendapatkan cadangan geo berlebihan untuk database yang bernama Database01, lalu menyimpannya dalam variabel $GeoBackup nya.
Perintah kedua memulihkan cadangan di database $GeoBackup ke database SQL bernama RestoredDatabase.
...
### -ElastisPoolName
Menentukan nama kolam elastis tempat untuk meletakkan database SQL.
...
### -FromDeletedDatabaseBackup
Mengindikasikan bahwa cmdlet ini memulihkan database dari cadangan database yang SQL.
Anda dapat menggunakan cmdlet Get-AzSqlDeletedDatabaseBackup ini untuk mendapatkan cadangan database SQL dihapus.
...
Anda bisa menggunakan cmdlet Get-AzSqlDatabaseGeoBackup untuk mendapatkan cadangan geo berlebihan.
