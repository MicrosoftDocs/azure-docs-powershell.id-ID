...
ms.locfileid: "132409444"
---
# Get-AzMarketplaceTerms

## SYNOPSIS
Dapatkan persyaratan perjanjian untuk publisher id(Publisher), offer id(Product) dan plan id(Name) yang diberikan. Istilah objek yang dikembalikan oleh perintah ini harus disampaikan ke Set-AzMarketplaceTerms syarat hukum.
