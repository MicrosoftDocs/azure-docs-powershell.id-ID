...
### -ObjectId
Kumpulan Azure Active Directory id objek bagi pengguna atau grup yang akan menerapkan kebijakan.
...
### -ObjectType
Tipe Azure Active Directory objek untuk ID objek yang diteruskan.
