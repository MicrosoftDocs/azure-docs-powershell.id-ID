...
Buat pemicu baru yang disebut ContosoTrigger di ruang kerja ContosoWorkspace. Pemicu dibuat dalam status 'Dihentikan', yang berarti pemicu tidak langsung dimulai. Pemicu dapat mulai menggunakan `Start-AzDataFactoryV2Trigger` cmdlet.
...
Buat pemicu baru yang disebut ContosoTrigger di ruang kerja ContosoWorkspace melalui pipeline. Pemicu dibuat dalam status 'Dihentikan', yang berarti pemicu tidak langsung dimulai. Pemicu dapat mulai menggunakan `Start-AzDataFactoryV2Trigger` cmdlet.
