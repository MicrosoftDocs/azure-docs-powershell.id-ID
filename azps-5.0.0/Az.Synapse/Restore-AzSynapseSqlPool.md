...
## DESKRIPSI
Cmdlet **Restore-AzSynapseSqlPool** memulihkan SQL Analitik Azure Synapse dari cadangan atau titik pemulihan dari setiap SQL lokal.
...
Perintah ini membuat azure Synapse Analytics SQL lokal dengan memulihkan dari cadangan terbaru dari setiap SQL lokal dalam langganan ini.
...
Perintah ini membuat azure Synapse Analytics SQL pool dengan memulihkan dari cadangan terbaru dari setiap SQL lokal dalam langganan ini dengan ID sumber daya.
...
Perintah ini akan membuat SQL Analitik Azure Synapse dengan memaksimalkan titik pemulihan dari semua pool SQL dalam langganan ini untuk memulihkan atau menyalin dari status sebelumnya dengan ID sumber daya.
...
### -BackupResourceId
Pengidentifikasi sumber daya dari objek SQL pool yang ingin dipulihkan.
...
### -FromBackup
Menunjukkan untuk memulihkan dari cadangan terbaru dari semua SQL baru dalam langganan ini.
...
### -RestorePoint
Waktu jepretan layar untuk dipulihkan.
...
### -SourceSqlPoolName
Nama objek SQL sumber untuk dibuat.
