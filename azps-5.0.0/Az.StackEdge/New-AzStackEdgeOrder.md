...
## DESKRIPSI
Cmdlet **New-AzStackEdgeOrder** membuat urutan baru untuk perangkat Stack Edge. Sumber daya perangkat Stack Edge perlu dibuat terlebih dahulu sebelum membuat pesanan. Anda dapat menentukan detail seperti orang kontak, nama perusahaan, email, alamat, dll. sebagai parameter untuk membuat pesanan.
