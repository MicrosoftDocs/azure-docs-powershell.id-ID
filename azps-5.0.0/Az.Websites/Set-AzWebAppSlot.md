...
Mengubah slot Azure Web App. (otomatisgenerated)
...
### -AppSettings
Aplikasi Pengaturan HashTable. Aplikasi yang sudah Pengaturan akan diganti, menghapus pengaturan apa pun yang tidak disediakan.
...
### -AzureStoragePath
Azure Storage terpasang di dalam Web App untuk Container. Menggunakan New-AzureRmWebAppAzureStoragePath untuk membuatnya
