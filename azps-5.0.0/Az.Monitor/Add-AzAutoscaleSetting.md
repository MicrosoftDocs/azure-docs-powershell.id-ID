...
Dua perintah pertama menggunakan [New-AzAutoscaleRule](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azautoscalerule) untuk membuat dua aturan Skala Otomatis, $Rule 1 dan $Rule 2.
Perintah ketiga dan keempat menggunakan [New-AzAutoscaleProfile](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azautoscaleprofile) untuk membuat profil Skala otomatis, $Profile 1 dan $Profile 2, menggunakan $Rule 1 dan $Rule 2.
