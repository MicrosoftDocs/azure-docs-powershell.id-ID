...
### -Lokasi
Menentukan kawasan Azure untuk membuat kunci vault. Gunakan perintah [Get-AzLocation](https://docs.microsoft.com/powershell/module/Azure/Get-AzLocation) untuk melihat pilihan Anda.
...
Menentukan berapa lama sumber daya yang dihapus dipertahankan, dan berapa lama hingga vault atau objek di status dihapus dapat di pembersihan. Defaultnya adalah 90 hari.
