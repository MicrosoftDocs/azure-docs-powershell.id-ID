...
ms.locfileid: "132410750"
---
# Restore-AzManagedHsmKey

## SYNOPSIS
Membuat kunci di HSM terkelola dari kunci yang dicadangkan.
...
## DESKRIPSI
Cmdlet **Restore-AzManagedHsmKey** membuat kunci di HSM terkelola yang ditentukan.
Kunci ini adalah replika kunci yang dicadangkan dalam file input dan memiliki nama yang sama seperti kunci aslinya.
Jika HSM terkelola telah memiliki kunci dengan nama yang sama, cmdlet ini gagal dan bukan menimpa kunci asli.
Jika cadangan berisi beberapa versi kunci, semua versi akan dipulihkan.
HSM terkelola yang Anda pulihkan kuncinya dapat berbeda dari HSM terkelola yang Anda cadangkan kuncinya.
Namun, HSM terkelola harus menggunakan langganan yang sama dan berada di kawasan Azure di kawasan yang sama (misalnya, Amerika Utara).
...
Perintah ini memulihkan kunci, termasuk semua versinya, dari file cadangan yang bernama Backup.blob ke dalam HSM terkelola yang bernama testmhsm.
