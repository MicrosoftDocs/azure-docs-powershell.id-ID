...
Langkah ini adalah salah satu langkah mengimpor kunci yang diproteksi HSM ke Azure Key Vault. Lihat https://docs.microsoft.com/en-us/azure/key-vault/keys/hsm-protected-keys
