...
### Contoh 1: Menambahkan sumber daya ke kumpulan pemindahan.
```powershell
...
Menambahkan sumber daya ke kumpulan pindahkan dalam langganan yang ditentukan.
...
Tipe sumber daya.
Misalnya, nilai dapat menjadi Microsoft.Compute/virtualMachines.
...
Mendapatkan atau mengatur nama Sumber Daya target.
