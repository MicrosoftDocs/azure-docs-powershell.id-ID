...
### Contoh 1: Memvalidasi dependensi sebelum mempersiapkan sumber daya
```powershell
...
Validasi dependensi sebelum mempersiapkan sumber daya tersebut.
...
Mulai mempersiapkan kumpulan sumber daya dalam Kumpulan Pemindahan menggunakan "Nama MoveResource" sebagai input.
...
Mulai mempersiapkan kumpulan sumber daya dalam Kumpulan Pemindahan menggunakan "SourceARMID".
...
### -MoveResource
Mendapatkan atau mengatur daftar Id sumber daya, secara default id itu menerima id pindahkan sumber daya kecuali tipe input dialihkan melalui properti moveResourceInputType.
