...
Karena kumpulan data CNAME bisa berisi paling banyak satu catatan, awalnya data harus kosong, atau catatan yang sudah ada harus dihapus menggunakan Remove-AzureRmDnsRecordConfig.
...
Contoh ini menambahkan catatan NS ke kumpulan data yang sudah ada.
...
Ini adalah representasi offline **RecordSet**, dan perubahannya tidak mengubah respons DNS hingga Anda menjalankan cmdlet Set-AzureRmDnsRecordSet baru.

## OUTPUTS

### Microsoft.Azure.Commands.Dns.DnsRecordSet
Cmdlet ini mengembalikan objek **RecordSet yang** diubah.
Selain itu, objek yang melintas di diubah secara langsung.
