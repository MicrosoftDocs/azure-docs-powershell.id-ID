...
Anda dapat membuat referensi objek ini menggunakan cmdlet dan sintaks New-AzureRmApplicationGatewayBackendAddressPool yang serupa dengan ini:
...
Anda dapat membuat referensi objek ini menggunakan cmdlet dan sintaks New-AzureRmApplicationGatewayBackendHttpSettings yang serupa dengan ini:
...
###  
**New-AzureRmApplicationGatewayPathRuleConfig** tidak menerima input pipelined.

## OUTPUTS

###  
**New-AzureRmApplicationGatewayPathRuleConfig** membuat instans baru objek **Microsoft.Azure.Commands.Network.Models.PSApplicationGatewayPathRule** .
