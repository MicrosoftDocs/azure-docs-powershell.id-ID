...
## DESCRIPTION
Cmdlet **Set-AzureRmApplicationGatewayUrlPathMapConfig** mengatur konfigurasi untuk array pemetaan jalur URL ke kumpulan server backend.
