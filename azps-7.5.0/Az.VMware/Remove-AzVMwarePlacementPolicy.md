...
ms.openlocfilehash: 6dcef6b738db8cb2a93dfa1ceb54fd1823849293
ms.sourcegitcommit: 5df8b100721844736630242c724da453a2168434
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 06/26/2022
ms.locfileid: "146633242"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan lihat [versi terbaru](/powershell/module/az.vmware/remove-azvmwareplacementpolicy) untuk informasi terbaru.
...
### Contoh 1: Menghapus kebijakan penempatan di kluster cloud privat
```powershell
...
### Contoh 2: Menghapus kebijakan penempatan di kluster cloud privat
```powershell
