...
ms.openlocfilehash: fdfcf7f726a04f17260cec83338de8d6d8cc9809
ms.sourcegitcommit: 82b4008b76d035e4aee733727371765b0d853bed
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 05/24/2022
ms.locfileid: "145743472"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan lihat [versi terbaru](/powershell/module/az.desktopvirtualization/remove-azwvdsessionhost) untuk informasi terbaru.
...
### Contoh 1: Menghapus Windows Virtual Desktop SessionHost berdasarkan nama
```powershell
Remove-AzWvdSessionHost -ResourceGroupName ResourceGroupName -HostPoolName HostPoolName -Name SessionHostName
```

Perintah ini menghapus Windows Virtual Desktop SessionHost di Kumpulan Host.
