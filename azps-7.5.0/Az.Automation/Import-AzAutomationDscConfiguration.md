...
Perintah ini mengimpor konfigurasi DSC dalam file bernama client.ps1 ke akun Automation bernama Contoso17. Perintah menentukan parameter *Force* . Jika ada konfigurasi DSC yang ada, perintah ini akan menggantikannya.
