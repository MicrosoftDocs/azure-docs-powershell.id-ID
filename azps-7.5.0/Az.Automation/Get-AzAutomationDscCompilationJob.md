...
### -ConfigurationName
Menentukan nama konfigurasi DSC yang cmdlet ini mendapatkan pekerjaan kompilasi.
...
### -Id
Menentukan ID unik dari pekerjaan kompilasi DSC yang didapat cmdlet ini.
