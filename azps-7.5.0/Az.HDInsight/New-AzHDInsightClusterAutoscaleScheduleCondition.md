...
Perintah ini menciptakan kondisi di mana skala otomatis kluster menjadi 5 simpul pekerja pada pukul 09.00 setiap Senin, Rabu.

### Contoh 2: Aktifkan skala otomatis kluster berbasis jadwal dengan kondisi skala otomatis.
```powershell
