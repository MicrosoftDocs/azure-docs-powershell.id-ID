...
Properties        : {"objectName":"object","instanceName":"*","intervalSeconds":15,"performanceCounters":[{"counterName
                    ":"counter"}]}
```
Menambahkan penghitung kinerja tempat Azure Operational Insights mengumpulkan data ke semua komputer Linux di ruang kerja
## PARAMETERS
...
### -IntervalSeconds
Menentukan interval pengumpulan.
