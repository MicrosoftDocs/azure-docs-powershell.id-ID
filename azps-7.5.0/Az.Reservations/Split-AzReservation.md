...
Pisahkan yang ditentukan `Reservation` menjadi dua `Reservation`d dengan jumlah yang sesuai
...
### -Kuantitas
Bilangan bulat yang dipisahkan koma untuk bidang kuantitas dari keduanya `Reservation`
...
### -ReservationId
Id dari yang akan dipisahkan `Reservation`
