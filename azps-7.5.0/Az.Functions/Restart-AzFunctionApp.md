...
ms.openlocfilehash: 1ce994e10c0f38326809b9c46fca054b9a39ad81
ms.sourcegitcommit: 5df8b100721844736630242c724da453a2168434
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 06/26/2022
ms.locfileid: "146609716"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan lihat [versi terbaru](/powershell/module/az.functions/restart-azfunctionapp) untuk informasi terbaru.
...
### Contoh 1: Dapatkan aplikasi fungsi berdasarkan nama dan mulai ulang.
```powershell
Get-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName | Restart-AzFunctionApp -Force
```

Perintah ini mendapatkan aplikasi fungsi berdasarkan nama dan menghidupkannya kembali.

### Contoh 2: Mulai ulang aplikasi fungsi berdasarkan nama.
```powershell
