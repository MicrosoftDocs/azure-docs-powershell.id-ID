...
ms.openlocfilehash: 84b0d39fbf7c1276a5242fed42543e1474907d32
ms.sourcegitcommit: 5df8b100721844736630242c724da453a2168434
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 06/26/2022
ms.locfileid: "146616970"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan lihat [versi terbaru](/powershell/module/az.websites/remove-azwebappcontinuouswebjob) untuk informasi terbaru.
...
### Contoh 1: Menghapus pekerjaan web berkelanjutan untuk aplikasi
```powershell
PS C:\> Remove-AzWebAppContinuousWebJob -ResourceGroupName webjob-rg-test -AppName appService-test01 -Name continuousjob-01
```

Perintah ini menghapus pekerjaan web berkelanjutan untuk aplikasi.

### Contoh 2: Menghapus pekerjaan web berkelanjutan untuk aplikasi menurut alur
```powershell
...
Perintah ini menghapus pekerjaan web berkelanjutan untuk aplikasi berdasarkan alur.
