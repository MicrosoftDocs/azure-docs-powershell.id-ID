...
ms.openlocfilehash: 8027e1fbeaacd30b5a2fe89521e4ca4100b18939
ms.sourcegitcommit: 5df8b100721844736630242c724da453a2168434
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 06/26/2022
ms.locfileid: "146633152"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan lihat [versi terbaru](/powershell/module/az.websites/start-azwebappslotcontinuouswebjob) untuk informasi terbaru.
...
### Contoh 1: Memulai pekerjaan web berkelanjutan untuk slot penyebaran
```powershell
...
### Contoh 2: Memulai pekerjaan web berkelanjutan untuk slot penyebaran menurut alur
```powershell
...
Perintah ini memulai pekerjaan web berkelanjutan untuk slot penyebaran berdasarkan alur.
