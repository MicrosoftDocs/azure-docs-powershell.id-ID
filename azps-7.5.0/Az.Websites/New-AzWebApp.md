...
Perintah ini membuat Aplikasi Web Azure bernama ContosoSite di grup sumber daya yang ada bernama Default-Web-WestUS di pusat data US Barat.
Perintah ini menggunakan paket App Service yang ada bernama ContosoServicePlan.

## PARAMETERS

### -AppServicePlan
Nama Paket App Service atau Id Paket App Service. Jika WebApp dan Paket App Service berada di Grup Sumber Daya yang berbeda, gunakan ID, bukan nama. Id Paket App Service dapat diambil menggunakan: $asp = Get-AzAppServicePlan -ResourceGroup myRG -Name MyWebapp $asp.id mengembalikan Id Paket App Service.
...
App Pengaturan Mengambil alih HashTable
...
ID Sumber Daya profil traffic manager yang ada
