...
ms.openlocfilehash: 5496980b263aa2ac0d69a6eb919c105a1dc93d44
ms.sourcegitcommit: 5df8b100721844736630242c724da453a2168434
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 06/26/2022
ms.locfileid: "146614558"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan lihat [versi terbaru](/powershell/module/az.resources/remove-azadappcredential) untuk informasi terbaru.
...
### Contoh 1: Menghapus kredensial dari aplikasi menurut id kunci
```powershell
Remove-AzADAppCredential -DisplayName $name -KeyId $keyid
```

Menghapus kredensial dari aplikasi menurut id kunci
...
Menghapus semua kredensial dari aplikasi
