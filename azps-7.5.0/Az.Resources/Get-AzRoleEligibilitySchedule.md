...
ms.openlocfilehash: a3a0e9db759db2ecd68b2dca8a8049f887289d52
ms.sourcegitcommit: 5df8b100721844736630242c724da453a2168434
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 06/26/2022
ms.locfileid: "146592132"
---
...
### Contoh 1: Mencantumkan semua jadwal peran yang memenuhi syarat untuk sumber daya
```powershell
...
### Contoh 3: Mencantumkan semua jadwal peran yang memenuhi syarat untuk sumber daya dengan filter
```powershell
PS C:\> $scope = "/subscriptions/38ab2ccc-3747-4567-b36b-9478f5602f0d"
...
### Contoh 4: Mendapatkan jadwal peran yang memenuhi syarat berdasarkan cakupan dan nama
```powershell
PS C:\> $scope = "/subscriptions/38ab2ccc-3747-4567-b36b-9478f5602f0d"
