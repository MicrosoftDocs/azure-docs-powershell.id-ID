...
ms.openlocfilehash: b703b4a8c27edab4339f9bff041972d27bf0c390
ms.sourcegitcommit: 5df8b100721844736630242c724da453a2168434
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 06/26/2022
ms.locfileid: "146617348"
---
...
### Contoh 1: Mencantumkan semua instans jadwal peran yang memenuhi syarat untuk sumber daya
```powershell
...
Mengembalikan semua `roleEligibilityScheduleInstances` untuk `scope`.
...
### Contoh 2: Mencantumkan semua instans jadwal peran saya yang memenuhi syarat untuk sumber daya
```powershell
...
Mengembalikan semua `roleEligibilityScheduleInstances` `scope` yang ditetapkan untuk pengguna panggilan.

### Contoh 3: Mencantumkan semua instans jadwal peran yang memenuhi syarat untuk sumber daya dengan filter
```powershell
PS C:\> $scope = "/subscriptions/38ab2ccc-3747-4567-b36b-9478f5602f0d"
...
### Contoh 4: Mendapatkan instans jadwal yang memenuhi syarat peran berdasarkan cakupan dan nama
```powershell
PS C:\> $scope = "/subscriptions/38ab2ccc-3747-4567-b36b-9478f5602f0d"
...
### -Name
Nama (hash nama jadwal + waktu) dari jadwal kelayakan peran yang akan didapatkan.
