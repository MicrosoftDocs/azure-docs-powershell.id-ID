...
### Contoh 2: Mendapatkan hasil What-If di cakupan penyewa dengan ResourceIdOnly
```powershell
Get-AzTenantDeploymentWhatIfResult `
    -DeploymentName "deploy-01" `
    -Location "West US" `
