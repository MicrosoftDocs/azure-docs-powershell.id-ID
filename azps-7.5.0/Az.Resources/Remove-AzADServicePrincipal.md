...
ms.openlocfilehash: 77bcfde40a3431aec1a0d3425317ad746ca44be9
ms.sourcegitcommit: 5df8b100721844736630242c724da453a2168434
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 06/26/2022
ms.locfileid: "146627914"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan lihat [versi terbaru](/powershell/module/az.resources/remove-azadserviceprincipal) untuk informasi terbaru.
...
### Contoh 1: Menghapus perwakilan layanan menurut nama tampilan
```powershell
...
INPUTOBJECT `<IMicrosoftGraphServicePrincipal>`: kunci: objek perwakilan layanan
  - `[(Any) <Object>]`: Ini menunjukkan properti apa pun dapat ditambahkan ke objek ini.
  - `[DeletedDateTime <DateTime?>]`: 
  - `[DisplayName <String>]`: Nama yang ditampilkan dalam direktori
