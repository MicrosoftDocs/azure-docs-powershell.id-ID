...
Catatan: Kondisi target untuk modul harus dimulai dengan "dari devices.modules where". Lihat https://docs.microsoft.com/azure/iot-hub/iot-hub-automatic-device-management untuk informasi lebih lanjut.
