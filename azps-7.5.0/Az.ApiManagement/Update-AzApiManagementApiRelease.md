...
### Contoh 1: Memperbarui Rilis API untuk Revisi API
```powershell
...
### -PassThru
Jika ditentukan, contoh jenis Microsoft.Azure.Commands.ApiManagement.ServiceManagement.Models.PsApiManagementApiRelease mewakili rilis API yang ditetapkan.
...
### -ReleaseId
Pengidentifikasi untuk Api Revisi ReleaseId.
Parameter ini diperlukan.
