...
### -IdentityClientId
User-Assigned Managed Identity ClientId yang digunakan untuk mengautentikasi ke KeyVault untuk mengambil Sertifikat SSL Kustom.
...
### -KeyVaultId
KeyVaultId ke rahasia yang menyimpan Sertifikat SSL Kustom.
