...
ms.locfileid: "144212183"
---
# New-AzRecoveryServicesAsrVMNicIPConfig

## SYNOPSIS
Membuat konfigurasi IP ASR NIC yang berisi detail konfigurasi failover dan failover pengujian untuk setiap Konfigurasi IP (Primer dan Sekunder) NIC.
...
Menentukan apakah konfigurasi IP yang ada dipilih untuk pengujian failover/failover.
...
### -TfoStaticIPAddress
Menentukan alamat IP dari konfigurasi IP failover pengujian.
