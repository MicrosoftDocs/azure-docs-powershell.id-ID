...
Contoh ini akan memulai peningkatan aplikasi terkelola untuk memperbarui versi jenis ke "v2" yang dibuat dengan **New-AzServiceFabricManagedClusterApplicationTypeVersion**. Parameter aplikasi yang digunakan harus didefinisikan dalam manifes aplikasi.
...
Menentukan durasi dalam detik, untuk menunggu sebelum instans stateless ditutup, untuk memungkinkan permintaan aktif menguras dengan baik.
...
Jika value=true, parameter kebijakan peningkatan lainnya tidak diperbolehkan.
