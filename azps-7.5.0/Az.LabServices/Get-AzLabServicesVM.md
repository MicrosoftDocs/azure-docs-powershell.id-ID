...
ms.openlocfilehash: 6b45a4a1be4539bcfdc2a73020c9c39c0685f7c2
ms.sourcegitcommit: 5df8b100721844736630242c724da453a2168434
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 06/26/2022
ms.locfileid: "146597118"
---
# Get-AzLabServicesVM
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan lihat [versi terbaru](/powershell/module/az.labservices/get-azlabservicesvm) untuk informasi terbaru.
...
### Contoh 1: Mendapatkan semua Komputer virtual di lab.
```powershell
...
Mengembalikan semua VM.

### Contoh 2: Mendapatkan VM tertentu di lab.
```powershell
