...
### Contoh 2: Mendapatkan informasi tentang semua tautan aktif di Azure SQL Managed Instance
```powershell
...
### Contoh 3: Mendapatkan semua tautan instans di Azure SQL Managed Instance menggunakan objek Instans
```powershell
...
### Contoh 4: Mendapatkan semua tautan instans di Azure SQL Managed Instance menggunakan pengidentifikasi sumber daya
```powershell
...
### Contoh 6: Mendapatkan semua tautan instans untuk Instans Terkelola dengan mempipa objek instans
```powershell
...
### Contoh 7: Mendapatkan tautan instans tertentu untuk instans dengan mempipa objek instans dan menentukan nama tautan
```powershell
