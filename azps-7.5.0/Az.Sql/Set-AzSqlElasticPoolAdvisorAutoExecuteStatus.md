...
### Contoh 1: Mengaktifkan eksekusi otomatis untuk penasihat
```powershell
...
### -AutoExecuteStatus
Menentukan nilai baru tempat cmdlet ini memperbarui status eksekusi otomatis.
...
## NOTES
* Kata kunci: azure, azurerm, lengan, sumber daya, manajemen, manajer, sql, kumpulan elastis, mssql, penasihat
