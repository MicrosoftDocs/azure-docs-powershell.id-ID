...
### Contoh 1: Mendapatkan informasi tentang semua sertifikat kepercayaan server di Azure SQL Managed Instance
```powershell
...
### Contoh 4: Mendapatkan semua sertifikat kepercayaan server di Azure SQL Managed Instance menggunakan pengidentifikasi sumber daya
...
### Contoh 6: Mendapatkan semua sertifikat kepercayaan server untuk Instans Terkelola dengan mempipa objek instans
...
### Contoh 7: Mendapatkan sertifikat kepercayaan server tertentu untuk instans dengan mempipa objek instans dan menentukan nama sertifikat
```powershell
