...
ms.openlocfilehash: 648f56c890b68b45e7e04d3f920ce0555c98d093
ms.sourcegitcommit: 82b4008b76d035e4aee733727371765b0d853bed
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 05/24/2022
ms.locfileid: "145724968"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan lihat [versi terbaru](/powershell/module/az.sql/remove-azsqldatabasesensitivityclassification) untuk informasi terbaru.
...
## DESCRIPTION
Cmdlet Remove-AzSqlDatabaseSensitivityClassification menghapus jenis informasi dan label sensitivitas kolom dalam database.

## EXAMPLES

### Contoh 1: Menghapus jenis informasi dan label sensitivitas kolom dalam Azure SQL Database.
```powershell
...
### Contoh 2: Hapus jenis informasi saat ini dan label sensitivitas kolom dalam database Azure SQL menggunakan Piping.
```powershell
...
### Contoh 3: Menghapus jenis informasi dan label sensitivitas kolom dalam database Azure SQL menggunakan Piping.
```powershell
