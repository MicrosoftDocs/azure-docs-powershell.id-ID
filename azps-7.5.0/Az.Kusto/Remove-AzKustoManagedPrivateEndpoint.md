...
ms.openlocfilehash: bdca2dc57f71cac548a269bddffcc3e199b29f93
ms.sourcegitcommit: 82b4008b76d035e4aee733727371765b0d853bed
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 05/24/2022
ms.locfileid: "145693378"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan lihat [versi terbaru](/powershell/module/az.kusto/remove-azkustomanagedprivateendpoint) untuk informasi terbaru.
...
### Contoh 1: Menghapus Kusto ManagedPrivateEndpoint yang sudah ada berdasarkan nama
```powershell
Remove-AzKustoManagedPrivateEndpoint -ClusterName "mycluster" -ResourceGroupName "testrg" -Name "ManagedPrivateEndpointName"
```

Perintah di atas menghapus Kusto ManagedPrivateEndpoint bernama "ManagedPrivateEndpointName" di kluster "mycluster" yang ditemukan di grup sumber daya "testrg".
