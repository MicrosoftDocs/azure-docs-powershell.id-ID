...
ms.openlocfilehash: f39ef91116b813e038ba9d4b724fa6fd2748a738
ms.sourcegitcommit: 5df8b100721844736630242c724da453a2168434
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 06/26/2022
ms.locfileid: "146642638"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan lihat [versi terbaru](/powershell/module/az.kusto/invoke-azkustodiagnoseclustervirtualnetwork) untuk informasi terbaru.
...
### Contoh 1: Menampilkan diagnosis konektivitas jaringan untuk sumber daya eksternal 
```powershell
Invoke-AzKustoDiagnoseClusterVirtualNetwork -ResourceGroupName "testrg" -ClusterName "testnewkustocluster"
```

Perintah di atas mendiagnosis status konektivitas jaringan untuk sumber daya eksternal tempat kluster "testnewkustocluster" bergantung pada
