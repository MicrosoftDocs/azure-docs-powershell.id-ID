...
ms.openlocfilehash: cdd8ba7357c2f4faea22726251136655456a53e6
ms.sourcegitcommit: 321c644cf2161807a71e1af318fc5c5311d22e25
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 05/25/2022
ms.locfileid: "145799936"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan lihat [versi terbaru](/powershell/module/az.kusto/test-azkustodatabasenameavailability) untuk informasi terbaru.
...
### Contoh 1: Periksa ketersediaan nama database Kusto yang sedang digunakan
```powershell
...
Perintah di atas mengembalikan apakah database Kusto bernama "mykustodatabase" ada di kluster "testnewkustocluster" atau tidak.

### Contoh 2: Periksa ketersediaan nama database Kusto yang tidak digunakan
```powershell
...
Perintah di atas mengembalikan apakah database Kusto bernama "mykustodatabase2" ada di kluster "testnewkustocluster" atau tidak.
...
### -Type
Jenis sumber daya, misalnya Microsoft. Kusto/Kluster/database.
