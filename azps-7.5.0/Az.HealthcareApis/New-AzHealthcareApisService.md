...
### Contoh 1 : Membuat layanan fhir Azure healthcareapis baru bernama MyService di grup sumber daya MyResourceGroup di lokasi westus2 dengan throughput penawaran cosmosdb = 400
```powershell
...
### Contoh 2 : Membuat layanan fhir Azure healthcareapis baru bernama MyService di grup sumber daya MyResourceGroup di lokasi westus2 dengan throughput penawaran cosmosdb = 400 dan uri kunci brankas kunci "https://\<my-keyvault>.vault.azure.net/keys/\<my-key>"
```powershell
