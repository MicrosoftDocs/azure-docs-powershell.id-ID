...
Parameter skrip U-SQL telah ditambahkan di atas konten skrip utama, misalnya: DECLARE @Department string = "Sales"; DECLARE @NumRecords int = 1000; DECLARE @StartDateTime DateTime = datetime baru(2017, 12, 6, 0, 0, 0, 0);
...
### -PipelineUri
Uri opsional yang ditautkan ke layanan asal yang terkait dengan alur ini.
...
### -RunId
ID yang mengidentifikasi iterasi eksekusi alur khusus ini.
