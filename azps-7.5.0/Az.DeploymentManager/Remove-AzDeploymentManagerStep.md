...
ms.openlocfilehash: dcf19be80cb0ca0b0c544da6e8334ce80fa1ed27
ms.sourcegitcommit: 82b4008b76d035e4aee733727371765b0d853bed
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 05/24/2022
ms.locfileid: "145745398"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan lihat [versi terbaru](/powershell/module/az.deploymentmanager/remove-azdeploymentmanagerstep) untuk informasi terbaru.
...
## DESCRIPTION
Cmdlet **Remove-AzDeploymentManagerStep** menghapus langkah.
Tentukan langkah berdasarkan namanya dan nama grup sumber daya. Secara bergantian, Anda dapat menyediakan objek Langkah atau ResourceId.

## EXAMPLES

### Contoh 1: Menghapus langkah
```powershell
...
```
 ...
 Perintah ini menghapus langkah yang namanya dan ResourceGroup masing-masing cocok dengan properti Nama dan ResourceGroupName dari $stepObject.
