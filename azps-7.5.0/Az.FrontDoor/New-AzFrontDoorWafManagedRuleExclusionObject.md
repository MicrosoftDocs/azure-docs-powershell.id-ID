...
### -Operator
Operator yang akan digunakan saat mencocokkan pemilih, EqualsAny berarti tidak ada pemilih (semua variabel yang cocok dengan jenis yang ditentukan)
...
### -Variabel
Cocokkan variabel. Nilai yang mungkin adalah RequestHeaderNames, RequestCookieNames, QueryStringArgNames, RequestBodyPostArgNames.
