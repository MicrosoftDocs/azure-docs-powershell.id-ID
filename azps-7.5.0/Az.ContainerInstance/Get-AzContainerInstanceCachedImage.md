...
### Contoh 1: Dapatkan daftar gambar cache untuk langganan saat ini di suatu wilayah.
```powershell
...
Perintah ini mendapatkan daftar gambar cache untuk langganan saat ini di wilayah `eastus`.
