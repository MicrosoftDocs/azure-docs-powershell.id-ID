...
ms.openlocfilehash: 3d7e3d13223fcc41161d388dc2b13b2880a41237
ms.sourcegitcommit: 82b4008b76d035e4aee733727371765b0d853bed
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 05/24/2022
ms.locfileid: "145656796"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan lihat [versi terbaru](/powershell/module/az.providerhub/remove-azproviderhubdefaultrollout) untuk informasi terbaru.
...
### Contoh 1: Menghapus peluncuran default berdasarkan nama.
```powershell
Remove-AzProviderHubDefaultRollout -ProviderNamespace "Microsoft.Contoso" -RolloutName "defaultRollout2021w10"
```

Menghapus peluncuran default berdasarkan nama.

### Contoh 2: Menghapus peluncuran default berdasarkan nama.
```powershell
Remove-AzProviderHubDefaultRollout -ProviderNamespace "Microsoft.Contoso" -RolloutName "defaultRollout2021w10"
```
