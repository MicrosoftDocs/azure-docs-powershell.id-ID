...
### Contoh 3: Mengatur potongan ACL secara rekursif menurut gugus
```
$token = $null
...
Skrip ini menetapkan ACL secara menyeluruh pada potongan direktori berdasarkan gugus, dengan ukuran gugus sebagai BatchSize * MaxBatchCount. Ukuran gugus adalah 200 dalam skrip ini.
