...
### Contoh 1: Membuat objek pemindaian Msi Instans Terkelola Azure Sql Database
```powershell
...
Membuat objek pemindaian Msi Instans Terkelola Azure Sql Database
