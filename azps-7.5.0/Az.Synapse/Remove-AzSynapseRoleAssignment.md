...
Perintah ini menghapus penetapan peran Azure Synapse Analytics dengan nama peran, nama utama pengguna, jenis item, dan item.
...
### -ItemType
Jenis item ruang kerja Azure Synapse.
