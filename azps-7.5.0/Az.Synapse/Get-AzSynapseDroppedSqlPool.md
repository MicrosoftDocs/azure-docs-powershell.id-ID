...
## DESCRIPTION
Cmdlet **Get-AzSynapseDroppedSqlPool** mendapatkan cadangan kumpulan SQL yang dihapus yang ditentukan yang dapat Anda pulihkan, atau semua cadangan yang dihapus yang dapat Anda pulihkan di ruang kerja. 

## EXAMPLES

### Contoh 1: Mendapatkan sqlpools yang dihilangkan tertentu dari kumpulan sql
```powershell
...
### Contoh 2: Dapatkan semua sqlpool yang dihilangkan di ruang kerja
```powershell
