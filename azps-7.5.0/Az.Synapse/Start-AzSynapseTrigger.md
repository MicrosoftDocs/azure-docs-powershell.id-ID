...
## DESCRIPTION
Cmdlet **Start-AzSynapseTrigger** memulai pemicu di ruang kerja. Jika pemicu berada dalam status 'Dihentikan', cmdlet memulai pemicu dan akhirnya memanggil alur berdasarkan definisinya. Jika pemicu sudah dalam status 'Dimulai', cmdlet ini tidak berpengaruh.
