...
### Contoh 2: Memperbarui berdasarkan instans layanan web
```powershell
...
### -Kunci
Memperbarui salah satu atau kedua kunci akses yang digunakan untuk mengautentikasi panggilan ke API runtime layanan.
...
### -Parameters
Kumpulan nilai parameter global yang ditentukan untuk layanan web, diberikan sebagai nama parameter global -\> kumpulan nilai default.
