...
### Contoh 2: Mengatur IP privat statis sebagai IP front-end dari gateway aplikasi
```powershell
...
### -ApplicationGateway
Menentukan objek gateway aplikasi untuk mengubah konfigurasi IP front-end.
