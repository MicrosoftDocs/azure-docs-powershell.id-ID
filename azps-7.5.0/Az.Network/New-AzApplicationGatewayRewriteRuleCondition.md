...
```
Perintah ini membuat kondisi dalam aturan penulisan ulang dan menyimpan hasilnya dalam variabel bernama $condition.
...
### -IgnoreCase
Atur bendera ini untuk mengabaikan kasus pada pola
...
### -Pola
Pola yang akan dicari di Header Variabel
