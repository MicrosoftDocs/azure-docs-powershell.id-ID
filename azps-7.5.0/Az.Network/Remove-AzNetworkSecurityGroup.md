...
ms.openlocfilehash: 5b4ddd11f54101a17c611cc658256dda72665e3c
ms.sourcegitcommit: 82b4008b76d035e4aee733727371765b0d853bed
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 05/24/2022
ms.locfileid: "145669846"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan lihat [versi terbaru](/powershell/module/az.network/remove-aznetworksecuritygroup) untuk informasi terbaru.
...
## DESCRIPTION
Cmdlet **Remove-AzNetworkSecurityGroup** menghapus grup keamanan jaringan Azure.

## EXAMPLES

### Contoh 1: Menghapus grup keamanan jaringan
```powershell
Remove-AzNetworkSecurityGroup -Name "NSG-FrontEnd" -ResourceGroupName "TestRG"
```

Perintah ini menghapus grup keamanan bernama NSG-FrontEnd dalam grup sumber daya bernama TestRG.
...
### -ResourceGroupName
Menentukan nama grup sumber daya tempat cmdlet ini menghapus grup keamanan jaringan.
