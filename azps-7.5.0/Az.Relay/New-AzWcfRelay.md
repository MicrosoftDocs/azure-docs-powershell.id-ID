...
Membuat WcfRelay \`TestWCFRelay2\` baru di ruang nama \`Relay yang ditentukan TestNameSpace-Relay\`.
...
Membuat WcfRelay \`TestWCFRelay\` baru di ruang nama \`Relay yang ditentukan TestNameSpace-Relay1\`.
