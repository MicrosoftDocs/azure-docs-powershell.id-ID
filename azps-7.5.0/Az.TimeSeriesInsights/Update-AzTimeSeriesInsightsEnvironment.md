...
ms.openlocfilehash: acebee01ab6c6145491bcdcba032fbc10e5aa6f6
ms.sourcegitcommit: 5df8b100721844736630242c724da453a2168434
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 06/26/2022
ms.locfileid: "146639676"
---
# Update-AzTimeSeriesInsightsEnvironment

## SYNOPSIS
Updates lingkungan dengan nama yang ditentukan dalam grup langganan dan sumber daya yang ditentukan.

> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan lihat [versi terbaru](/powershell/module/az.timeseriesinsights/update-aztimeseriesinsightsenvironment) untuk informasi terbaru.
...
### Contoh 1: Memperbarui lingkungan wawasan rangkaian waktu Gen1
```powershell
...
Perintah ini memperbarui lingkungan wawasan rangkaian waktu Gen1.

### Contoh 2: Memperbarui lingkungan wawasan rangkaian waktu Gen1
```powershell
...
### -Tag
Pasangan kunci-nilai properti tambahan untuk lingkungan.
