...
Panggil perintah jalankan RunPowerShellScript dengan menimpa skrip 'sample.ps1' dan parameter pada ID '0' VM dalam set skala komputer virtual 'vmssname' dalam grup sumber daya 'rgname'.
