...
ms.openlocfilehash: 494b6d335d6d5da8f183dece1b93cb9780f41df9
ms.sourcegitcommit: cbc0e7ba6f2d138b46d0d72b6776e95cb040e6c8
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 05/24/2022
ms.locfileid: "145528339"
---
...
## DESCRIPTION
Cmdlet **New-AzServiceBusAuthorizationRule** membuat aturan otorisasi baru untuk namespace layanan atau antrean atau topik Bus Layanan yang ditentukan.
...
`AuthoRule1` Membuat dengan hak **Dengarkan** dan **Kirim** untuk namespace `SB-Example1`.
...
`AuthoRule1` Membuat dengan hak **Dengarkan** dan **Kirim** untuk topik `SBTopic`.
