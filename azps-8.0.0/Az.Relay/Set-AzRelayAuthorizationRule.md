...
## DESCRIPTION
Cmdlet **Set-AzRelayAuthorizationRule** memperbarui deskripsi untuk aturan otorisasi yang ditentukan dari entitas Relay yang diberikan (Namespace/WcfRelay/HybridConnection).
...
Menambahkan **Kirim** dari hak akses aturan `AuthoRule1` otorisasi di namespace `TestNameSpace-Relay1`.

### Contoh 1.2 - Namespace dengan parameter Hak
```powershell
...
Menambahkan **Kirim** ke hak akses aturan `AuthoRule1` otorisasi HybridConnection `TestHybridConnection`.

### Contoh 3.2 - HybridConnection dengan parameter Hak
```powershell
