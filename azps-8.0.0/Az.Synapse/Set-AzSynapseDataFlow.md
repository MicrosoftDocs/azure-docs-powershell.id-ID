...
## DESCRIPTION
Cmdlet **Set-AzSynapseDataFlow** membuat aliran data atau memperbarui aliran data yang ada di ruang kerja.
...
Perintah ini membuat aliran data bernama ContosoDataFlow di ruang kerja bernama ContosoWorkspace.
