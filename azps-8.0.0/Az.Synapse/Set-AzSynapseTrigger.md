...
Buat pemicu baru bernama ContosoTrigger di ruang kerja ContosoWorkspace. Pemicu dibuat dalam status 'Dihentikan', yang berarti bahwa pemicu tidak segera dimulai. Pemicu dapat dimulai menggunakan `Start-AzDataFactoryV2Trigger` cmdlet .
