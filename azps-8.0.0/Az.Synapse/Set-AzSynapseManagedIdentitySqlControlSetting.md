...
## DESCRIPTION
**Set-AzSynapseManagedIdentitySqlControlSetting memperbarui identitas terkelola** SQL mengontrol pengaturan ke ruang kerja.
...
Perintah ini memungkinkan identitas terkelola SQL pengaturan kontrol ke ruang kerja untuk ruang kerja ContosoWorkspace melalui alur.
...
Perintah ini memungkinkan identitas terkelola SQL pengaturan kontrol ke ruang kerja untuk ruang kerja ContosoWorkspace melalui ID sumber daya ruang kerja.
...
### -Diaktifkan
Menunjukkan apakah akan mengaktifkan pengaturan kontrol SQL identitas terkelola.
