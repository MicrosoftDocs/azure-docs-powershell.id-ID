...
## DESCRIPTION
Cmdlet **Update-AzSynapseSqlDatabase** memperbarui database SQL Analitik Azure Synapse.
...
Perintah ini memperbarui database SQL Azure Synapse Analytics.
...
### -InputObject
SQL Database objek input, biasanya melewati alur.
