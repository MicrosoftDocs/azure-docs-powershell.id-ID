...
## DESCRIPTION
Cmdlet **Get-AzRecoveryServicesAsrvCenter** mendapatkan detail server vCenter Server yang terdaftar untuk penemuan di server Konfigurasi yang ditentukan oleh fabric ASR.
...
Dapatkan azure site recovery vCenter berdasarkan nama fabric dan nama vCenter Server.
...
Dapatkan daftar vCenter Server azure site recovery berdasarkan nama fabric.
