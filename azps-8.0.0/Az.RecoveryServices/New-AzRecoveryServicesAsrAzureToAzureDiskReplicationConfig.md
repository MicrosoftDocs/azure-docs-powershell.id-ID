...
Buat objek pemetaan disk terkelola dengan ID set enkripsi disk target, agar disk komputer virtual Azure dapat direplikasi. Digunakan selama Azure ke Azure EnableDr dan melindungi kembali operasi.
...
Menentukan jenis akun dari disk terkelola yang direplikasi.
