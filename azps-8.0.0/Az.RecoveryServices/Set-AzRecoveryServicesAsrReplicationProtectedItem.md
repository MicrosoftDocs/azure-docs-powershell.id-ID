...
ms.openlocfilehash: d0faf4dc8b8eb8df48a4fe92a1e470961abdea81
ms.sourcegitcommit: cbc0e7ba6f2d138b46d0d72b6776e95cb040e6c8
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 05/24/2022
ms.locfileid: "145499261"
---
...
Memulai operasi memperbarui NIC utama item yang dilindungi replikasi (untuk digunakan untuk vm )pengaturan yang dipulihkan menggunakan parameter yang ditentukan dan mengembalikan pekerjaan ASR yang digunakan untuk melacak operasi.
...
Memulai operasi memperbarui NIC item yang dilindungi replikasi (untuk digunakan untuk vm yang dipulihkan )pengaturan menggunakan parameter yang ditentukan dan mengembalikan pekerjaan ASR yang digunakan untuk melacak operasi.
...
Memulai operasi memperbarui item yang dilindungi replikasi yang dipilih tp noc mengaktifkan jaringan yang dipercepat pada VM pemulihan (untuk pemulihan bencana Azure ke Azure).
...
Kamus Id sumber daya disk untuk mengeset enkripsi disk ID ARM.
...
### -LicenseType
Menentukan pilihan jenis lisensi yang akan digunakan untuk komputer virtual Windows Server. Jika Anda berhak menggunakan Azure Hybrid Use Benefit (HUB) untuk migrasi dan ingin menentukan bahwa pengaturan HUB digunakan saat mengalihkan item yang dilindungi ini, atur jenis lisensi menjadi WindowsServer.
...
Menentukan Id Sumber Daya dari grup penempatan kedekatan pemulihan untuk melakukan failover pada komputer virtual.
...
ID grup sumber daya Azure di wilayah pemulihan tempat item yang dilindungi akan dipulihkan saat failover.
