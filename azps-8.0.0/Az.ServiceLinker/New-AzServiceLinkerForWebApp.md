...
### Contoh 1: Membuat tautan layanan antara webapp dan postgresql
```powershell
...
### -WebApp
[ResourceNameCompleter("Microsoft.Web/sites", nameof(ResourceGroupName))] Nama webapp sumber daya yang akan disambungkan.
