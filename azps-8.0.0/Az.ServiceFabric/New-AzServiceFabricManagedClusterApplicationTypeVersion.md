...
## DESCRIPTION
Cmdlet ini membuat versi jenis aplikasi terkelola baru menggunakan paket yang ditentukan dalam -PackageUrl, ini harus dapat diakses melalui titik akhir REST untuk Resource Manager Azure untuk digunakan selama penyebaran dan aplikasi mandiri yang dikemas zip dengan ekstensi .sfpkg. Perintah ini akan membuat jenis aplikasi jika belum ada.
