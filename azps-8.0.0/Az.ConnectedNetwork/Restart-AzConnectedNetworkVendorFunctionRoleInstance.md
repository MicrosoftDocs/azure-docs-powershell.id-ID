...
### Contoh 1: Restart-AzConnectedNetworkVendorFunctionRoleInstance melalui lokasi, serviceKey, nama vendor, dan nama instans peran
```powershell
...
Memulai ulang instans peran fungsi jaringan vendor dengan serviceKey yang ditentukan, centraluseuap lokasi, nama vendor myVendor, dan peran nama instans peran1.
