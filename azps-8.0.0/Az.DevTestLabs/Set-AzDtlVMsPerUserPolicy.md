...
## DESCRIPTION
Cmdlet **Set-AzDtlVMsPerUserPolicy** menetapkan komputer virtual per kebijakan pengguna lab, yang menetapkan jumlah maksimum komputer virtual yang diizinkan per pengguna.
...
### -Nonaktifkan
Menunjukkan bahwa cmdlet ini menonaktifkan kebijakan untuk lab.
...
### -LabName
Menentukan nama lab tempat cmdlet ini menetapkan komputer virtual per kebijakan pengguna.
