...
ms.locfileid: "145505242"
---
# Modul Az.Support
## Deskripsi
Topik di bagian ini men dokumentasikan cmdlet Azure PowerShell untuk membuat dan mengelola tiket dukungan Azure dalam kerangka kerja Azure Resource Manager (ARM). Cmdlet ada di namespace Microsoft.Azure.Commands.Support
...
Mendapatkan daftar tiket dukungan. Anda bisa mendapatkan detail tiket dukungan penuh berdasarkan nama tiket atau memfilter tiket dukungan menurut *Status* atau *CreatedDate*.
