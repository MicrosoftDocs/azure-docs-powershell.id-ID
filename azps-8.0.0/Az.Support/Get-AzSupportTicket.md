...
## DESCRIPTION
Mendapatkan daftar tiket dukungan. Ini akan mengambil semua tiket dukungan jika Anda tidak menentukan parameter apa pun. Anda juga dapat memfilter tiket dukungan menurut Status atau CreatedDate menggunakan parameter Filter. Berikut adalah beberapa contoh nilai filter yang dapat Anda tentukan.
...
### Contoh 3: Mendapatkan tiket dukungan berdasarkan nama
```powershell
