...
## DESCRIPTION
Cantumkan semua sesi debug aliran data aktif menurut Azure Data Factory dengan detail.
...
Dapatkan semua sesi debug aliran data aktif di Azure Data Factory "WikiADF".
