...
### Contoh 1: Daftar prinsipal database dari kluster dan database Kusto yang diberikan
```powershell
...
Perintah di atas mengembalikan daftar prinsipal database dari kluster dan database Kusto yang diberikan
