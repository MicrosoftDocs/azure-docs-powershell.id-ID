...
Perintah ini mendapatkan detail penggunaan untuk ruang kerja bernama MyWorkspace di grup sumber daya yang ditentukan.

### Contoh 2: Dapatkan data penggunaan menggunakan alur
```powershell
