...
Perintah ini membuat instans monitor SAP menurut brankas kunci untuk HANA.

### Contoh 3: Membuat instans monitor SAP menurut kamus untuk PrometheusHaCluster
```powershell
...
### Contoh 5: Membuat instans monitor SAP menurut kamus untuk MsSqlServer
```powershell
