...
Contoh ini meneruskan objek PSVirtualMachine ke parameter '-VM'. Ini juga menginstal patch keamanan sambil menyertakan dan mengecualikan KB tertentu dengan menggunakan '-KBNumberToExclude' dan '-KBNumberToInclude'. Ini juga mengecualikan KB yang memerlukan boot ulang dengan menggunakan '-ExcludeKBsRequiringReboot'.
