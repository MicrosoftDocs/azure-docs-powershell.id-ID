...
### Contoh 6: Tambahkan file VHD langsung ke disk yang lebih terkonfigurasi.
```powershell
...
### -Destination
Menentukan URI blob di Blob Storage.
Parameter mendukung SAS URI, meskipun tujuan skenario patching tidak dapat menjadi SAS URI.
