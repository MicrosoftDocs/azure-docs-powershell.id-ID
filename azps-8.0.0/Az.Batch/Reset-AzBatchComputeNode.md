...
### Contoh 2: Gambar ulang semua simpul dalam kumpulan
```powershell
...
### -ComputeNode
Menentukan objek **PSComputeNode** yang mewakili simpul komputasi untuk digambar ulang.
