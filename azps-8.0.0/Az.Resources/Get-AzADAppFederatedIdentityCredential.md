...
ms.openlocfilehash: 44ee54b7c9100a69fb39639535bad8fb846c09a7
ms.sourcegitcommit: 5df8b100721844736630242c724da453a2168434
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 06/26/2022
ms.locfileid: "146634498"
---
...
### Contoh 1: Mencantumkan kredensial identitas federasi untuk aplikasi
```powershell
Get-AzADApplication -ObjectId $app | Get-AzADAppFederatedCredential
```

Mencantumkan kredensial identitas federasi untuk aplikasi

### Contoh 2: Mendapatkan kredensial identitas federasi menurut id
```powershell
Get-AzADAppFederatedCredential -ApplicationObjectId $appObjectId -Id $credentialId
```

Mendapatkan kredensial identitas federasi menurut id

## PARAMETERS

### -ApplicationObject
objek aplikasi Untuk membangun, lihat bagian CATATAN untuk properti APPLICATIONOBJECT dan membuat tabel hash.
...
APPLICATIONOBJECT `<MicrosoftGraphApplication>`: objek aplikasi
