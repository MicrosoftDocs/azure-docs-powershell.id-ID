...
### Contoh 4: Mendapatkan aplikasi yang dimiliki oleh pengguna saat ini
```powershell
Get-AzADapplication -OwnedApplication
```

Mendapatkan aplikasi yang dimiliki oleh pengguna saat ini
...
### -OwnedApplication
dapatkan aplikasi yang dimiliki
