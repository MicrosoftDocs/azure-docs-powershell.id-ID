...
## DESCRIPTION
Cmdlet **New-AzVirtualNetworkTap** membuat sumber daya ketuk jaringan virtual Azure.
...
Semua ketukan sumber yang dikonfigurasi lalu lintas VM akan dirutekan ke IP Tujuan + Port ini.
...
Semua ketukan sumber yang dikonfigurasi lalu lintas VM akan dirutekan ke IpConfiguration LoadBalancer ini. Port Tujuan Default adalah 4789.
...
Referensi sumber daya konfigurasi IP front end penyeimbang muatan tujuan.
...
Referensi sumber daya konfigurasi IP antarmuka jaringan tujuan.
