...
ms.openlocfilehash: efdec4eec921ec016e80b68d7a6f8c2270bb8fc2
ms.sourcegitcommit: cbc0e7ba6f2d138b46d0d72b6776e95cb040e6c8
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 05/24/2022
ms.locfileid: "145508014"
---
...
Perintah pertama mendapatkan gateway jaringan virtual bernama Gateway01 yang termasuk dalam grup sumber daya ResourceGroup001 dan menyimpannya ke variabel bernama $Gateway Perintah kedua memperbarui gateway jaringan virtual yang disimpan dalam variabel $Gateway.
...
Perintah pertama mendapatkan gateway jaringan virtual bernama Gateway01 yang termasuk dalam grup sumber daya ResourceGroup001 dan menyimpannya ke variabel bernama $Gateway Perintah kedua menetapkan nilai gateway jaringan virtual Gateway01 IpConfiguration Id ke dalam ipconfigurationId1 variabel.
...
Perintah kelima mengatur PSIpConfigurationBgpPeeringAddress yang baru dibuat ini ke IpConfigurationBgpPeeringAddresses dan perbarui gateway.

### Contoh 6: Menambahkan/Memperbarui NatRules ke gateway jaringan virtual yang sudah ada
```powershell
$Gateway = Get-AzVirtualNetworkGateway -ResourceGroupName "ResourceGroup001" -Name "Gateway001"
...
Perintah kelima mengatur PSVirtualNetworkGatewayNatRule baru ini diatur ke NatRules gateway dan memperbarui gateway.
...
Ini akan mengaktifkan dan menonaktifkan BgpRouteTranslationForNat pada VirtualNetworkGateway ini
...
Bendera untuk menghapus autentikasi AAD untuk klien P2S dari gateway jaringan virtual.
...
Objek gateway jaringan virtual untuk memodifikasi dasar.
...
Daftar jenis autentikasi klien VPN P2S.
