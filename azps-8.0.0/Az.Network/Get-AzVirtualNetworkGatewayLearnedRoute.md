...
Untuk gateway jaringan virtual Azure bernama gatewayname dalam resource group resourceGroup, mengambil rute yang diketahui gateway Azure. Gateway jaringan virtual Azure dalam hal ini memiliki dua rute statis (10.1.0.0/16 dan 10.0.0.254/32), serta satu rute yang dipelajari melalui BGP (10.0.0.0/16).
