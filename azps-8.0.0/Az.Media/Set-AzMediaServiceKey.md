...
## DESCRIPTION
Cmdlet **Set-AzMediaServiceKey meregenerasi** kunci yang digunakan untuk mengakses titik akhir Transfer Status Representasional (REST) yang terkait dengan layanan media.
