...
### Contoh 1: Mendapatkan ekspor berkelanjutan untuk sumber daya application insights
```powershell
Get-AzApplicationInsightsContinuousExport -ResourceGroupName "testgroup" -Name "test"
```

Mendapatkan ekspor berkelanjutan untuk sumber daya application insights

### Contoh 2: Mendapatkan ekspor berkelanjutan untuk sumber daya application insights
```powershell
