...
ms.openlocfilehash: 1a6ee5dc85b62ca4a607a3748039aae7be20394e
ms.sourcegitcommit: cbc0e7ba6f2d138b46d0d72b6776e95cb040e6c8
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 05/24/2022
ms.locfileid: "145517410"
---
...
### Contoh 1: Memperbarui konfigurasi ekspor berkelanjutan
```powershell
...
Perbarui konfigurasi ekspor berkelanjutan "jlTFEiBg1rkDXOCIeJQ2mB2TxZg=" sumber daya "uji" dalam grup sumber daya "testgroup" untuk mengekspor dokumen "Request" dan "Trace" ke kontainer penyimpanan "testcontainer" di "teststorageaccount". Token SAS harus valid dan memiliki izin tulis ke kontainer, jika tidak, fitur ekspor berkelanjutan tidak akan berfungsi.
Jika token SAS kedaluwarsa, fitur ekspor berkelanjutan akan berhenti berfungsi.
...
### -ExportId
ID konfigurasi Ekspor Berkelanjutan.
