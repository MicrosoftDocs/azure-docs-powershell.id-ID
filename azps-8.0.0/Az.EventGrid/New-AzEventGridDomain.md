...
ms.openlocfilehash: 7ff7312309e5c468782e88a83934bd67e94c1206
ms.sourcegitcommit: cbc0e7ba6f2d138b46d0d72b6776e95cb040e6c8
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 05/24/2022
ms.locfileid: "145562445"
---
...
Membuat domain \`Event Grid Domain1\` di lokasi \`geografis yang ditentukan westus2\`, dalam grup \`sumber daya MyResourceGroupName\`  \`SystemAssigned\` jenis identitas.
...
Membuat domain \`Event Grid Domain1\` di lokasi \`geografis yang ditentukan westus2\`, dalam grup \`sumber daya MyResourceGroupName\`  \`UserAssigned\` dengan id identitas tertentu.
...
Beralih param untuk membuat topik secara otomatis dengan langganan pertama
...
Beralih param ke topik penghapusan otomatis dengan langganan terakhir
...
### -DisableLocalAuth
Alihkan param untuk menonaktifkan autentikasi lokal.
