...
ms.openlocfilehash: c94328a0dab8ee4f34de52e359f7c5068795b598
ms.sourcegitcommit: cbc0e7ba6f2d138b46d0d72b6776e95cb040e6c8
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 05/24/2022
ms.locfileid: "145511155"
---
# New-AzApiManagement
...
### Contoh 4: Membuat layanan API Management dan Mengaktifkan protokol TLS 1.0
...
### Contoh 5: Membuat layanan API Management di Zona Ketersediaan
...
### Contoh 6: Membuat layanan API Management dalam Mode Internal ke Virtual Network dengan Stv2
...
Cmdlet menyebarkan layanan API Management ke Virtual Network menggunakan versi platform stv2.


### Contoh 7: Membuat layanan API Management untuk jaringan virtual eksternal untuk Stv1
...
Perintah ini membuat layanan API Management tingkat Premium di subnet jaringan virtual Azure yang memiliki titik akhir gateway yang menghadap eksternal dengan wilayah master di AS Barat dalam model stv1
...
Apakah akses titik akhir publik diizinkan atau tidak untuk layanan ini. Nilai yang mungkin termasuk: 'Diaktifkan', 'Dinonaktifkan'
