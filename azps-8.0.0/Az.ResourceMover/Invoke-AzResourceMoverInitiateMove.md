...
### Contoh 2: Mulai Pemindahan untuk sekumpulan sumber daya dalam kumpulan Pindahkan menggunakan "Nama MoveResource" sebagai input.
```powershell
...
### Contoh 3: Memulai Pemindahan untuk sekumpulan sumber daya dalam Kumpulan Pemindahan menggunakan "SourceARMID" sebagai input.
```powershell
...
Mulai Pemindahan untuk sekumpulan sumber daya dalam kumpulan Pemindahan menggunakan "SourceARMID" sebagai input.
