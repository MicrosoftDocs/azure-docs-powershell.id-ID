...
### Contoh 1: Menghapus Windows Aplikasi Virtual Desktop berdasarkan nama
```powershell
...
Perintah ini menghapus aplikasi Windows Virtual Desktop dalam Grup aplikasi.
