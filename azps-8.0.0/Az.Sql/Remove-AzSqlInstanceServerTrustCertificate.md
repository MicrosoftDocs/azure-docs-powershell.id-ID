...
### Contoh 1: Menghapus sertifikat kepercayaan server
```powershell
...
Perintah ini menghapus sertifikat kepercayaan server "Certificate01" dari instans terkelola yang ditentukan oleh objek instans.

### Contoh 5: Menghapus sertifikat kepercayaan server menggunakan parameter posisi
```powershell
...
### -PassThru
Menentukan apakah akan mengembalikan Sertifikat Kepercayaan Server yang dihapus
