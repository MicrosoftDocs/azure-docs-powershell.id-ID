...
## DESCRIPTION
Cmdlet **Set-AzSqlDatabaseBackupLongTermRetentionPolicy** menetapkan kebijakan penyimpanan jangka panjang yang terdaftar ke database ini.
Kebijakan ini adalah sumber daya Azure Backup yang digunakan untuk menentukan kebijakan penyimpanan cadangan.

## EXAMPLES

### Contoh 1: Atur retensi mingguan untuk versi kebijakan penyimpanan jangka panjang saat ini
```powershell
...
Ini menetapkan kebijakan penyimpanan jangka panjang database01 untuk menyimpan setiap pencadangan penuh mingguan selama 2 minggu

### Contoh 2: Atur retensi bulanan untuk versi kebijakan penyimpanan jangka panjang saat ini
```powershell
...
Ini menetapkan kebijakan penyimpanan jangka panjang database01 untuk menyimpan setiap pencadangan penuh selama 14 hari, pencadangan penuh pertama setiap bulan selama 24 minggu, dan pencadangan penuh yang diambil pada minggu ke-26 tahun selama 10 tahun
...
Menghapus kebijakan untuk database01 sehingga tidak lagi menyimpan cadangan retensi jangka panjang.
...
Ini adalah cara lain untuk menghapus kebijakan untuk database01 sehingga tidak lagi menyimpan cadangan retensi jangka panjang.
Ini tidak akan mempengaruhi cadangan yang telah diambil
