...
## DESCRIPTION
Cmdlet **Get-AzSqlDatabaseTransparentDataEncryptionActivity** mendapatkan kemajuan pemindaian Transparent Data Encryption (TDE) dari database Azure SQL.
...
### -DatabaseName
Menentukan nama database yang cmdlet ini mendapatkan aktivitas enkripsi TDE.
