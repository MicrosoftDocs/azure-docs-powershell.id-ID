...
Anda tidak perlu menentukan parameter ini saat melakukan operasi yang direncanakan, seperti latihan pemulihan.
Dalam kasus terakhir, database sekunder disinkronkan dengan database utama sebelum dialihkan.

## EXAMPLES

### Contoh 1: Memulai failover yang direncanakan
```powershell
