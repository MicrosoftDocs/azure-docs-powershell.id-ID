...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan lihat [versi terbaru](/powershell/module/az.springcloud/update-azspringcloud) untuk informasi terbaru.
...
Perbarui Spring Cloud Service berdasarkan nama.

### Contoh 2: Perbarui Spring Cloud Service dari pipa.
```powershell
...
Perbarui Spring Cloud Service dari pipa.
...
### -TraceEnabled
Menunjukkan apakah mengaktifkan fungsionalitas pelacakan
