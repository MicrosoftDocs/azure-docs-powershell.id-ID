...
ms.openlocfilehash: 88255abc84a06c65a483271f349be91ec5c6c3da
ms.sourcegitcommit: e32efb81b37827496f5fe4e57cd9a67004b5a271
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 05/04/2022
ms.locfileid: "144663408"
---
...
Cmdlet **New-AzApiManagementApiRevision** membuat Revisi API untuk API yang ada dalam konteks API Management.

## EXAMPLES

### Contoh 1: Membuat Revisi API kosong untuk API
```powershell
...
Perintah ini membuat Revisi `2` API API `echo-api` .
...
Perintah ini membuat Revisi `5` API API `echo-api` .
...
### -ApiRevisionDescription
Deskripsi Revisi Api. Parameter ini bersifat opsional.
...
### -ServiceUrl
URL layanan web yang mengekspos API di layanan Backend. URL ini hanya akan digunakan oleh Azure API Management, dan tidak akan di publikasikan. Panjangnya harus 1 hingga 2000 karakter. Parameter ini diperlukan.
