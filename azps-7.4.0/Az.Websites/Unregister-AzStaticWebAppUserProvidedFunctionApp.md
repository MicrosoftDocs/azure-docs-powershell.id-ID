...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan lihat [versi terbaru](/powershell/module/az.websites/unregister-azstaticwebappuserprovidedfunctionapp) untuk informasi terbaru.
...
### Contoh 1: Membatalkan pendaftaran aplikasi fungsi yang disediakan pengguna dari situs statis
```powershell
...
### Contoh 2: Membatalkan pendaftaran aplikasi fungsi yang disediakan pengguna dari situs statis berdasarkan alur
```powershell
...
Perintah ini membatalkan pendaftaran aplikasi fungsi yang disediakan pengguna dari situs statis berdasarkan alur.
