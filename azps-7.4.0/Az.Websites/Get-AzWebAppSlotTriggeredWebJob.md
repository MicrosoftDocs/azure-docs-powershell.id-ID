...
Perintah ini dipicu web untuk slot penyebaran.

### Contoh 3: Dapatkan web yang dipicu untuk slot penyebaran menurut alur
```powershell
...
Perintah ini dipicu web untuk slot penyebaran berdasarkan alur.
