...
### Contoh 2: Menghapus pekerjaan web berkelanjutan untuk slot penyebaran menurut pipeline
```powershell
...
Perintah ini menghapus pekerjaan web berkelanjutan untuk slot penyebaran menurut saluran.
