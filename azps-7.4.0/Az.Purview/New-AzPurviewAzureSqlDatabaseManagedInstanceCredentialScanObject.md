...
### Contoh 1: Membuat objek pemindaian Kredensial Instans Terkelola Database Azure Sql
```powershell
...
Membuat objek pemindaian Kredensial Instans Terkelola Database Azure Sql
