...
## DESCRIPTION
Cmdlet remove-AzNetworkWatcherConnectionMonitor menghapus pemantau koneksi yang ditentukan.

## EXAMPLES

### Contoh 1: Menghapus pemantau koneksi yang ditentukan
```powershell
...
Hapus pemantau koneksi. (dibuat otomatis)
