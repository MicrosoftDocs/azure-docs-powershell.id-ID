...
ms.locfileid: "144558823"
---
# Add-AzApplicationGatewayTrustedClientCertificate

## SYNOPSIS
Menambahkan rantai sertifikat OS klien tepercaya ke gateway aplikasi.

> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan lihat [versi terbaru](/powershell/module/az.network/add-azapplicationgatewaytrustedclientcertificate) untuk informasi terbaru.
...
Menambahkan rantai sertifikat OS klien tepercaya ke gateway aplikasi. (dibuat otomatis)
