...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan lihat [versi terbaru](/powershell/module/az.vmware/get-azvmwareaddon) untuk informasi terbaru.
...
### Contoh 1: Daftar addon di bawah grup sumber daya
```powershell
...
Mencantumkan addon di bawah grup sumber daya

### Contoh 2: Mendapatkan addon berdasarkan nama di cloud privat
```powershell
