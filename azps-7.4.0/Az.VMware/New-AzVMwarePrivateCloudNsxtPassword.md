...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan lihat [versi terbaru](/powershell/module/az.vmware/new-azvmwareprivatecloudnsxtpassword) untuk informasi terbaru.
...
### Contoh 1: Memutar kata sandi NSX-T Manager
```powershell
