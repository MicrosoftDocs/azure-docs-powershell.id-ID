...
## DESCRIPTION
Memperlihatkan status enkripsi disk set skala VM.
...
Memperlihatkan status enkripsi disk instans VM 1 dalam set skala VM bernama VMSS001 yang termasuk dalam grup sumber daya bernama Group001.
