...
Perintah ini membuat host Sku yang diberikan di grup host yang diberikan dan lokasi yang diberikan.
...
### -LicenseType
Menentukan jenis lisensi perangkat lunak yang akan diterapkan ke VM yang disebarkan pada host. Nilai yang mungkin adalah: Tidak ada, Windows_Server_Hybrid, dan Windows_Server_Perpetual.  Nilai defaultnya adalah Tidak Ada.
...
### -PlatformFaultDomain
Menentukan jumlah domain kesalahan platform host.  Kemudian nilai minimum adalah 0 dan nilai maksimum adalah 2.
