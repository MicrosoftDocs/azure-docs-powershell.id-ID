...
ms.openlocfilehash: 683eb7e3b32065c7ac268d3f6c4e938baa203898
ms.sourcegitcommit: e32efb81b37827496f5fe4e57cd9a67004b5a271
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 05/04/2022
ms.locfileid: "144732308"
---
...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan lihat [versi terbaru](/powershell/module/az.netappfiles/approve-aznetappfilesreplication) untuk informasi terbaru.
...
## DESCRIPTION
Menyetujui koneksi replikasi pada volume sumber
...
Perintah ini Menyetujui Replikasi di MyAnfVolume.

## PARAMETERS

### -AccountName
Nama akun ANF dari volume sumber replikasi
...
Id sistem file dari volume perlindungan data tujuan
...
### -InputObject
Objek volume sumber ANF untuk mengotorisasi tujuan replikasi
...
### -Name
Nama volume sumber replikasi ANF
...
### -PassThru
Mengembalikan apakah otorisasi replikasi volume yang ditentukan dilakukan
...
### -PoolName
Nama kumpulan ANF dari volume sumber replikasi
...
### -ResourceGroupName
Grup sumber daya volume sumber replikasi ANF
...
### -ResourceId
Id sumber daya volume sumber replikasi ANF
