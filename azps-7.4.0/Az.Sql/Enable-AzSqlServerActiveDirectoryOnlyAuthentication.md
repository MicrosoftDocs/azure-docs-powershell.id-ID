...
Perintah ini memungkinkan Azure Active Directory (Azure AD) hanya persyaratan autentikasi untuk server AzureSQL bernama Server01 yang terkait dengan grup sumber daya bernama ResourceGroup01.
