...
### Contoh 1: Dapatkan informasi tentang semua sertifikat kepercayaan server di Azure SQL Managed Instance
```powershell
...
### Contoh 4: Dapatkan semua sertifikat kepercayaan server di Azure SQL Managed Instance menggunakan pengidentifikasi sumber daya
