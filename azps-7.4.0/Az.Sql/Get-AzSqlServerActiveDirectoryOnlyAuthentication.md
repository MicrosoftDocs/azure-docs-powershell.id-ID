...
Perintah ini hanya mendapatkan persyaratan autentikasi Azure Active Directory (Azure AD) untuk server AzureSQL bernama Server01 yang terkait dengan grup sumber daya bernama ResourceGroup01.
