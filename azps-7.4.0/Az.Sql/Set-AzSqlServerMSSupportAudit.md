...
### Contoh 1: Mengaktifkan penyimpanan blob Microsoft mendukung kebijakan audit operasi server Azure SQL
```powershell
...
### Contoh 4: Menonaktifkan hub peristiwa Microsoft mendukung kebijakan audit operasi server Azure SQL
```powershell
...
### Contoh 7: Menonaktifkan, melalui alur, analitik log Microsoft mendukung kebijakan audit operasi dari server Azure SQL
```powershell
...
### Contoh 9: Mengaktifkan pengiriman catatan audit operasi dukungan Microsoft dari server Azure SQL ke penyimpanan blob, hub peristiwa, dan analitik log.
```powershell
