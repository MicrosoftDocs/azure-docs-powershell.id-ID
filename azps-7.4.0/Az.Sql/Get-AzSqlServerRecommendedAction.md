...
### Contoh 1: Mendapatkan daftar semua tindakan yang direkomendasikan untuk Advisor tertentu
```powershell
...
### -ServerName
Menentukan nama server tempat Advisor berada.
