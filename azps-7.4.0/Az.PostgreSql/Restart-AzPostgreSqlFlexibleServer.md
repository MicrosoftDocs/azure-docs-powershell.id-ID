...
> [!NOTE]
>Ini adalah versi sebelumnya dari dokumentasi kami. Silakan lihat [versi terbaru](/powershell/module/az.postgresql/restart-azpostgresqlflexibleserver) untuk informasi terbaru.
...
### Contoh 3: Menghidupkan ulang server dengan failover yang direncanakan
```powershell
...
Mulai ulang server berdasarkan nama dengan failover paksa
...
### -Parameter
Mewakili parameter hidupkan ulang server.
