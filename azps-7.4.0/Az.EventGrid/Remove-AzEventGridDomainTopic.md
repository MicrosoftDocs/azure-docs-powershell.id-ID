...
Menghapus Topik \`Domain Event Grid Topik1\` di bawah Domain \`Domain1\` di grup \`sumber daya MyResourceGroupName\`.
...
### -ResourceId
Pengidentifikasi Sumber Daya yang mewakili Topik Domain Event Grid.
