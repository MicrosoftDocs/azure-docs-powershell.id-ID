...
### Contoh 1: Membatalkan permintaan jadwal penetapan peran tertunda
```powershell
...
Anda dapat menggunakan operasi ini untuk membatalkan yang `roleAssignmentScheduleRequest` belum ditetapkan.
...
### -Lingkup
Lingkup permintaan penetapan peran untuk membatalkan.
