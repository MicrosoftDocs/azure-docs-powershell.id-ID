...
### Contoh 1: Mencantumkan semua penetapan kebijakan manajemen peran di bawah lingkup sumber daya
```powershell
...
### Contoh 2: Dapatkan penetapan kebijakan manajemen peran menurut Lingkup dan Nama
```powershell
PS C:\> $scope = "/subscriptions/38ab2ccc-3747-4567-b36b-9478f5602f0d/"
