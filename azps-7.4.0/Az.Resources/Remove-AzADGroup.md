...
ms.openlocfilehash: 801b0336625707aff3bc5c7025b0b93a13239999
ms.sourcegitcommit: dcb33efdfc53ba0b2f271e883021de84878d1f31
ms.translationtype: MT
ms.contentlocale: id-ID
ms.lasthandoff: 04/14/2022
ms.locfileid: "142429807"
---
# Remove-AzADGroup
...
Menghapus grup menurut nama tampilan

### Contoh 2: Hapus grup menurut input saluran
```powershell
Get-AzADGroup -ObjectId $id | Remove-AzADGroup
```

Hapus grup menurut input saluran
