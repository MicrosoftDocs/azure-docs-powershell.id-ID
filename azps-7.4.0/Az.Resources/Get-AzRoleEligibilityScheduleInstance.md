...
### Contoh 1: Mencantumkan semua contoh jadwal yang memenuhi syarat untuk sumber daya
```powershell
...
### Contoh 2: Cantumkan semua instans jadwal yang memenuhi syarat peran saya untuk sumber daya
```powershell
...
### Contoh 3: Mencantumkan semua contoh jadwal yang memenuhi syarat untuk sumber daya dengan filter
```powershell
PS C:\> $scope = "/subscriptions/38ab2ccc-3747-4567-b36b-9478f5602f0d"
...
### Contoh 4: Dapatkan peran yang memenuhi syarat menjadwalkan instans menurut lingkup dan nama
```powershell
PS C:\> $scope = "/subscriptions/38ab2ccc-3747-4567-b36b-9478f5602f0d"
...
### -Lingkup
Lingkup jadwal kelayakan peran.
