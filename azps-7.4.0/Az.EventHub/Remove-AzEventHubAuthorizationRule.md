...
## DESCRIPTION
Cmdlet Remove-AzEventHubAuthorizationRule menghapus dan menghapus aturan otorisasi yang ditentukan dari Pusat Aktivitas tertentu.
...
Menghapus aturan \`otorisasi MyAuthRuleName\` dari Event Hub \`MyEventHubName\`.
